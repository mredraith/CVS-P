...
triggerall = (command = "hyper_01A" || command = "hyper_01AA")
triggerall = (var(51) != 3 && var(44) = -1) || (var(51) >= 3 && power = 3000)
trigger1 = ctrl
;
trigger2 = var(20) > 0
...
value = 2100
triggerall = statetype != A
triggerall = (command = "super_02A" || command = "super_02AA")
...
value = 2000
triggerall = statetype != A
triggerall = (command = "super_01A" || command = "super_01AA")
triggerall = power >= 1000 || var(20) > 0
trigger1 = ctrl
;
trigger2 = movecontact && (stateno=200||stateno=240||stateno=300||stateno=320||stateno=540||stateno=560||stateno=510)
...
value = 2200
triggerall = statetype != A
triggerall = (command = "super_03A" ||command = "super_03AA")
triggerall = power >= 1000 || var(20) > 0
trigger1 = ctrl
;
trigger2 = movecontact && (stateno=200||stateno=240||stateno=300||stateno=320||stateno=540||stateno=560||stateno=510)
...
triggerall = statetype != A && command = "power_up"
triggerall = var(20) = 0
trigger1 = var(51) = 1 && power >= 1000
trigger2 = var(51) >= 3 && power >= 3000

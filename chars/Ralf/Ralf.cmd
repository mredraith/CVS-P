...
time = 5
;--------------------------------------------------------------------
[State -1, Jet-Vulcan Punch]
type=ChangeState
value=3400
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="JetVulcanPunch"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;--------------------------------------------------------------------
[State -1, Bareback Galatica Phantom]
type=ChangeState
value=3300
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="BarebackGalaticaPhantom"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;--------------------------------------------------------------------------
...
;----------------------------------------------------------------------
[State -1, Max Galatica Phantom]
type=ChangeState
value=3250
triggerall=!AILevel && RoundState=2 && StateType != A && var(20) <= 60 && power >= 2000&&command ="MaxGalaticaPhantom"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Galatica Phantom]
type=ChangeState
value=3200
triggerall=!AILevel && RoundState=2 && StateType != A && stateno!=3200 && var(20) <= 60 && power >= 1000&&command ="GalaticaPhantom"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Bareback Vulcan Punch]
type=ChangeState
value=3150
triggerall=!AILevel && RoundState=2 && StateType != A && var(20) <= 60 && power >= 2000&&command ="MaxBarebackVulcanPunch"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Bareback Vulcan Punch]
type=ChangeState
value=3100
triggerall=!AILevel && RoundState=2 && StateType != A && stateno!=3100 && var(20) <= 60 && power >= 1000&&command ="BarebackVulcanPunch"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Super Vulcan Punch]
type=ChangeState
value=3050
triggerall=!AILevel && RoundState=2 && StateType != A && var(20) <= 60 && power >= 2000&&command ="MaxSuperVulcanPunch"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Super Vulcan Punch]
type=ChangeState
value=3000
triggerall=!AILevel && RoundState=2 && StateType != A && stateno!=3000 && var(20) <= 60 && power >= 1000&&command ="SuperVulcanPunch"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;========================================================================
[State -1, Ralf Tackle]
type=ChangeState
value=Ifelse(command="RalfTackleEX"&&var(20) <= 60&&power>=500,1350,1300)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="RalfTackle1"|command="RalfTackle2"|command="RalfTackle3")||(command="RalfTackleEX"&&power>=500&&var(20) <= 60)) 
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="RalfTackleEX"&&power>=500&&var(20) <= 60)
;------------------------------------------------------------------------
[State -1, Super Argentine Backbreaker]
type=ChangeState
value=Ifelse(command="SuperArgentineBackbreakerEX"&&var(20) <= 60&&power>=500,1550,1500)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="SuperArgentineBackbreaker1"|command="SuperArgentineBackbreaker2"|command="SuperArgentineBackbreaker3")||(command="SuperArgentineBackbreakerEX"&&power>=500&&var(20) <= 60)) 
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="RalfTackleEX"&&power>=500&&var(20) <= 60)
;------------------------------------------------------------------------
[State -1, Ralf Kick]
type=ChangeState
value=Ifelse((command="RalfKickEX"||command="RalfKickEX2")&&var(20) <= 60&&power>=500,1250,1200)
triggerall=!AILevel && RoundState=2 && StateType != A && (ifelse(var(20) > 0|| var(45)=1 || (stateno = [1000, 4999]), 1, var(49) > 16))
triggerall=(var(45)=0&&((command="RalfKick1")||(command="RalfKick2")||(command="RalfKick3")||(command="RalfKickEX"&&power>=500&&var(20) <= 60)))||(var(45)&&((command="RalfKick4")||(command="RalfKick5")||(command="RalfKick6")||(command="RalfKickEX2"&&power>=500&&var(20) <= 60)))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && ((command="RalfKickEX"||command="RalfKickEX2")&&power>=500&&var(20) <= 60)
;-----------------------------------------------------------------------
[State -1, Dive Bomber Punch]
type =ChangeState
value=Ifelse(command="GatlingAttackEX2"&&var(20) <= 60&&power>=500,1475,1425)
triggerall=!AILevel && RoundState=2 && StateType = A && pos y<-15
triggerall=((command="GatlingAttack4")||(command="GatlingAttack5")||(command="GatlingAttack6")||(command="GatlingAttackEX2"&&power>=500&&var(20) <= 60))
trigger1=ctrl
trigger2=var(5)
trigger3=(stateno = [600,650]) && movecontact
;------------------------------------------------------------------------
[State -1, Bomber Punch]
type=ChangeState
value=Ifelse((command="BomberPunchEX"||command="BomberPunchEX2")&&var(20) <= 60&&power>=500,1450,1400)
triggerall=!AILevel && RoundState=2 && StateType != A && (ifelse(var(20) > 0|| var(45)=1 || (stateno = [1000, 4999]), 1, var(51) > 16))
triggerall=(var(45)=0&&((command="BomberPunch1")||(command="BomberPunch2")||(command="BomberPunch3")||(command="BomberPunchEX"&&power>=500&&var(20) <= 60)))||(var(45)&&((command="BomberPunch4")||(command="BomberPunch5")||(command="BomberPunch6")||(command="BomberPunchEX2"&&power>=500&&var(20) <= 60)))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && ((command="BomberPunchEX"||command="BomberPunchEX2")&&power>=500&&var(20) <= 60)
;------------------------------------------------------------------------
[State -1, Gatling Attack]
type=ChangeState
value=Ifelse((command="GatlingAttackEX"||command="GatlingAttackEX2")&&var(20) <= 60&&power>=500,1150,1100)
triggerall=!AILevel && RoundState=2 && StateType != A && (ifelse(var(20) > 0|| var(45)=1 || (stateno = [1000, 4999]), 1, var(49) > 16))
triggerall=(var(45)=0&&((command="GatlingAttack1")||(command="GatlingAttack2")||(command="GatlingAttack3")||(command="GatlingAttackEX"&&power>=500&&var(20) <= 60)))||(var(45)&&((command="GatlingAttack4")||(command="GatlingAttack5")||(command="GatlingAttack6")||(command="GatlingAttackEX2"&&power>=500&&var(20) <= 60)))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && ((command="GatlingAttackEX"||command="GatlingAttackEX2")&&power>=500&&var(20) <= 60)
;------------------------------------------------------------------------
[State -1, Vulcan Punch]
type=ChangeState
value=Ifelse(command="pp"&&var(20) <= 60&&power>=500,1050,1000)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="x"|command="y"|command="z")||(command="pp"&&power>=500&&var(20) <= 60)) && var(47)>=5
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="pp"&&power>=500&&var(20) <= 60)
;========================================================================
...
trigger2=var(4)
trigger3=((stateno=[200,219])||(stateno=[230,249])||(stateno=[400,419])||(stateno=[430,449]))&&movecontact&&var(55)
trigger4=((stateno=[200,250])||(stateno=[400,419])||(stateno=[430,449]))&&movecontact&&!var(55)
;---------------------------------------------------------------------------
...
;--------------------------------------------------------------------
[State -1, Jet-Vulcan Punch AI]
type=ChangeState
value=3300
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && var(20)<=0 && power >= 3000
triggerall=(p2bodydist x=[10,100]) && (p2bodydist y = [ -80, 5]) && enemynear,statetype!=L && enemynear,statetype!=A && !(enemynear,canrecover) && random < (400 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[5100,5220]) && !var(16)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)&&enemynear,movetype=H&&random<400
trigger3=(stateno=[200,450]) && movehit && random < (200 * (AIlevel ** 2 / 64.0))
;--------------------------------------------------------------------
[State -1, Bareback Galatica Phantom AI]
type=ChangeState
value=3300
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && var(20)<=0 && power >= 3000
triggerall=(p2bodydist x=[40,160]) && (p2bodydist y = [ -80, 5]) && enemynear,statetype!=L && enemynear,statetype!=A && enemynear,movetype!=A && !(enemynear,canrecover) && random < (300 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155]) && (enemynear,stateno!=[5100,5220]) && !var(16)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)&&enemynear,movetype=H&&random<400
trigger3=(stateno=[200,450]) && movehit && random < (200 * (AIlevel ** 2 / 64.0))
;----------------------------------------------------------------------
[State -1, Max Galatica Phantom AI]
type=ChangeState
value=3250
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && var(20)<=60 && power >= 2000
triggerall=(p2bodydist x=[10,180]) && (p2bodydist y = [ -80, 5]) && enemynear,statetype!=A && enemynear,statetype!=L && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[5100,5220]) && !var(16) 
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno=[200,450]) && movehit && random < (200 * (AIlevel ** 2 / 64.0))
;----------------------------------------------------------------------
[State -1, Galatica Phantom AI]
type=ChangeState
value=3200
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && var(20)<=60 && power >= 1000
triggerall=(p2bodydist x=[10,120]) && (p2bodydist y = [ -80, 5]) && enemynear,statetype!=A && enemynear,statetype!=L && random < (200 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[5100,5220]) && !var(16) 
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno=[200,450]) && movehit && random < (150 * (AIlevel ** 2 / 64.0))
;----------------------------------------------------------------------
[State -1, Max Bareback Vulcan Punch AI]
type=ChangeState
value=3150
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && var(20)<=60 && power >= 2000
triggerall=(p2bodydist x=[30,180]) && (p2bodydist y = [ -60, 5]) && enemynear,statetype!=C && enemynear,statetype!=L && random < (200 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155]) && (enemynear,stateno!=[5100,5220]) && !var(16) 
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno=[200,450]) && movehit && random < (150 * (AIlevel ** 2 / 64.0))
;----------------------------------------------------------------------
[State -1, Bareback Vulcan Punch AI]
type=ChangeState
value=3100
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && var(20)<=60 && power >= 1000
triggerall=(p2bodydist x=[30,140]) && (p2bodydist y = [ -60, 5]) && enemynear,statetype!=C && enemynear,statetype!=L && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155]) && (enemynear,stateno!=[5100,5220]) && !var(16) 
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno=[200,450]) && movehit && random < (150 * (AIlevel ** 2 / 64.0))
;----------------------------------------------------------------------
[State -1, Max Super Vulcan Punch AI]
type=ChangeState
value=3050
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && var(20)<=60 && power >= 2000
triggerall=(p2bodydist x=[5,100]) && (p2bodydist y = [ -80, 5]) && enemynear,statetype!=L && random < (200 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155]) && (enemynear,stateno!=[5100,5220]) && !var(16) 
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno=[200,450]) && movehit && random < (250 * (AIlevel ** 2 / 64.0))
;----------------------------------------------------------------------
[State -1, Super Vulcan Punch AI]
type=ChangeState
value=3000
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && var(20)<=60 && power >= 1000
triggerall=(p2bodydist x=[5,80]) && (p2bodydist y = [ -80, 5]) && enemynear,statetype!=L && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155]) && (enemynear,stateno!=[5100,5220]) && !var(16) 
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno=[200,450]) && movehit && random < (250 * (AIlevel ** 2 / 64.0))
;========================================================================
[State -1, Ralf Tackle AI]
type=ChangeState
value=Ifelse((power >= 500 && random < 100), 1350, 1300)
triggerall=AILevel && RoundState=2 && numenemy && StateType != A 
triggerall=(p2bodydist x=[40,160]) && (p2bodydist y = [ -70, 5]) && enemynear,statetype!=A && enemynear,statetype!=L && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155]) && (enemynear,stateno!=[5100,5220]) && (!var(16) && var(15)<1||var(20))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno=[200,440]) && movehit && random < (300 * (AIlevel ** 2 / 64.0))
;------------------------------------------------------------------------
[State -1, Super Argentine Backbreaker AI]
type=ChangeState
value=Ifelse((power >= 500 && random < 50), 1550, 1500)
triggerall=AILevel && RoundState=2 && numenemy && StateType != A 
triggerall=(p2bodydist x=[-5,40]) && (p2bodydist y = [ -70, 5]) && enemynear,movetype!=H && enemynear,statetype!=A && enemynear,statetype!=L && random < (200 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[150,155]) && (enemynear,stateno!=[5000,5220]) 
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
;------------------------------------------------------------------------
[State -1, Ralf Kick AI]
type=ChangeState
value=Ifelse((power >= 500 && random < 150), 1250, 1200)
triggerall=AILevel && RoundState=2 && numenemy && StateType != A 
triggerall=(p2bodydist x=[65,180]) && (p2bodydist y = [ -70, 5]) && enemynear,statetype!=A && enemynear,statetype!=L && random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[150,155]) && (enemynear,stateno!=[5100,5220]) && (!var(16) && var(15)<1||var(20))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno=[200,440]) && movehit && random < (150 * (AIlevel ** 2 / 64.0))
;-----------------------------------------------------------------------
[State -1, Dive Bomber Punch AI]
type =ChangeState
value=Ifelse((power >= 500 && random < 100), 1475, 1425)
triggerall=AILevel && RoundState=2 && numenemy && StateType = A && pos y<-15
triggerall=(p2bodydist x= [5,85]) && (p2bodydist y = [ -50, 175]) && random < (250* (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[5120,5220]) && (fvar(8)<2 && var(15)<2||var(20))
trigger1=ctrl
trigger2=(stateno = [600,650]) && movecontact && random<200
;------------------------------------------------------------------------
[State -1, Bomber Punch AI]
type=ChangeState
value=Ifelse((power >= 500 && random < 150), 1450, 1400)
triggerall=AILevel && RoundState=2 && numenemy && StateType != A 
triggerall=(p2bodydist x=[0,35]) && (p2bodydist y = [ -120, 5]) && enemynear,statetype!=C  && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155]) && (enemynear,stateno!=[5110,5220]) && (!var(16) && var(15)<1||var(20))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno=[200,440]) && movehit && random < (100 * (AIlevel ** 2 / 64.0))
;------------------------------------------------------------------------
[State -1, Gatling Attack AI]
type=ChangeState
value=Ifelse((power >= 500 && random < 75), 1150, 1100)
triggerall=AILevel && RoundState=2 && numenemy && StateType != A 
triggerall=(p2bodydist x=[10,100]) && (p2bodydist y = [ -70, 5]) && enemynear,statetype!=L && random < (100 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155]) && (enemynear,stateno!=[5100,5220]) && (!var(16) && var(15)<1||var(20))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno=[200,440]) && movehit && random < (100 * (AIlevel ** 2 / 64.0))
;------------------------------------------------------------------------
[State -1, Vulcan Punch AI]
type=ChangeState
value=Ifelse((power >= 500 && random < 100), 1050, 1000)
triggerall=AILevel && RoundState=2 && numenemy && StateType != A 
triggerall=(p2bodydist x=[5,70]) && (p2bodydist y = [ -100, 5]) && enemynear,statetype!=L && random < (150 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155]) && (enemynear,stateno!=[5100,5220]) && (!var(16) && var(15)<1||var(20))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno=[200,440]) && movehit && random < (200 * (AIlevel ** 2 / 64.0))

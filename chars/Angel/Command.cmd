...
;R, R:						([special] F, F)			90001026
;L, L:						([special] B, B)			90001074
;L, R:						([special] B, F)			90012806
;R, L:						([special] F, B)			90012904
...
;L, R, D, DR:					(B, F, D, DF)			90033303
;R, L, D, DL:					(F, B, D, DB)			90034301
...
[State -1, (special) L, R: Right]
type = Explod
triggerAll = NumExplod(90001054)
triggerAll = NumHelper(90000005) && !IsHelper && !AILevel
trigger1 = Helper(90000005), command = "fwd" && Helper(90000005), command != "back" && Helper(90000005), command != "up" && Helper(90000005), command != "down"
anim = 1
ID = 90012806
...
[State -1, (special) R, L: Left]
type = Explod
triggerAll = NumExplod(90001006)
triggerAll = NumHelper(90000005) && !IsHelper && !AILevel
trigger1 = Helper(90000005), command = "back" && Helper(90000005), command != "fwd" && Helper(90000005), command != "up" && Helper(90000005), command != "down"
anim = 1
ID = 90012904
...
;==============================================================================================
;===================<BACK, FORWARD, DOWN, DOWN-FORWARD/FORWARDS, BACK, DOWN, DOWN-BACK>======================
;==============================================================================================
...
[State -1, L, R, DR, D, DL, L: Right]
type = Explod
triggerAll = NumExplod(90033004) || NumExplod(90033054)
triggerAll = NumHelper(90000005) && !IsHelper && !AILevel
trigger1 = Helper(90000005), command = "fwd" && Helper(90000005), command != "back" && Helper(90000005), command != "up" && Helper(90000005), command != "down"
anim = 1
ID = 90033106
...
[State -1, L, R, DR, D, DL, L: Down-Right]
type = Explod
triggerAll = NumExplod(90033106) || NumExplod(90033202)
triggerAll = NumHelper(90000005) && !IsHelper && !AILevel
trigger1 = !NumExplod(92828282) && !NumExplod(92468246)
trigger1 = Helper(90000005), command = "dfwd" && Helper(90000005), command != "back" && Helper(90000005), command != "up"
trigger2 = NumExplod(92828282) || NumExplod(92468246)
...
[State -1, R, L, DL, D, DR, R: Left]
type = Explod
triggerAll = NumExplod(90034006) || NumExplod(90034056)
triggerAll = NumHelper(90000005) && !IsHelper && !AILevel
trigger1 = Helper(90000005), command = "back" && Helper(90000005), command != "fwd" && Helper(90000005), command != "up" && Helper(90000005), command != "down"
anim = 1
ID = 90034104
...
[State -1, R, L, DL, D, DR, R: Down-Left]
type = Explod
triggerAll = NumExplod(90034104) || NumExplod(90034202)
triggerAll = NumHelper(90000005) && !IsHelper && !AILevel
trigger1 = !NumExplod(92828282) && !NumExplod(92468246)
trigger1 = Helper(90000005), command = "dback" && Helper(90000005), command != "fwd" && Helper(90000005), command != "up"
trigger2 = NumExplod(92828282) || NumExplod(92468246)
...
[State -1, Survivor's Banquet]
type = ChangeState
value = 3200
triggerAll = !AILevel
;command = "DDD"
triggerAll = NumExplod(90032602)
;(command = "x" || command = "y" || command = "z")  && (command = "a" || command = "b" || command = "c")
...
[State -1, MAX Loyalty Test For Liberalists]
type = ChangeState
value = 3050
triggerAll = !AILevel
;command = "B, F, D, DF"
triggerAll = (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90033303)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90034301))
;x + y / x + z / y + z
...
[State -1, Winds Fairground/Blue Monday Parade]
type = ChangeState
value = 3100
triggerAll = !AILevel
;command = "B, F, D, DF"
...
[State -1, Loyalty Test For Liberalists]
type = ChangeState
value = 3000
triggerAll = !AILevel
;command = "B, F, D, DF"
...
[State -1, EX Mad Murder Roulette]
type = ChangeState
value = 1130
triggerAll = !AILevel
;command = "B, D, DB"
...
[State -1, EX Red Sky of Yaponesia]
type = ChangeState
value = 1030
triggerAll = !AILevel
;command = "HCB"
...
[State -1, Senseless Fists]
type = ChangeState
value = 2020
triggerAll = !AILevel
;command = "[special] BF"
triggerAll = (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90012806)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90012904))
;a / b / c
triggerAll = NumExplod(90000230) || NumExplod(90000235) || NumExplod(90000240) || NumExplod(90000245) || NumExplod(90000250) || NumExplod(90000255)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100, 101])
...
[State -1, Formalist's Blue]
type = ChangeState
value = 2000
triggerAll = !AILevel
;command = "holddown" && command = "holdfwd" && command = "a"
triggerAll = (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90000003)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90000001))
...
[State -1, Senseless Chatter (Cancelled)]
type = ChangeState
value = 249
triggerAll = !AILevel
...
[State -1, At Wasteland]
type = ChangeState
value = 648
triggerAll = !AILevel && !NumProjID(131035)
;command = "b" && command = "holddown"
triggerAll = (NumExplod(90000002) || NumExplod(90000001) || NumExplod(90000003)) && (NumExplod(90000240) || command = "b")
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = Power >= 1000 && var(20) <= 60
triggerAll = (P2BodyDist x = [0, 50]) && InGuardDist && !var(26)
triggerAll = P2StateType != L && (EnemyNear, HitDefAttr = SCA, NA, SA, HA)
...
trigger1 = Random < (ifElse((P2StateNo = [200, 699]), 250, ifElse((P2StateNo = [1000, 2999]), 500, 1000)) * (AILevel ** 2 / 64.0))
...
triggerAll = (P2BodyDist x = [-20, 25]) && P2BodyDist y = 0
...
triggerAll = (P2BodyDist x = [0, 40]) && (P2Dist y = [-60, 60]) && (EnemyNear, vel y >= 0)
trigger1 = (EnemyNear, StateNo = [200, 699]) && Random < (250 * (AIlevel ** 2 / 64.0))
trigger2 = (StateNo = 700 || StateNo = 710 || StateNo = 715 || StateNo = 760) && !AnimTime
...
;Custom Combo (Block String)
[State -1, Senseless Chatter (Custom Combo)]
type = ChangeState
value = 248
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && var(20)
triggerAll = (P2BodyDist x = [0, 38]) && (P2Dist y = [-65, 0]) && P2StateType != A && P2StateType != L
trigger1 = var(6) && MoveGuarded && StateNo = 2000 && Random < 500

[State -1, Citizens of the World (Custom Combo)]
type = ChangeState
value = 2010
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && var(20)
triggerAll = (P2BodyDist x = [0, 38]) && (P2Dist y = [-95, 0]) && P2StateType != A && P2StateType != L
trigger1 = var(6) && MoveGuarded && (StateNo = 248 && Random < 500)

[State -1, Formalist's Blue (Custom Combo)]
type = ChangeState
value = 2000
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && var(20)
triggerAll = (P2BodyDist x = [0, 100]) && (P2Dist y = [-35, 0]) && P2StateType != A && P2StateType != L
trigger1 = var(6) && MoveGuarded && StateNo != 248 && StateNo != 2000 && StateNo != 2010
trigger2 = var(6) && MoveGuarded && P2BodyDist x > 38
trigger3 = var(6) && MoveGuarded && ((StateNo = 248 && Random < 500) || StateNo = 2010)
...
trigger1 = P2StateType = C && var(20)
trigger2 = var(6) && MoveHit
trigger2 = P2StateType != C && var(20) > 16

[State -1, Senseless Fists (Custom Combo)]
type = ChangeState
value = 2020
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && var(20)
triggerAll = (P2BodyDist x = [0, 80]) && (P2Dist y = [-95, 0]) && P2StateType != C && P2StateType != L
trigger1 = var(6) && MoveHit
...
triggerAll = (P2BodyDist x = [0, 65]) && (P2Dist y = [-90, 0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200, 499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 9) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 30]) && (P2Dist y = [-90, 0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200, 499]) && !AnimTime && ctrl
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 65]) && (P2Dist y = [-20, 0]) && P2StateType != A && P2StateType != L
triggerAll = (P2StateType = S || (P2StateType = C && P2MoveType = H))
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200, 499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 8) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [60, 80]) && (P2Dist y = [-80, 80]) && P2StateType = A
trigger1 = ctrl
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [-35, -20]) && (P2Dist y = [-45, 45]) && P2StateType = S
trigger1 = ctrl
trigger1 = vel y > 0 && Random < (100 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 40]) && (P2Dist y = [-75, 0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200, 499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 5) && Random < (250 * (AILevel ** 2 / 64.0))
...
[State -1, Senseless Chatter]
type = ChangeState
value = ifElse(var(5), 249, 248)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [7, 85]) && (P2Dist y = [-65, 0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = var(5)
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 53]) && (P2Dist y = [-100, 0]) && P2StateType != L && P2StateType = A
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 45]) && (P2Dist y = [-55, 0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 50]) && (P2Dist y = [-10, 0]) && P2StateType != A && P2StateType != L
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 35]) && (P2Dist y = [-35, 35]) && P2StateType != L
trigger1 = ctrl
trigger1 = vel y <= 0 && Random < (100 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 25]) && (P2Dist y = [-20, 20]) && P2StateType = S
trigger1 = ctrl
trigger1 = vel y > 0 && Random < (100 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 50]) && (P2Dist y = [-65, 65]) && P2StateType = S
trigger1 = ctrl
trigger1 = vel y > 0 && Random < (100 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 30]) && (P2Dist y = [-90, 0]) && P2StateType != C && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 50]) && (P2Dist y = [-35, 0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (250 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200, 499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 2) && Random < (250 * (AILevel ** 2 / 64.0))
trigger3 = StateNo = 900 && !AnimTime
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 40]) && (P2Dist y = [-55, 0]) && P2StateType != A && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (250 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200, 499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 2) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 60]) && (P2Dist y = [-10, 0]) && P2StateType != A && P2StateType != L
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (250 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200, 499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 2) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 25]) && (P2Dist y = [-30, 30]) && P2StateType != L
trigger1 = ctrl
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 25]) && (P2Dist y = [-25, 25]) && P2StateType = S
trigger1 = ctrl
trigger1 = vel y > 0 && Random < (250 * (AIlevel ** 2 / 64.0))
...
trigger1 = (P2BodyDist x = [130, 150]) && (P2Dist y = [-48, 0])
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = StateNo = 0 && PrevStateNo = 1110 && Power < 1000
trigger3 = StateNo = 0 && PrevStateNo = 2200 && Power < 1000
...
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = Power >= 500 && !var(16) && var(15) < 1
triggerAll = P2StateType != L
trigger1 = (P2BodyDist x = [130, 150]) && (P2Dist y = [-48, 0])
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 6]) && P2Dist y = 0
...
trigger2 = var(6) && MoveHit && (StateNo = 200 || StateNo = 230) && Power = 3000
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [-5, 30]) && (P2Dist y = [-35, 0]) && P2StateType != L
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = var(6) && ((MoveGuarded && Random < (333 * (AILevel ** 2 / 64.0))) || (MoveHit && Random < (500 * (AILevel ** 2 / 64.0)) && P2StateType = C))
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [-5, 20]) && (P2Dist y = [-75, 0]) && P2StateType != L
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = var(6) && ((MoveGuarded && Random < (333 * (AILevel ** 2 / 64.0))) || (MoveHit && Random < (500 * (AILevel ** 2 / 64.0)) && P2StateType = C))
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [7, 80]) && (P2Dist y = [-95, 0]) && P2StateType != L
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (125 * (AILevel ** 2 / 64.0))
trigger2 = var(6) && ((MoveGuarded && Random < (333 * (AILevel ** 2 / 64.0))) || (MoveHit && P2StateType != C))
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [-10, 6]) && (P2Dist y = [-80, 0]) && P2StateType != L
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (125 * (AILevel ** 2 / 64.0))
trigger2 = var(6) && MoveHit
...
trigger1 = StateNo = 2120 && var(7) && MoveHit && (Power < 2000 || Power = 3000)
trigger2 = StateNo = 0 && PrevStateNo = 2200 && (Power < 2000 || Power = 3000)
...
triggerAll = Power >= 2000 && var(20) <= 60
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000, 4999]))
trigger1 = StateNo = 2120 && var(7) && MoveHit
trigger2 = StateNo = 0 && PrevStateNo = 2200
trigger3 = StateNo = 3010 && AnimElemTime(54) >= 0 && var(8)
...
triggerAll = Power >= 3000 && !var(20)
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000, 4999]))
triggerAll = (P2BodyDist x = [-45, 45]) && P2StateType = L
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101]))

...
[State -1, Tenchi Haohken]
type = ChangeState
value = 3200
triggerAll = !AILevel
triggerAll = command = "TenchiHaohken"
triggerAll = RoundState = 2 && StateType != A
...
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXHaohShokoken"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
value = 3000
triggerAll = !AILevel
triggerAll = command = "HaohShokoken"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
[State -1, EX Moko Raijinsetsu]
type = ChangeState
value = 1530
triggerAll = !AILevel
triggerAll = command = "EXMokoRaijinsetsu"
triggerAll = RoundState=2 && StateType != A
...
value = 1430
triggerAll = !AILevel
triggerAll = command = "EXKyokugenryuRenbuken"
triggerAll = RoundState=2 && StateType != A
triggerAll = Power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXKoho"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Aerial Ko'oken]
type = changestate
value = 1080
triggerAll = !AILevel
triggerAll = command = "EXKo'oken"
...
[State -1, Moko Raijinsetsu]
type = ChangeState
value = 1500
triggerAll = !AILevel
triggerAll = command = "MokoRaijinsetsu"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1400
triggerAll = !AILevel
triggerAll = command = "KyokugenryuRenbuken"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
[State -1, Aerial Ko'oken]
type = ChangeState
value = 1050
triggerAll = !AILevel
triggerAll = command = "Ko'oken"
triggerAll = RoundState = 2 && StateType = A && (var(3) != [1,2])
triggerAll = !var(39)
triggerAll = ifElse(PrevStateNo = 1402, pos y <= -64, 1)
trigger1 = ctrl
trigger2 = var(6)
...
value = 1600
triggerAll = !AILevel
triggerAll = command = "Kogeki"
triggerAll = RoundState = 2 && StateType != A
trigger1 = P2StateType = L && P2StateNo != 5120 && P2Dist x < 75
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = ((StateNo = [200,201]) || StateNo = 231 || StateNo = 400) && Time >= 5
trigger3 = var(4)
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,58]) && (P2Dist y = [-64,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,80]) && (P2Dist y = [-121,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 2 / 64.0))
...
trigger1 = (P2BodyDist x = [0, 75]) && P2Dist y = 0
...
trigger3 = var(7) && StateNo = 1301 && var(10) != 2 && Random < (500 * (AILevel ** 2 / 64.0))
trigger4 = var(7) && StateNo = 1331 && var(10) != 2 && Random < (500 * (AILevel ** 2 / 64.0))

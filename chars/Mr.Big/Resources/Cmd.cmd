...
time = 5
;--------------------------------------------------------------------
[State -1, Rising Spear]
type=ChangeState
value=3500
triggerall=!AILevel && RoundState=2 && StateType != A && var(20)<=0 && power >= 3000&&command ="Rising Spear"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;======================================================================================================================================================
[State -1, MAX Crazy Drum Typhoon]
type=ChangeState
value=3150
triggerall=!AILevel && RoundState=2 && (stateno!=[3150,3199])&& StateType != A &&var(20) <= 60 && power >= 2000&&command ="MAX Crazy Drum Typhoon"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================================================================================================
[State -1, Crazy Drum Typhoon]
type=ChangeState
value=3100
triggerall=!AILevel && RoundState=2 && (stateno!=[3100,3149])&& StateType != A &&var(20) <= 60 && power >= 1000&&command ="Crazy Drum Typhoon"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================================================================================================
[State -1, MAX California Dreamin]
type=ChangeState
value=3250
triggerall=!AILevel && RoundState=2 && (stateno!=[3250,3299])&& StateType != A &&var(20) <= 60 && power >= 2000&&command ="MAX California Dreamin"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================================================================================================
[State -1, California Dreamin]
type=ChangeState
value=3200
triggerall=!AILevel && RoundState=2 && (stateno!=[3200,3249])&& StateType != A &&var(20) <= 60 && power >= 1000&&command ="California Dreamin"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================================================================================================
[State -1, Blaster Wave]
type=ChangeState
value=3050
triggerAll = numhelper(3005)=0 && numhelper(3505)=0
triggerall=!AILevel && RoundState=2 && (stateno!=[3000,3001])&& StateType != A &&var(20) <= 60 && power >= 2000&&command ="MAX Blaster Wave"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================================================================================================
[State -1, Blaster Wave]
...
value=3000
triggerAll = numhelper(3005)=0 && numhelper(3505)=0
triggerall=!AILevel && RoundState=2 && (stateno!=[3000,3001])&& StateType != A &&var(20) <= 60 && power >= 1000&&command ="Blaster Wave"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;======================================================================================================================================================
[State -1, Crazy Drum]
type = ChangeState
value=Ifelse(command="Crazy DrumEX"&&var(20) <= 60&&power>=500,1430,1400)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall=((command="Crazy Drum")||(command="Crazy DrumEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)&&stateno!=1405
trigger3=(stateno = [200,450]) && movecontact && (command="Crazy DrumEX"&&power>=500&&var(20) <= 60)
;======================================================================================================================================================
[State -1, Spinning Lancer]
type = ChangeState
value=Ifelse(command="Spinning LancerEX"&&var(20) <= 60&&power>=500,1330,1300)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall=((command="Spinning Lancer")||(command="Spinning LancerEX"&&power>=500&&var(20) <= 60))
triggerAll = numhelper(3005)=0
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="Spinning LancerEX"&&power>=500&&var(20) <= 60)
;======================================================================================================================================================
[State -1, California Romance]
type = ChangeState
value=Ifelse(command="California RomanceEX"&&var(20) <= 60&&power>=500,1230,1200)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall=((command="California Romance")||(command="California RomanceEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="California RomanceEX"&&power>=500&&var(20) <= 60)
;======================================================================================================================================================
[State -1, Cross Diving]
type = ChangeState
value=Ifelse(command="Cross Diving_EX"&&var(20) <= 60&&power>=500,1130,1100)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall=((command="Cross Diving")||(command="Cross Diving_EX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="Cross Diving_EX"&&power>=500&&var(20) <= 60)
;======================================================================================================================================================
[State -1, Ground Blaster]
type=ChangeState
value=Ifelse(command="Ground Blaster_EX"&&var(20) <= 60&&power>=500,1030,1000)
triggerall=!AILevel && RoundState=2 && StateType != A && Ifelse(!var(20),!var(39),Numhelper(1005)<8)
triggerall=((command="Ground Blaster")||(command="Ground Blaster_EX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)&&(stateno!=[1200,1290])
trigger3=(stateno = [200,450]) && movecontact && (command="Ground Blaster_EX"&&power>=500&&var(20) <= 60)
;========================================================================
...
trigger1=ctrl||stateno=[100,101]
trigger2=var(4)&&(stateno!=[1200,1290])
;---------------------------------------------------------------------------
...
;---------------------------------------------------------------------------
[State -1, Rising Spear AI]
type=ChangeState
value=3500
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3500,3599]) && StateType != A &&var(20)<=60&& power >= 3000 && random < (250 * (AIlevel ** 2 / 64.0))
...
;---------------------------------------------------------------------------
[State -1, Max Crazy Drum Typhoon AI]
type=ChangeState
value=3150
triggerall=AILevel && RoundState=2 && Numenemy && StateType != A && (stateno!=[3150,3501]) &&var(20) <= 60 && power >= 2000
triggerall=Ifelse(enemynear,statetype=A,(p2bodydist x=[25,80]),(p2bodydist x=[25,200]))  && (p2bodydist y = [ -70, -25]) && random < (150 * (AIlevel ** 2 / 64.0))
...
;----------------------------------------------------------------------
[State -1, Crazy Drum Typhoon AI]
type=ChangeState
value=3100
triggerall=AILevel && RoundState=2 && Numenemy && StateType != A && (stateno!=[3100,3501]) &&var(20) <= 60 && power >= 1000
...
trigger3=(stateno=[200,440])&&movehit&&random<200
;========================================================================
[State -1, Cross Diving AI]
type=ChangeState
value=Ifelse((power >= 500 && random < 50), 1130, 1100)
...
;========================================================================
[State -1, Crazy Drum AI]
type = ChangeState
value = ifElse(Power >= 500 && Random < 100 && (P2BodyDist x = [0,145]), 1330, 1300)

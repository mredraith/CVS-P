...
[State -1, Midnight Pleasure]
type = ChangeState
value = 3200
triggerAll = !AILevel
triggerAll = command = "MidnightPleasure"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, MAX Midnight Bliss]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXMidnightBliss"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Demon Blast]
type = ChangeState
value = 3150 
triggerAll = !AILevel
triggerAll = command = "MAXDemonBlast"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, Midnight Bliss]
type = ChangeState
value = 3000
triggerAll = !AILevel
triggerAll = command = "MidnightBliss"
triggerAll = RoundState = 2 && StateType != A
...
value = 3100
triggerAll = !AILevel
triggerAll = command = "DemonBlast"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, EX Hell Ride]
type = ChangeState
value = 1430
triggerAll = !AILevel
triggerAll = command = "EXHellRide"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = P2StateNo = 5110

[State -1, EX Negative Stolen]
type = ChangeState
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXNegativeStolen"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1230
triggerAll = !AILevel
triggerAll = command = "EXBatSpin"
triggerAll = RoundState = 2
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Demon Cradle]
type = ChangeState
value = 1130 + 50 * (StateNo = [100,111])
triggerAll = !AILevel
triggerAll = command = "EXDemonCradle"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,111])
trigger2 = var(6)

[State -1, EX Air Chaos Flare 2]
type = ChangeState
value = 1580
triggerAll = !AILevel
triggerAll = command = "EXChaosFlare2"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
[State -1, EX Air Chaos Flare]
type = ChangeState
value = 1080
triggerAll = !AILevel
triggerAll = command = "EXChaosFlare"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
value = 1400
triggerAll = !AILevel
triggerAll = command = "HellRide"
triggerAll = RoundState = 2 && StateType != A
trigger1 = P2StateNo = 5110

[State -1, Negative Stolen]
type = ChangeState
value = 1300
triggerAll = !AILevel
triggerAll = command = "NegativeStolen"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1200
triggerAll = !AILevel
triggerAll = command = "BatSpin"
triggerAll = RoundState = 2
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Demon Cradle]
type = ChangeState
value = 1100 + 50 * (StateNo = [100,111])
triggerAll = !AILevel
triggerAll = command = "DemonCradle"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,111])
trigger2 = var(6)

[State -1, Air Chaos Flare 2]
type = ChangeState
value = 1550
triggerAll = !AILevel
triggerAll = command = "ChaosFlare2"
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Chaos Flare 2]
type = ChangeState
value = 1500
triggerAll = !AILevel
triggerAll = command = "ChaosFlare2"
...
[State -1, Air Chaos Flare]
type = ChangeState
value = 1050
triggerAll = !AILevel
triggerAll = command = "ChaosFlare"
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = movecontact && (stateno = 200 || stateno = 210 || stateno = 215 || stateno = 230 || stateno = 240 || stateno = 245 || stateno = 400 || stateno = 410 || stateno = 430 || stateno = 440)
trigger3 = var(4)
...
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = movecontact && (stateno = 200 || stateno = 230 || stateno = 240 || stateno = 245 || stateno = 400 || stateno = 410 || stateno = 430 || stateno = 440)
trigger3 = var(4)
...
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = movecontact && (stateno = 200 || stateno = 210 || stateno = 215 || stateno = 230 || stateno = 240 || stateno = 245 || stateno = 400 || stateno = 430 || stateno = 440)
trigger3 = var(4)
...
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = movecontact && (stateno = 200 || stateno = 210 || stateno = 215 || stateno = 230 || stateno = 240 || stateno = 245 || stateno = 400 || stateno = 410 || stateno = 430)
trigger3 = var(4)

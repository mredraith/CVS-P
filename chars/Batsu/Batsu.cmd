...
[Command]
name="Max Ichimonji Style Barrage"
...
[Command]
name="Max Blazing Mikadzuki Kick"
...
;--------------------------------------------------------------------
[State -1, Double Zenkai Kiaidan]
type=ChangeState
value=3600
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="Double Zenkai Kiaidan"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;----------------------------------------------------------------------
[State -1, Super Guts Upper]
type=ChangeState
value=3500
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="Super Guts Upper"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;----------------------------------------------------------------------
[State -1, Max Super Ryuusei Kick]
type=ChangeState
value=3450
triggerall=!AILevel && RoundState=2 && (stateno!=[3450,3453])&& StateType = A &&var(20) <= 60 && power >= 2000&&Pos Y<=-30&&command ="Max Super Ryuusei Kick"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Super Ryuusei Kick]
type=ChangeState
value=3400
triggerall=!AILevel && RoundState=2 && (stateno!=[3400,3403])&& StateType = A &&var(20) <= 60 && power >= 1000&&Pos Y<=-30&&command ="Super Ryuusei Kick"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Ichimonji Style Barrage]
type=ChangeState
value=3350
triggerall=!AILevel && RoundState=2 && (stateno!=[3350,3353]) && StateType != A &&var(20) <= 60 && power >= 2000&&command ="Max Ichimonji Style Barrage"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Ichimonji Style Barrage]
type=ChangeState
value=3300
triggerall=!AILevel && RoundState=2 && (stateno!=[3300,3303]) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="Ichimonji Style Barrage"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Blazing Mikadzuki Kick]
type=ChangeState
value=3250
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="Max Blazing Mikadzuki Kick"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Blazing Mikadzuki Kick]
type=ChangeState
value=3200
triggerall=!AILevel && RoundState=2 && (stateno!=[3200,3202]) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="Blazing Mikadzuki Kick"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Zenkai Kiai Dan]
type=ChangeState
value=3010
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="Max Zenkai Kiai Dan"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Zenkai Kiai Dan]
type=ChangeState
value=3000
triggerall=!AILevel && RoundState=2 && (stateno!=[3000,3001]) && StateType != A &&var(20) <= 60 && power >= 1000&&command ="Zenkai Kiai Dan"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Max Air Zenkai Kiai Dan]
type=ChangeState
value=3150
triggerall=!AILevel && RoundState=2 && (stateno!=[3150,3151]) && StateType = A &&var(20) <= 60 && power >= 2000&&command ="Max Zenkai Kiai Dan"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Air Zenkai Kiai Dan]
type=ChangeState
value=3100
triggerall=!AILevel && RoundState=2 && (stateno!=[3100,3101]) && StateType = A &&var(20) <= 60 && power >= 1000&&command ="Zenkai Kiai Dan"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo = [110,111])
trigger2=var(6)|| var(7)
;========================================================================
[State -1, EX Mikadzuki Kick]
type=changestate
value=1350
triggerall=!AILevel && RoundState=2&& statetype!=A&&var(20) <= 60&&power>=500
triggerall = command = "EX Mikadzuki Kick" && var(12) < 2
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])|| (StateNo = [110,111])
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;-----------------------------------------------------------------------
[State -1, EX Ryuusei Kick]
type=changestate
value=1450
triggerall=!AILevel && RoundState=2&& statetype=A&&var(20) <= 60&&power>=500
triggerall = command = "EX Ryuusei Kick" && var(12) < 1
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])|| (StateNo = [110,111])
trigger2 = (stateno = [600,650])&&stateno!=420&&movecontact
trigger3= var(5)
;-----------------------------------------------------------------------
[State -1, Ryuusei Kick]
type=changestate
value=1400
triggerall=!AILevel && RoundState=2&& statetype=A
triggerall = command = "Ryuusei Kick" && var(12) < 2
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])|| (StateNo = [110,111])
trigger2 = (stateno = [600,650])&&stateno!=420&&movecontact
trigger3= var(5)
;------------------------------------------------------------------------
[State -1, Mikadzuki Kick]
type=changestate
value=1300
triggerall=!AILevel && RoundState=2&& statetype!=A
triggerall = command = "Mikadzuki Kick"
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])|| (StateNo = [110,111])
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;------------------------------------------------------------------------
[State -1, EX Guts Upper]
type=changestate
value=1250 + 10 * (var(45) = 1)
triggerall=!AILevel && RoundState=2&& statetype!=A&&var(20) <= 60&&power>=500
triggerall = command = "EX Guts Upper" && var(12) < 1
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])|| (StateNo = [110,111])
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;------------------------------------------------------------------------
...
value=1200
triggerall=!AILevel && RoundState=2&& statetype!=A
triggerall = command = "Guts Upper" && var(12) < 1
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])|| (StateNo = [110,111])
trigger2 = (stateno = [200,450])&&stateno!=420&&movecontact
trigger3= var(5)
;------------------------------------------------------------------------
[State -1, EX Air Kiai Dan]
type = ChangeState
value = 1150
triggerall =  !AILevel && roundstate=2 && statetype=A&&var(20) <= 60&&power>=500&&!numhelper(1155) && !numhelper(1105) && !numhelper(3155) && !numhelper(3105)
triggerall = command = "EX Kiai Dan"
trigger1 = ctrl
trigger2 = (stateno = [600,650])&&stateno!=420&&movecontact
trigger3= var(5)
;------------------------------------------------------------------------
[State -1, Air Kiai Dan]
type = ChangeState
value = 1100
triggerall =  !AILevel && roundstate=2 && statetype=A&&!numhelper(1105)&& !numhelper(1155) && !numhelper(3155) && !numhelper(3105)
triggerall = command = "Kiai Dan"
trigger1 = ctrl
trigger2 = (stateno = [600,650])&&stateno!=420&&movecontact
trigger3= var(5)
;------------------------------------------------------------------------
...
;------------------------------------------------------------------------
;Max Super Ryuusei Kick
[State -1, Max Super Ryuusei Kick]
type = changestate
value = 3450
triggerall=AIlevel&&roundstate = 2 && statetype = A &&power >= 1000&&var(20)<=60&&(enemynear,Movetype!=A)&&(enemynear,stateno!=[120,155])
triggerall=(enemynear,Movetype!=A)&&(enemynear,stateno!=[5100,5250])&&(enemynear,stateno!=[120,155])&&(enemynear,statetype!=A)&&(enemynear,statetype!=C)
triggerall=(p2dist x=[5,90])&&(p2dist y=[-40,205])&&(Ifelse(var(1),random<300,random<250)*(AIlevel ** 2 / 64.0))&&Pos Y<=-30
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
trigger1 = (stateno = 620 || stateno = 650)
trigger1 = (movehit = [1, 16]) && (p2bodydist x = [0, 30]) && random < (100 * (AIlevel ** 2 / 64.0))
trigger2 = (stateno = 1100 || stateno = [1301, 1303])
trigger2 = (movehit = [1, 16]) && random < (250 * (AIlevel ** 2 / 64.0))
trigger3=(var(6)) && movehit && random<200
trigger4=(var(7)) && movehit && random<50
;--------------------------------------------------------------------------
;Super Ryuusei Kick
[State -1, Super Ryuusei Kick]
type = changestate
...
triggerall=(enemynear, statetype != A) &&(enemynear, statetype = S)&& (enemynear, statetype = A)&&!numhelper(1105)&& !numhelper(1155) && !numhelper(3155) && !numhelper(3105)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
trigger1 = (stateno = 620 || stateno = 650)
trigger1 = (movehit = [1, 16]) && (p2bodydist x = [0, 30]) && random < (100 * (AIlevel ** 2 / 64.0))
trigger2 = (stateno = 1100 || stateno = [1301, 1303])
...
type = changestate
value = 3100
triggerall=AILevel && numenemy && RoundState=2 && StateType = A &&var(20)<=60&& power >= 1000 && random < (350 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,Movetype!=A)&&(enemynear,stateno!=[5100,5250])&&(enemynear,stateno!=[120,155])&&(enemynear,statetype!=A)&&(enemynear,statetype!=C)
triggerall = (p2bodydist x = [0, 120]) && p2dist y >= -20 && (enemynear, vel y < 4)
triggerall=(enemynear, statetype != A) &&(enemynear, statetype = S)&& (enemynear, statetype = A)&&!numhelper(1105)&& !numhelper(1155) && !numhelper(3155) && !numhelper(3105)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
...
type=ChangeState
value=3010
triggerall=AILevel && numenemy && RoundState=2 && (stateno!=[3010,3011])&& StateType != A && var(20) <= 60 && power >= 2000 && random < (100 * (AIlevel ** 2 / 64.0))
...
type = changestate
value=3200
triggerall=AILevel && numenemy && RoundState=2&& (stateno!=[3200,3202]) && StateType != A &&var(20)<=60&& power >= 1000 && random < (350 * (AIlevel ** 2 / 64.0))
...
triggerall=AIlevel&&roundstate = 2 && statetype != A&&(enemynear,Movetype!=A)&&(enemynear,stateno!=[120,155])
triggerall=(p2dist x=[30,120])&&(p2dist y=[-50,255])&&(Ifelse(var(1),random<250,random<200)*(AIlevel ** 2 / 64.0))&&Pos Y<=-40
...
type=ChangeState
value=1250 + 10 * (var(45) = 1)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A &&power>=500 &&var(20)<=60&& random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(p2stateno != [120, 155]) && (enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220]) && p2bodydist x >=10 && p2bodydist x <=70 &&(p2dist y=[-110,5]) &&(enemynear, statetype != C)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
trigger2=var(5)
trigger3=(stateno=[200,440])&&movehit&&random<200
...
triggerall=(p2bodydist x=[30,160]) && (p2bodydist y = [ -80, 205])  && random < (40 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155])&&(enemynear,stateno!=[5110,5220]) && enemynear,statetype!=C && enemynear,statetype!=L
triggerall=(enemynear, statetype != A) &&(enemynear, statetype = S)&& (enemynear, statetype = A)&&!numhelper(1105)&& !numhelper(1155) && !numhelper(3155) && !numhelper(3105)
trigger1=ctrl
trigger2=var(5)
trigger3=(stateno=[600,650])&&movehit&&random<200

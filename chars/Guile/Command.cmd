...
value = 3200
triggerAll = !AILevel
triggerAll = command = "SonicHurricane" && ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(48) > 0)
triggerAll = RoundState = 2 && StateType != A
...
triggerAll = !AILevel
triggerAll = command = "MAXTotalWipeout" && ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(48) > 0)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)
...
value = 3000
triggerAll = !AILevel
triggerAll = command = "SomersaultStrike" && ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(48) > 0 && var(50) > 0)
triggerAll = RoundState = 2 && StateType != A
...
triggerAll = !AILevel
triggerAll = command = "TotalWipeout" && ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(48) > 0)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

...
[Command]
name = "SoulTeleportFront_3P"
command = ~F, D, DF, x+y+z
time = 25

[Command]
name = "SoulTeleportBack_3P"
command = ~B, D, DB, x+y+z
time = 25

[Command]
name = "SoulTeleportFront_3K"
command = ~F, D, DF, a+b+c
time = 25

[Command]
name = "SoulTeleportBack_3K"
...
[State -1, Illusion Soul]
type = ChangeState
value = 3500
triggerAll = !AILevel
triggerAll = (command = "Illusion Spark" && var(41) != 0 && var(41) = 1) || (command = "Illusion Soul" && var(41) != 0 && var(41) = 2)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Illusion Spark]
type = ChangeState
value = 3200
triggerAll = !AILevel
triggerAll = command = "Illusion Spark" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, MAX Aura Soul Throw]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXAura Soul Throw"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Aura Soul Spark]
type = ChangeState
value = 3150
triggerAll = !AILevel
triggerAll = command = "MAXAura Soul Spark"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Soul Spiral Teleport]
type = ChangeState
value = 3650
triggerAll = !AILevel
triggerAll = (command = "MAXSoul Satellite" && var(41) != 0 && var(41) = 1) || (command = "MAXSoul Spiral Teleport" && var(41) != 0 && var(41) = 2)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

;[State -1, MAX Soul Illusion]
;type = ChangeState
;value = 3350
;triggerAll = !AILevel
;triggerAll = command = "MAXSoul Illusion"
;triggerAll = RoundState = 2 && StateType != A
;triggerAll = power >= 2000 && var(20) <= 60
;trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
;trigger2 = var(7) || var(8)

[State -1, MAX Soul Satellite]
type = ChangeState
value = 3450
triggerAll = !AILevel
triggerAll = command = "MAXSoul Satellite" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60 && !Numhelper(3405)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, Aura Soul Throw]
type = ChangeState
value = 3000
triggerAll = !AILevel
triggerAll = command = "Aura Soul Throw"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Aura Soul Spark]
type = ChangeState
value = 3100
triggerAll = !AILevel
triggerAll = command = "Aura Soul Spark"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Soul Spiral Teleport]
type = ChangeState
value = 3600
triggerAll = !AILevel
triggerAll = (command = "Soul Satellite" && var(41) != 0 && var(41) = 1) || (command = "Soul Spiral Teleport" && var(41) != 0 && var(41) = 2)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

;[State -1, Soul Illusion]
;type = ChangeState
;value = 3300
;triggerAll = !AILevel
;triggerAll = command = "Soul Illusion"
;triggerAll = RoundState = 2 && StateType != A
;triggerAll = power >= 1000 && var(20) <= 60
;trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
;trigger2 = var(7)

[State -1, Soul Satellite]
type = ChangeState
value = 3400
triggerAll = !AILevel
triggerAll = command = "Soul Satellite" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60 && !Numhelper(3405)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Soul Teleport]
type = ChangeState
value = 1400
triggerAll = !AILevel && var(41) != 0
triggerAll = command = "SoulTeleportFront_3P" || command = "SoulTeleportBack_3P" || command = "SoulTeleportFront_3K" || command = "SoulTeleportBack_3K"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Soul Drill]
type = ChangeState
value = 1530
triggerAll = !AILevel
triggerAll = (command = "EXSoul Spiral" && var(41) != 0 && var(41) = 1) || (command = "EXSoul Drill" && var(41) != 0 && var(41) = 2)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = movecontact && (stateno=225 || stateno=255 || stateno=420 || stateno=440)
trigger3 = var(6)

[State -1, EX Soul Reflect]
type = ChangeState
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXSoul Reflect"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = movecontact && (stateno=225 || stateno=255 || stateno=420 || stateno=440)
...
[State -1, EX Soul Spiral]
type = ChangeState
value = 1230
triggerAll = !AILevel
triggerAll = command = "EXSoul Spiral" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = movecontact && (stateno=225 || stateno=255 || stateno=420 || stateno=440)
...
[State -1, EX Soul Throw]
type = ChangeState
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXSoul Throw"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = movecontact && (stateno=225 || stateno=255 || stateno=420 || stateno=440)
...
[State -1, EX Soul Spark]
type = ChangeState
value = 1030
triggerAll = !AILevel
triggerAll = command = "EXSoul Spark"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
value = 1500
triggerAll = !AILevel
triggerAll = (command = "Soul Spiral" && var(41) != 0 && var(41) = 1) || (command = "Soul Drill" && var(41) != 0 && var(41) = 2)
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = movecontact && (stateno=225 || stateno=255 || stateno=420 || stateno=440)
trigger3 = var(6)

[State -1, Soul Reflect]
type = ChangeState
value = 1300
triggerAll = !AILevel
triggerAll = command = "Soul Reflect"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = movecontact && (stateno=225 || stateno=255 || stateno=420 || stateno=440)
trigger3 = var(6)
...
value = 1200
triggerAll = !AILevel
triggerAll = command = "Soul Spiral" && var(41) != 1
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = movecontact && (stateno=225 || stateno=255 || stateno=420 || stateno=440)
trigger3 = var(6)

...
[State -1, Black Hayato]
type = ChangeState
value = 3200
triggerAll = !AILevel
triggerAll = command = "Black Hayato"
triggerAll = RoundState = 2 && StateType != A
triggerAll = (power >= 3000 && !var(20) && !var(5)) || (power >= 0 && !var(20) && var(5))
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, MAX Hyper Flash Sword]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXHyper Flash Sword"
triggerAll = RoundState = 2 && StateType != A
triggerAll = (power >= 2000 && var(20) <= 60) || (power >= 0 && !var(20) && var(5))
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Plasma Field]
type = ChangeState
value = 3350
triggerAll = !AILevel
triggerAll = command = "MAXPlasma Field" && !var(5)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Scimitar]
type = ChangeState
value = 3150 
triggerAll = !AILevel
triggerAll = command = "MAXScimitar"
triggerAll = RoundState = 2 && StateType != A
triggerAll = (power >= 2000 && var(20) <= 60) || (power >= 0 && !var(20) && var(5))
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, Hyper Flash Sworde]
type = ChangeState
value = 3000
triggerAll = !AILevel
triggerAll = command = "Hyper Flash Sword"
triggerAll = RoundState = 2 && StateType != A
triggerAll = (power >= 1000 && var(20) <= 60) || (power >= 0 && !var(20) && var(5))
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Plasma Field]
type = ChangeState
value = 3300 
triggerAll = !AILevel
triggerAll = command = "Plasma Field" && !var(5)
triggerAll = RoundState = 2 && StateType != A
...
[State -1, EX Grab Launcher]
type = ChangeState
value = 1230
triggerAll = !AILevel
triggerAll = command = "EXGrab Launcher"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Crimson Sword]
type = ChangeState
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXCrimson Sword"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Flash Sword]
type = ChangeState
value = 1030
triggerAll = !AILevel
triggerAll = command = "EXFlash Sword"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Grab Launcher]
type = ChangeState
value = 1200
triggerAll = !AILevel
triggerAll = command = "Grab Launcher"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Crimson Sword]
type = ChangeState
value = 1100
triggerAll = !AILevel
triggerAll = command = "Crimson Sword"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1000
triggerAll = !AILevel
triggerAll = command = "Flash Sword"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 310
triggerAll = !AILevel
triggerAll = command != "holddown" && command = "holdback" && command = "x"
...
triggerAll = StateType != A
trigger1 = StateNo = 310 && movecontact = [1,4]
;trigger2 = var(4)
...
triggerAll = StateType != A
trigger1 = StateNo = 330 && movecontact = [1,4]
;trigger2 = var(4)
...
triggerAll = command = "x"
triggerAll = StateType != A
trigger1 = StateNo = 500 && movecontact = [1,4]
;trigger2 = var(4)
...
triggerAll = command != "holddown" && command = "x"
triggerAll = StateType != A
trigger1 = StateNo = 350 && movecontact = [1,4]
;trigger2 = var(4)
...
triggerAll = StateType != A
trigger1 = StateNo = 370 && movecontact = [1,4]
;trigger2 = var(4)
...
triggerAll = StateType != A
trigger1 = StateNo = 380 && movecontact = [1,4]
;trigger2 = var(4)
...
triggerAll = command != "holddown" && command = "z"
triggerAll = StateType != A
trigger1 = StateNo = 390 && movecontact = [1,4]
;trigger2 = var(4)
...
trigger1 = (EnemyNear, MoveType = H) && (EnemyNear, HitFall) && Random < (150 * (AILevel ** 2 / 64.0))
...
trigger1 = !InGuardDist && P2BodyDist x >= 160 && Random < (150 * (AILevel ** 2 / 64.0))
...
trigger1 = (EnemyNear, MoveType != A) && P2BodyDist x >= 160 && Random < (150 * (AILevel ** 2 / 64.0))

;===============================================================================
;===========================<HAYATO A.I NORMAL ATTACKS>=========================
;===============================================================================
...
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (125 * (AILevel ** 3 / 64.0))
...
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 3 / 64.0))
trigger3 = StateNo = 310 && MoveHit = [1,4]
...
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 3 / 64.0))
trigger3 = StateNo = 330 && MoveHit = [1,4]
...
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 3 / 64.0))
trigger3 = StateNo = 500 && MoveHit = [1,4]
...
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 3 / 64.0))
trigger3 = StateNo = 350 && MoveHit = [1,4]
...
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 3 / 64.0))
trigger3 = StateNo = 370 && MoveHit = [1,4]
...
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 3 / 64.0))
trigger3 = StateNo = 380 && MoveHit = [1,4]
...
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 3 / 64.0))
trigger3 = StateNo = 390 && MoveHit = [1,4]
...
trigger1 = ctrl
trigger1 = vel y > 0 && Random < (125 * (AILevel ** 3 / 64.0))
trigger2 = var(4) && Random < (150 * (AILevel ** 3 / 64.0))

[State -1, Jumping Heavy Sword]
type = ChangeState
value = 660
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType = A
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,70]) && (P2Dist y = [-52,0]) && P2StateType != A && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (125 * (AILevel ** 3 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 3 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,97]) && (P2Dist y = [-52,0]) && P2StateType != A && P2StateType != L
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (125 * (AILevel ** 3 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 3 / 64.0))
...
trigger1 = ctrl
trigger1 = vel y > 0 && Random < (ifElse(P2Dist x < 0, 250, 150) * (AILevel ** 3 / 64.0))
...
;===============================================================================
;===========================<HAYATO A.I SPECIAL MOVES>==========================
;===============================================================================

[State -1, Flash Sword]
type = ChangeState
value = ifElse(Power >= 500 && Random < 133, 1030, 1000)
triggerAll = AILevel && NumEnemy && (Power >= 0 && var(5))
triggerAll = RoundState = 2 && StateType != A
...
triggerAll = !var(16) && (var(15) < 1 || var(20))
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101]))
trigger1 = P2BodyDist x >= 15 && Random < (125 * (AILevel ** 3 / 64.0))
...
trigger3 = var(6) && MoveHit && Random < (150 * (AILevel ** 3 / 64.0))
...
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (125 * (AILevel ** 3 / 64.0))
trigger2 = var(6) && MoveHit && Random < (150 * (AILevel ** 3 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
trigger3 = (StateNo = 5120 || StateNo = 5201) && !AnimTime && Random < (250 * (AILevel ** 3 / 64.0))
...
;===============================================================================
;===========================<HAYATO A.I SUPER MOVES>============================
;===============================================================================

[State -1, Hyper Flash Sword]
type = ChangeState
value = 3000
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = (Power >= 1000 && var(20) <= 60) || (Power >= 0 && var(5))
...
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (200 * (AILevel ** 3 / 64.0))
trigger2 = var(7) && MoveHit && Random < (ifElse((var(20) = [1,30]), 200, 150) * (AILevel ** 3 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4

[State -1, Plasma Field]
type = ChangeState
value = 3300
triggerAll = AILevel && NumEnemy && !var(5)
triggerAll = RoundState = 2 && StateType != A
triggerAll = Power >= 1000 && var(20) <= 60
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000,4999]))
triggerAll = !(EnemyNear, ctrl) && ((EnemyNear, StateNo != [120,155]) || EnemyNear, StateType = A)
...
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = (Power >= 2000 && var(20) <= 60) || (Power >= 0 && var(5))
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000,4999]))
triggerAll = !(EnemyNear, ctrl) && ((EnemyNear, StateNo != [120,155]) || EnemyNear, StateType = A)
triggerAll = (P2BodyDist x = [-80,80]) && (P2Dist y = [-80,32])
...
trigger2 = var(7) && MoveHit && Random < (ifElse((var(20) = [1,30]), 200, 150) * (AILevel ** 3 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
trigger3 = StateNo = 3000 && AnimElemTime(43) = 0 && MoveHit && Random < (150 * (AIlevel ** 3 / 64.0))
...
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = (Power >= 3000 && var(20) <= 60) || (Power >= 0 && var(5))
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000,4999]))
triggerAll = !(EnemyNear, ctrl) && ((EnemyNear, StateNo != [120,155]) || EnemyNear, StateType = A)
triggerAll = (P2BodyDist x = [-80,80]) && (P2Dist y = [-80,32])
triggerAll = P2StateType != A && P2StateType != L && P2MoveType != A
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (200 * (AILevel ** 3 / 64.0))
trigger2 = var(7) && MoveHit && Random < (150 * (AIlevel ** 3 / 64.0))

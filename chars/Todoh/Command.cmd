...
[Command]
name = "ShinganKuzuOtoshi"
command = ~D, DF, F, D, DB, B, z+c
time = 32
...
value = 3100
triggerAll = !AILevel
triggerAll = command = "ShinganKuzuOtoshi"
...
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXChouKasaneAte"
triggerAll = RoundState = 2 && StateType != A
...
value = 3000
triggerAll = !AILevel
triggerAll = command = "ChouKasaneAte"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, EX Stunning Grab]
type = ChangeState
value = 1230
triggerAll = !AILevel
triggerAll = command = "EXStunningGrab"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Air Kasane Ate]
type = ChangeState
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXKasaneAte"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1080
triggerAll = !AILevel
triggerAll = command = "EXTaikuu"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Kasane Ate]
type = ChangeState
value = 1030
triggerAll = !AILevel
triggerAll = command = "EXKasaneAte"
...
[State -1, Stunning Grab]
type = ChangeState
value = 1200
triggerAll = !AILevel
triggerAll = command = "StunningGrab"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Air Kasane Ate]
type = ChangeState
value = 1100
triggerAll = !AILevel
triggerAll = command = "KasaneAte"
triggerAll = RoundState = 2 && StateType = A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
trigger1 = ctrl
trigger1 = vel y > 0 && Random < (25 * (AILevel ** 3 / 64.0))
trigger2 = var(4) && Random < (100 * (AILevel ** 3 / 64.0))
...
trigger1 = ctrl && Random < (25 * (AILevel ** 3 / 64.0))
trigger2 = var(4) && Random < (100 * (AILevel ** 3 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,110]) && (P2Dist y = [-76,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 3 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 3 / 64.0))
...
trigger4 = (StateNo = 5120 || StateNo = 5201) && !AnimTime && Random < (50 * (AILevel ** 3 / 64.0))
...
triggerAll = (EnemyNear, StateNo = [200,3999]) || (EnemyNear, HitDefAttr = SCA, NA) || (EnemyNear, HitDefAttr = SCA, SA) &&  InGuardDist && EnemyNear, vel x >= 0  && (EnemyNear, vel y = [-2,8])
...
trigger3 = StateNo = 3000 && AnimElemTime(12) = 0 && Random < (50 * (AILevel ** 3 / 64.0))

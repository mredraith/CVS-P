...
;--------------------------------------------------------------------
[State -1, SFIV Sorai Rengeki]
type=ChangeState
value=3400
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="SFIVSoraiRengeki"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;--------------------------------------------------------------------
;[State -1, CVS2 You Hou]
;type=ChangeState
;value=3350
;triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="YouHou"
;trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
;trigger2=var(6)

[State -1, SFIV You Hou]
type=ChangeState
value=3300
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="YouHou"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;----------------------------------------------------------------------
[State -1, Hiten Souryujin]
type=ChangeState
value=3100
triggerAll = (var(3) != [1,2]) && pos y <= -32
triggerall=!AILevel && RoundState=2 && StateType = A &&var(20) <= 60 && power >= 1000&&command ="HitenSouryujin"
trigger1 = ctrl
trigger2=var(6)
;----------------------------------------------------------------------
[State -1, Max Sorai Rengeki]
type=ChangeState
value=3050
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="MAXSoraiRengeki"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Sorai Rengeki]
type=ChangeState
value=3000
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 1000&&command ="SoraiRengeki"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;----------------------------------------------------------------------
[State -1, Genei Jin]
type = ChangeState
value = 900
triggerAll = !AILevel && command = "GeneiJin" && RoundState = 2 && StateType != A && power >= 1000 && !var(20)
trigger1 = ctrl || StateNo = 52 || (StateNo = [100,101])
trigger1 = !var(41)
trigger2 = (stateno = [1200, 1230]) && MoveContact && AnimElemTime(8) < 0
;========================================================================
[State -1, ZenpouTenshin]
type=ChangeState
value=Ifelse(command="ZenpouTenshinEX"&&var(20) <= 60&&power>=500,1430,1400)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="ZenpouTenshin1")||(command="ZenpouTenshin2")||(command="ZenpouTenshin3")||(command="ZenpouTenshinEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="ZenpouTenshinEX"&&power>=500&&var(20) <= 60)

[State -1, Nishokyaku]
type=ChangeState
value=Ifelse(command="NishokyakuEX"&&var(20) <= 60&&power>=500,1130,1100)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Nishokyaku1")||(command="Nishokyaku2")||(command="Nishokyaku3")||(command="NishokyakuEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="NishokyakuEX"&&power>=500&&var(20) <= 60)

[State -1, Tetsuzankou]
type=ChangeState
value=Ifelse(command="TetsuzankouEX"&&var(20) <= 60&&power>=500,1230,1200)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Tetsuzankou1")||(command="Tetsuzankou2")||(command="Tetsuzankou3")||(command="TetsuzankouEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="TetsuzankouEX"&&power>=500&&var(20) <= 60)

[State -1, Kobokushi]
type=ChangeState
value=Ifelse(command="KobokushiEX"&&var(20) <= 60&&power>=500,1330,1300)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Kobokushi1")||(command="Kobokushi2")||(command="Kobokushi3")||(command="KobokushiEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="KobokushiEX"&&power>=500&&var(20) <= 60)

[State -1, Zesshou Hohou]
type=ChangeState
value=Ifelse(command="ZesshouHohouEX"&&var(20) <= 60&&power>=500,1030,1000)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="ZesshouHohou1")||(command="ZesshouHohou2")||(command="ZesshouHohou3")||(command="ZesshouHohouEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="ZesshouHohouEX"&&power>=500&&var(20) <= 60)
;========================================================================
...
type=ChangeState
value=645
triggerall = (movetype !=H) && pos y <-55
triggerall=!AILevel&&Roundstate=2&&statetype = A && command="RaigekiShuu1"||command="RaigekiShuu2"||command="RaigekiShuu3"
trigger1=ctrl
trigger2=var(4)
...
trigger3=((stateno=[200,219])||(stateno=[230,249])||(stateno=[400,419])||(stateno=[430,449]))&&movecontact&&var(55)
;--------------------------------------------------------------------------
[State -1, Standing SFIV Low Punch]
type=ChangeState
value=205

...
value = 3200
triggerAll = !AILevel
triggerAll = command = "KishinTsui"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, MAX Tengu Ishi]
type = ChangeState
value = 3450
triggerAll = !AILevel
triggerAll = command = "MAXTenguIshi"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
triggerall = numhelper(3405) = 0
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Yagyou Dama]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXYagyouDama"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Kishin Riki]
type = ChangeState
value = 3350
triggerAll = !AILevel
triggerAll = command = "MAXKishinRiki"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
triggerall = var(46) = 0
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
[State -1, MAX Yagyou Oodama]
type = ChangeState
value = 3150 
triggerAll = !AILevel
triggerAll = command = "MAXYagyouOodama"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)
...
;triggerall = var(51) = 0
triggerall = ctrl
trigger1 = command = "x" && var(46) > 0 && statetype != A
trigger2 = command = "y" && var(46) > 0 && statetype != A
trigger3 = command = "z" && var(46) > 0 && statetype != A

[State -1, Kishin Kuuchuu Jigoku Guruma]
type = ChangeState
value = 3340
triggerall = ctrl
;triggerall = var(51) = 0
...
[State -1, Yagyou Oodama]
type = ChangeState
value = 3100
triggerAll = !AILevel
triggerAll = command = "YagyouOodama"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, EX Hitobashira Nobori]
type = ChangeState
value = 1430
triggerAll = !AILevel
triggerAll = command = "EXJinchuuWatari"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Niou Riki]
type = ChangeState
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXNiouRiki"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Jinchuu Watari]
type = ChangeState
value = 1230
triggerAll = !AILevel
triggerAll = command = "EXJinchuuWatari"
...
[State -1, EX Oni Yanma]
type = ChangeState
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXOniYanma" && ifElse(var(20) > 0 || (StateNo = [1000, 4999]), 1, var(50) > 16)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Nichirin Shou]
type = ChangeState
value = 1030
triggerAll = !AILevel
triggerAll = command = "EXNichirinShou" && ifElse(var(20) > 0 || (StateNo = [1000, 4999]), 1, var(48) > 16)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
[State -1, Hitobashira Nobori]
type = ChangeState
value = 1400
triggerAll = !AILevel
triggerAll = command = "JinchuuWatari"
triggerAll = RoundState = 2 && StateType = A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1300
triggerAll = !AILevel
triggerAll = command = "NiouRiki"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Jinchuu Watari]
type = ChangeState
value = 1200
triggerAll = !AILevel
triggerAll = command = "JinchuuWatari"
...
value = 1100
triggerAll = !AILevel
triggerAll = command = "OniYanma" && ifElse(var(20) > 0 || (StateNo = [1000, 4999]), 1, var(50) > 16)
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Nichirin Shou]
type = ChangeState
value = 1000
triggerAll = !AILevel
triggerAll = command = "NichirinShou" && ifElse(var(20) > 0 || (StateNo = [1000, 4999]), 1, var(48) > 16)
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 3340
triggerAll = AILevel && NumEnemy
triggerAll = var(46) > 0 && statetype = A
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000,4999]))
triggerAll = !(EnemyNear, ctrl) && ((EnemyNear, StateNo != [120,155]) || EnemyNear, StateType = A)
triggerAll = (P2BodyDist x = [-80,80]) && (P2Dist y = [-80,32])
triggerAll = P2StateType != A && P2StateType != L && P2MoveType != A

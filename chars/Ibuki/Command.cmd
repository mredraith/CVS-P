...
[State -1, MAX Yoroi Dooshi]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXYoroi Dooshi"
triggerAll = RoundState = 2 && StateType != A
...
[State -1, MAX Yami Shigure]
type = ChangeState
value = 3350
triggerAll = !AILevel
triggerAll = command = "MAXYami Shigure"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = stateno = 225 && movecontact
...
[State -1, Yoroi Dooshi]
type = ChangeState
value = 3000
triggerAll = !AILevel
triggerAll = command = "Yoroi Dooshi"
triggerAll = RoundState = 2 && StateType != A
...
[State -1, Yami Shigure]
type = ChangeState
value = 3300 
triggerAll = !AILevel
triggerAll = command = "Yami Shigure"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = stateno = 225 && movecontact
...
value = 1700
triggerAll = !AILevel
triggerAll = command = "Kasumi Gake"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = stateno = 219 && movecontact
trigger3 = var(4)

[State -1, Bonshou Geri]
type = ChangeState
value = 259
triggerAll = !AILevel
...
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = stateno = 246 && movecontact
trigger3 = var(4)

[State -1, Ura Maki Geri]
type = ChangeState
value = 246
triggerAll = !AILevel
...
triggerAll = vel x
trigger1 = ctrl
trigger2 = stateno = 631 && movecontact
trigger3 = var(4)
...
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 2 / 64.0))
trigger3 = stateno = 219 && movecontact
...
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 2 / 64.0))
trigger3 = stateno = 246 && movecontact

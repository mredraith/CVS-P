...
;---------------------------------------------------------------------------
;Use these triggers if you want to enable A.I. (Does not work on Winmugen!)
;[State -1, AI ON]		;;
;Type = VarSet
;TriggerAll = Var(58) < 1
...
triggerall = var(58) = 1
triggerall = var(20) = 0
triggerall = random <= 80 && statetype != A && power >= 1000
triggerall = (p2dist x = [130,150]) && !inguarddist
trigger1 = ctrl
...
trigger3= var(58)<=0 && (command="holdback" || command="holdup")
...
triggerall = var(58) = 1
triggerall = var(20) <= 0
triggerall = roundstate = 2 && random < 200 && statetype != A && power >= 3000 && !var(20)
...
triggerall = var(58) = 1
triggerall = var(20) <= 0
triggerall = roundstate = 2 && random < 300 && statetype = A && power >= 1000
...
value = 1600
triggerall = var(58) = 1
triggerall = roundstate = 2 && random < 200 && statetype != A && p2movetype != H
...
value = 1600
triggerall = var(58) = 1
triggerall = roundstate = 2 && random < 100 && statetype != A && p2movetype != H
triggerall = p2statetype = A && p2statetype != L && p2dist x <= 90 && p2dist y >= -95
trigger1 = ctrl
trigger2 = var(21)
...
triggerall = var(58) = 1
triggerall = var(20) = 0
triggerall = roundstate = 2 && random < 100 && statetype != A && power >= 500 && p2movetype != H

...
triggerall=!AILevel && RoundState=2 && StateType != A && (ifelse(var(20) > 0|| var(45)=1 || (stateno = [1000, 4999]), 1, var(51) > 16)) && prevstateno!=1120
...
triggerall=!AILevel && RoundState=2 && StateType != A && (ifelse(var(20) > 0|| var(45)=1 || (stateno = [1000, 4999]), 1, var(49) > 16)) && Ifelse(!var(20),!Numhelper(1005),Numhelper(1005)<4)
...
type=ChangeState
value=Ifelse((command="SchwarzeFlammeEX"||command="SchwarzeFlammeEX2")&&var(20) <= 60&&power>=500,1075,1050)
triggerall=!AILevel && RoundState=2 && StateType = A && (ifelse(var(20) > 0|| var(45)=1 || (stateno = [1000, 4999]), 1, var(49) > 16)) && (var(3) != [1, 2]) && pos y<=-20 && Ifelse(!var(20),!Numhelper(1005),Numhelper(1005)<4)
triggerall=(var(45)=0&&((command="SchwarzeFlamme1")||(command="SchwarzeFlamme2")||(command="SchwarzeFlamme3")||(command="SchwarzeFlammeEX"&&power>=500&&var(20) <= 60)))||(var(45)&&((command="SchwarzeFlamme4")||(command="SchwarzeFlamme5")||(command="SchwarzeFlamme6")||(command="SchwarzeFlammeEX2"&&power>=500&&var(20) <= 60)))
trigger1=ctrl
trigger2=var(5)
...
trigger2=var(4)
trigger3=((stateno=[200,219])||(stateno=[230,249])||(stateno=[400,419])||(stateno=[430,449]))&& movecontact && var(55)
trigger4=stateno=400&&movecontact&&!var(55)
;---------------------------------------------------------------------------
...
type = changestate
value = 120
trigger1 = AIlevel && numenemy && roundstate = 2 && inguarddist
trigger1 = ctrl && (stateno != [120, 155]) && !var(20) && p2bodydist x >= 40
trigger1 = !(enemynear, hitdefattr = SCA, AT) && (enemynear, time < 150)
trigger1 = statetype != A || p2statetype = A
trigger1 = ifelse(statetype = A, ((var(3) != [1, 2]) || stateno = 5210), 1)
trigger1 = random < (ifelse((p2stateno = [200, 699]), 350, ifelse((p2stateno = [1000, 2999]), 700, 1000)) * (AIlevel ** 2 / 64.0))
...
trigger1 = ctrl && power < const(data.power) && power < powermax && !var(20) && enemy,movetype!=A
...
triggerall = enemynear,movetype!=H&&enemynear,statetype!=A&&enemynear,Hitover&&(p2bodydist x =[0,40])
...
type = ChangeState
value = 200
triggerall = AILevel && numenemy&&roundstate=2&&StateType != A && Movetype!=H
...
triggerall = (p2bodydist x = [0, 65]) && p2statetype != L && !(enemynear, hitfall) && Movetype!=H
...
type = ChangeState
value = 230
triggerall = AILevel && numenemy && roundstate=2 && StateType != A && P2statetype != A && Movetype!=H
...
value = 240
triggerall = AILevel && numenemy && roundstate=2 && StateType != A && P2statetype != A && P2statetype != C
triggerall = (p2bodydist x = [0, 60]) && p2statetype != L && !(enemynear, hitfall) && Movetype!=H
...
trigger1 = ctrl && random < (150 * (AIlevel ** 2 / 64.0)) && Movetype!=H
...
trigger4 = stateno = 400 && movehit && !var(55) && random < 250
;---------------------------------------------------------------------------
[State -1, Crouching Low Kick]
type = ChangeState
value = 430
...
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && var(20)<=60 && (enemynear,vel y<=0) && prevstateno!=1120 && (enemynear,vel y<=0)
...
triggerall=(enemynear,statetype != L) && (enemynear,stateno!=[5100,5220]) && (enemynear,stateno!=[120,155]) && (p2bodydist x =[45,180]) && (p2bodydist y =[-90,5]) && (enemynear, statetype != A) && (enemynear, statetype != C) && (enemynear, movetype != A)
trigger1=(ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101]))
...
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && Ifelse(!var(20),!Numhelper(1005),Numhelper(1005)<4) && random < (Ifelse(var(20),300,50) * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L) && (enemynear,stateno!=[5100,5220]) && (p2bodydist x >=10) && (p2bodydist y =[-240,5]) && (enemynear, statetype != C) 
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=(stateno=[200,440]) && movehit && random<100
;------------------------------------------------------------------------
[State -1, Air Schwarze Flamme]
...
triggerall=AILevel && RoundState=2 && numenemy && StateType = A && (var(3) != [1, 2]) && pos y<=-20 && Ifelse(!var(20),!Numhelper(1005),Numhelper(1005)<4) && random < (Ifelse(var(20),500,150) * (AIlevel ** 2 / 64.0))
...
triggerall=(enemynear,statetype != L) && !(enemynear, hitfall) && (enemynear,stateno!=[5100,5220]) && (enemynear,stateno!=[120,155]) && (p2bodydist x =[30,120]) && (p2bodydist y =[-80,5]) && (enemynear, statetype != C) 

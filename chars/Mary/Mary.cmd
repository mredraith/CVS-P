...
[command]
name = "StraightSlicer1"
command = ~$B, $F, a
time = 15

[command]
name = "StraightSlicer2"
command = ~$B, $F, b
time = 15

[command]
name = "StraightSlicer3"
command = ~$B, $F, c
time = 15
...
trigger2=var(6)
;--------------------------------------------------------------------
[State -1, Mary Typhoon]
type=ChangeState
value=3300
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="M.Typhoon"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;----------------------------------------------------------------------
[State -1, Max M.Splash Rose]
type=ChangeState
value=3150
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="MaxSplashRose"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, M.Splash Rose]
type=ChangeState
value=3100
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 1000&&command ="SplashRose"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;----------------------------------------------------------------------
[State -1, Max M.Dynamite Swing]
type=ChangeState
value=3050
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="MaxDynamiteSwing"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, M.Dynamite Swing]
type=ChangeState
value=3000
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 1000&&command ="DynamiteSwing"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;========================================================================
;----------------------------------------------------------------------
[State -1, Straight Slicer]
type=ChangeState
value=Ifelse(command="StraightSlicerEX"&&var(20) <= 60&&power>=500,1230,1200)
triggerall=ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(48) > 0)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="StraightSlicer1")||(command="StraightSlicer2")||(command="StraightSlicer3")||(command="StraightSlicerEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="StraightSlicerEX"&&power>=500&&var(20) <= 60)
;----------------------------------------------------------------------
[State -1, Vertical Arrow]
type=ChangeState
value=Ifelse(command="VerticalArrowEX"&&var(20) <= 60&&power>=500,1130,1100)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="VerticalArrow1")||(command="VerticalArrow2")||(command="VerticalArrow3")||(command="VerticalArrowEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="VerticalArrowEX"&&power>=500&&var(20) <= 60)
trigger4 = stateno = 1205 && movecontact
;----------------------------------------------------------------------
[State -1, SpinFall]
type=ChangeState
value=Ifelse(command="SpinFallEX"&&var(20) <= 60&&power>=500,1030,1000)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="SpinFall1")||(command="SpinFall2")||(command="SpinFall3")||(command="SpinFallEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="SpinFallEX"&&power>=500&&var(20) <= 60)
;----------------------------------------------------------------------
[State -1, RealCounter]
type=ChangeState
value=Ifelse(command="RealCounterEX"&&var(20) <= 60&&power>=500,1330,1300)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="RealCounter1")||(command="RealCounter2")||(command="RealCounter3")||(command="RealCounterEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="RealCounterEX"&&power>=500&&var(20) <= 60)
;----------------------------------------------------------------------
[State -1, M.Reverse]
type=ChangeState
value=Ifelse(command="M.ReverseEX"&&var(20) <= 60&&power>=500,1430,1400)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="M.Reverse1")||(command="M.Reverse2")||(command="M.Reverse3")||(command="M.ReverseEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="M.ReverseEX"&&power>=500&&var(20) <= 60)
;========================================================================
...
;---------------------------------------------------------------------------
[State -1, Double Rolling]
type=ChangeState
value=260
triggerall=!AILevel&&Roundstate=2&&statetype != A&&command != "holddown"&& command="a" && command = "holdfwd"
trigger1=ctrl||stateno=[100,101]
trigger2=var(4)
trigger3=((stateno=[200,219])||(stateno=[230,249])||(stateno=[400,419])||(stateno=[430,449]))&&movecontact
;---------------------------------------------------------------------------
...
trigger1=ctrl||stateno=[100,101]
trigger2=var(4)
trigger3=((stateno=[200,210])||(stateno=[230,249])||(stateno=[400,419])||(stateno=[430,449]))&&movecontact
;--------------------------------------------------------------------------

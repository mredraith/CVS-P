...
=====<Features>=====
 ...
 - Special intros versus Terry, Rock and Vega
...
.Shinkuu Nage:			F/B + 2p   (near opponent)
.Toraya:			F/B + 2k   (near opponent)
...
.Fake Jaeiken:			F, DF, D, DB, B, s


<SUPER>

.Raising Storm (MAX):		DB, F, DF, D, DB, B, DF, p
...
.Thunder Break:			DB, F, DF, D, DB, B, DF, 2k
...
=====<Move Details>=====
 ...
 - Thunder Break's ground projectile(s) OTG and can only be blocked low.
...
- EX Jaeiken changed. The new version wall-bounces.
...
- Thunder Break made into a Level 3 with behavior being closer to 2K2UM's.
...
=====<What's Missing/To Do>=====
 ...
 - Revise the way Thunder Break hits so it's less luck-based.
 - Proper Thunder Break Ground Streak (current one is based on Don Drago's take).
...
RagingRowen:
- Warusaki3 for the Toraya anim and code.
- KarmaCharmeleon for some extra throw stuff, Reppuken FX, help & support, and more.
- Don Drago for the Thunder Break behavior reference.
- The Sudden Rarity for the Double Shippuken voice.

...
[State -1, Inferno Breath]
type       = ChangeState
value      = 3100
triggerall = !AIlevel
triggerall = command = "Inferno Breath"
...
[State -1, Hyper Rapid Kicks Max]
type       = ChangeState
value      = 3055
triggerall = !AIlevel
triggerall = command = "Hyper Rapid Kicks Max"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 2000, power >= 1000)
trigger1   = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2   = var(6) || var(7)
trigger3  = stateno = 3000 && movecontact
trigger4  = stateno = 3040 && movecontact
trigger5  = stateno = 3050 && movecontact

[State -1, Hyper Rapid Kicks]
type       = ChangeState
value      = 3050
triggerall = !AIlevel
triggerall = command = "Hyper Rapid Kicks"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 1000, power >= 0)
trigger1   = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2   = var(6)

[State -1, Balloon Bomb Max]
type       = ChangeState
value      = 3045
triggerall = !AIlevel
triggerall = command = "Balloon Bomb Max"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 2000, power >= 1000)
trigger1   = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2   = var(6) || var(7)
...
[State -1, Balloon Bomb]
type       = ChangeState
value      = 3040
triggerall = !AIlevel
triggerall = command = "Balloon Bomb"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 1000, power >= 0)
trigger1   = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2   = var(6)

[State -1, Super Fire Blast Max]
type       = ChangeState
value      = 3005
triggerall = !AIlevel
triggerall = command = "Super Fire Blast Max"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 2000, power >= 1000)
trigger1   = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2   = var(6) || var(7)
...
[State -1, Super Fire Blast]
type       = ChangeState
value      = 3000
triggerall = !AIlevel
triggerall = command = "Super Fire Blast"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 1000, power >= 0)
trigger1   = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2   = var(6)
...
[State -1, EX Super 100 Kick Air]
type = ChangeState
value = 2153
triggerall = !AIlevel
triggerall = command = "EX Super 100 Kick Air"
triggerall=RoundState=2&& statetype=A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])|| (StateNo = [110,111])
trigger2= var(5)

[State -1, Super 100 Kick Air]
type = ChangeState
value = 2150
triggerall = !AIlevel
triggerall = command = "Super 100 Kick Air"
triggerall=RoundState=2&& statetype=A
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])|| (StateNo = [110,111])
trigger2= var(5)

[State -1, EX Super 100 Kick]
type = ChangeState
value = 2053
triggerall = !AIlevel
triggerall = command = "EX Super 100 Kick"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)

[State -1, Super 100 Kick]
type = ChangeState
value = 2050
triggerall = !AIlevel
triggerall = command = "Super 100 Kick" 
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
...
[State -1, EX Balloon Attack]
type = ChangeState
value = 2003
triggerall = !AIlevel
triggerall = command = "EX Balloon Attack"
triggerall=RoundState=2&& statetype=A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])|| (StateNo = [110,111])
trigger2= var(5)

[State -1, Balloon Attack]
type = ChangeState
value = 2000
triggerall = !AIlevel
triggerall = command = "Balloon Attack"
triggerall=RoundState=2&& statetype=A
trigger1= ctrl || stateno=40 || stateno=52 || (stateno=[100,101])|| (StateNo = [110,111])
trigger2= var(5)
...
value = 1053
triggerall = !AIlevel
triggerall = command = "EX Fire Breath"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
...
[State -1, EX Fire Blast]
type = ChangeState
value = 1003
triggerall = !AIlevel
triggerall = command = "EX Fire Blast"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
...
[State -1, Crouch Kick Strong Teleport]
type = ChangeState
value = 455
triggerall = !AIlevel
...
triggerAll = (P2BodyDist x = [-30,100]) && (P2Dist y = [-32,32])
...
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000,4999]))
triggerAll = !(EnemyNear, ctrl) && ((EnemyNear, StateNo != [120,155]) || EnemyNear, StateType = A)
triggerAll = (P2BodyDist x = [-15,100]) && (P2Dist y = [-32,32])
...
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000,4999]))
triggerAll = !(EnemyNear, ctrl) && ((EnemyNear, StateNo != [120,155]) || EnemyNear, StateType = A)
triggerAll = (P2BodyDist x = [-20,100]) && (P2Dist y = [-32,32])
triggerAll = P2StateType != A && P2StateType != L && P2MoveType != A
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (100 * (AILevel ** 2 / 64.0))
trigger2 = var(7) && MoveHit && Random < (ifElse((var(20) = [1,30]), 200, 50) * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
...
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000,4999]))
triggerAll = !(EnemyNear, ctrl) && ((EnemyNear, StateNo != [120,155]) || EnemyNear, StateType = A)
triggerAll = (P2BodyDist x = [-25,100]) && (P2Dist y = [-32,32])
triggerAll = P2StateType != A && P2StateType != L && P2MoveType != A
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (100 * (AILevel ** 2 / 64.0))
trigger2 = var(7) && MoveHit && Random < (ifElse((var(20) = [1,30]), 200, 50) * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
...
triggerAll = (P2BodyDist x = [-8,160]) && P2Dist y >= -130
...
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = P2StateType = A
triggerAll = (P2BodyDist x = [-8,160]) && P2Dist y >= -135
trigger1 = ctrl && Random < (50 * (AILevel ** 2 / 64.0))
trigger2 = var(6) && MoveHit && P2StateType = A

[State -1, Super 100 Kick]
type = ChangeState
value = ifElse((var(40) = 0 || var(40) = 3) && Power >= 500 && Random < 133, 2053, 2050)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
triggerAll = !var(16) && (var(15) < 1 || var(20))
...
trigger2 = EnemyNear, Random < (50 * (AILevel ** 2 / 64.0))
...
[State -1, Fire Breath]
type = ChangeState
value = ifElse((var(40) = 0 || var(40) = 3) && Power >= 500 && Random < 100, 1053, 1050)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
triggerAll = !var(16) && (var(15) < 1 || var(20))
...
[State -1, Fire Blast]
type = ChangeState
value = ifElse((var(40) = 0 || var(40) = 3) && Power >= 500 && Random < 100, 1003, 1000)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
triggerAll = !var(16) && (var(15) < 1 || var(20))

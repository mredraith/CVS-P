...
value = 3150
triggerAll = !AILevel
triggerall = command = "LightningUppercutMAX"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 2000, power >= 1000)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101]) || StateNo = 1050
trigger2 = var(6) || var(7)
;
[State -1, Devil Rage Max]
type = ChangeState
value = 3050
triggerAll = !AILevel
...
value = 3100
triggerAll = !AILevel
triggerall = command = "LightningUppercut"
triggerall = RoundState = 2 && StateType != A
...
[State -1, Twin Pistons]
type = ChangeState
value = 1530
triggerAll = !AILevel
triggerall = command = "Sokushitsu Goda"
triggerall = RoundState = 2 && StateType != A
...
value = 1430
triggerAll = !AILevel
triggerall = command = "EX KF Zankou"
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
...
[State -1, Slaughter High Kick]
type = ChangeState
value = 1510
triggerAll = !AILevel
triggerall = command = "Slaughter High Kick"
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)

[State -1, Slaughter Hook]
type = ChangeState
value = 1500
triggerAll = !AILevel
triggerall = command = "Slaughter Hook"
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)

[State -1, Strong KF Zankou]
type = ChangeState
value = 1420
triggerAll = !AILevel
triggerall = command = "KF Zankou3"
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)

[State -1, Medium KF Zankou]
type = ChangeState
value = 1410
triggerAll = !AILevel
triggerall = command = "KF Zankou2"
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)

[State -1, Light KF Zankou]
type = ChangeState
value = 1400
triggerAll = !AILevel
triggerall = command = "KF Zankou"
triggerall = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)
...
[State -1, Glorious Demon God Fist]
type = Changestate
value = 223
triggerAll = !AILevel
...
value = 252
triggerAll = !AILevel
triggerall = command = "kk" && command = "holddown"
...
trigger2 = command = "FF" && stateno = 1050
...
triggerAll = ctrl && (StateNo != [100,105]) && !var(26)
...
trigger1 = (EnemyNear, MoveType != A) && P2BodyDist x >= 260 && Random < (155 * (AILevel ** 2 / 64.0))
...
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = (P2BodyDist x = [0,200]) && P2StateType != C && P2StateType != L
...
trigger3 = (StateNo = 5120 || StateNo = 5201) && !AnimTime && Random < (120 * (AILevel ** 2 / 64.0))
trigger4 = (NumTarget(1165) || NumTarget(1530) || NumTarget(1590))
trigger4 = (ctrl || StateNo = 52 || (StateNo = [100, 101])); && Random < (500 * (AILevel ** 2 / 64.0))
...
trigger1 = ctrl && Random < (145 * (AIlevel ** 2 / 64.0))
...
triggerAll = (P2BodyDist x = [0,65]) && (P2Dist y = [-67,0]) && P2StateType != C && P2StateType != L
...
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (280 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,65]) && (P2Dist y = [-100,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,68]) && (P2Dist y = [-100,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (95 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,75]) && (P2Dist y = [-22,0]) && P2StateType != A && P2StateType != L
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,60]) && (P2Dist y = [-30,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,70]) && (P2Dist y = [-15,0]) && P2StateType != A && P2StateType != L
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200, 499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 2 / 64.0))
...
type = ChangeState
value = ifElse((ifelse(var(20) <= 0, power >= 500, power >= 0)) && Random < 100, 1530, ifElse(Random < 333 || P2BodyDist x > 76, 1510, ifElse(Random < 333 || P2BodyDist x > 68, 1500, 1520)))
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [-8,86]) && (P2Dist y = [-75,0]) && (P2StateType != L || P2StateNo = 5120)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (90 * (AILevel ** 2 / 64.0))
trigger2 = var(5) && MoveHit && Random < (250 * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 6
trigger3 = var(5) && MoveGuarded && Random < (100 * (AILevel ** 2 / 64.0))
trigger3 = EnemyNear, GetHitVar(HitTime) >= 6

[State -1, EX Rising Sun]
type = ChangeState
value = 1430
triggerAll = AILevel && NumEnemy && (ifelse(var(20) <= 0, power >= 500, power >= 0))
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [-30,120]) && (P2Dist y = [-35,0]) && (P2StateType != L || P2StateNo = 5120); && P2StateType != C
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (55 * (AILevel ** 2 / 64.0))
trigger2 = var(5) && MoveHit && Random < (85 * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 3
[State -1, Heavy Rising Sun]
type = ChangeState
value = 1420
triggerAll = AILevel && NumEnemy && !var(59)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [-30,110]) && (P2Dist y = [-35,0]) && (P2StateType != L || P2StateNo = 5120); && P2StateType != C
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (45 * (AILevel ** 2 / 64.0))
trigger2 = var(5) && MoveHit && Random < (85 * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 3
[State -1, Medium Rising Run]
type = ChangeState
value = 1410
triggerAll = AILevel && NumEnemy && !var(59)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [-30,100]) && (P2Dist y = [-35,0]) && (P2StateType != L || P2StateNo = 5120); && P2StateType != C
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (35 * (AILevel ** 2 / 64.0))
trigger2 = var(5) && MoveHit && Random < (75 * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 3
[State -1, Light Rising Sun]
type = ChangeState
value = 1400
triggerAll = AILevel && NumEnemy && !var(59)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [-30,90]) && (P2Dist y = [-35,0]) && (P2StateType != L || P2StateNo = 5120); && P2StateType != C
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = var(5) && MoveHit && Random < (65 * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 3
...
trigger1 = (p2bodydist x = [0, 36]) && p2dist y = 0
trigger1 = ctrl && random < (200 * (AIlevel ** 2 / 64.0))

[State -1, Devil Strike]
type = ChangeState
value = 3050
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerall = power>=cond(var(20)>0,1000,2000)
...
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerall = power>=cond(var(20)>0,0,1000)
triggerAll = !var(16) && (var(15) < 1 || (StateNo = [1000,4999]))
triggerAll = !(EnemyNear, ctrl) && (EnemyNear, StateNo != [120,155])
triggerAll = (P2BodyDist x = [0,65]) && (P2Dist y = [-32,0]) && (EnemyNear, StateType != L) && (EnemyNear, vel y >= 0)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (100 * (AILevel ** 2 / 64.0))
...
triggerAll = P2StateType != L && (P2Dist y = [-82,0])
triggerAll = P2BodyDist x = [0,70]
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (100 * (AILevel ** 2 / 64.0))
trigger2 = var(6) && MoveHit && Random < (200 * (AIlevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
trigger2 = (StateNo != [1400, 1499])
...
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerall = power>=cond(var(20)>0,1000,3000)
triggerAll = !var(16) && (var(15) < 1 || (StateNo = [1000, 4999]))
triggerAll = !(EnemyNear, ctrl) && (EnemyNear, StateNo != [120,155])
triggerAll = (P2BodyDist x = [0,80])
triggerAll = P2StateType != A && P2StateType != L
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (500 * (AIlevel ** 2 / 64.0))
trigger2 = var(6) && MoveHit && Random < (300 * (AIlevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
trigger2 = (StateNo != [1400, 1499])
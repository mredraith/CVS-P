...
;| CVS Chang Koehan by Falcon Rapper        |
; ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
;==================================================================================================================================================================
;=======================================<COMMAND FILE>=========================================
;==================================================================================================================================================================
...
;-| Super Motions |--------------------------------------------------------
[Command]
name="Tekkyu Dai Bousou Ousatsu"
command=~D, DF, F, D, DB, B, x+y+z
time=80

[Command]
name="Tekkyu Dai Bousou MAX"
...
[Command]
name = "Dai Hakai Nage1"
command = ~D, DB, B, F, x
time = 30
[Command]
name = "Dai Hakai Nage2"
command = ~D, DB, B, F, y
time = 30
[Command]
name = "Dai Hakai Nage3"
command = ~D, DB, B, F, z
time = 30

[Command]
name = "Dai Hakai NageEX"
...
[Command]
name = "Tekkyu Dai Kaiten1"
command = ~x, x
time = 20
[Command]
name = "Tekkyu Dai Kaiten2"
command = ~y, y
time = 20
[Command]
name = "Tekkyu Dai Kaiten3"
command = ~z, z
time = 20

[Command]
name = "Tekkyu Dai KaitenEX"
command = x+y,x+y
time = 20
[Command]
name = "Tekkyu Dai KaitenEX"
...
[Command]
name = "Tekkyu Funsai Geki1"
command = ~15$B, F, x
time = 15
[Command]
name = "Tekkyu Funsai Geki2"
command = ~15$B, F, y
time = 15
[Command]
name = "Tekkyu Funsai Geki3"
command = ~15$B, F, z
time = 15

[Command]
name = "Tekkyu Funsai GekiEX"
command = ~15$B, F, y+z
time = 15
[Command]
name = "Tekkyu Funsai GekiEX"
...
;Tekkyuu Taiko Uchi
[Command]
name = "Tekkyuu Taiko Uchi1"
command = ~D, DF, F, a
time = 16
[Command]
name = "Tekkyuu Taiko Uchi2"
command = ~D, DF, F, b
time = 16
[Command]
name = "Tekkyuu Taiko Uchi3"
command = ~D, DF, F, c
time = 16

[Command]
name = "Tekkyuu Taiko UchiEX"
command = ~D, DF, F, a+b
time = 16
[Command]
name = "Tekkyuu Taiko UchiEX"
...
;============================================================================================================================================-----------------------------------------------------------------
;============================================================================================================================================
[State -1, Tekkyu Dai Bousou Ousatsu]
type = ChangeState
value = 3500
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="Tekkyu Dai Bousou Ousatsu"
...
;============================================================================================================================================-----------------------------------------------------------------
;============================================================================================================================================
[State -1, Tekkyu Dai Bousou MAX]
type = ChangeState
value = 3050
triggerall=!AILevel && RoundState=2 && (stateno!=[3015,3060]) && StateType != A && var(20) <= 60 && power >= 2000&&command ="Tekkyu Dai Bousou MAX"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno = [200,450]) && movecontact
;============================================================================================================================================
[State -1, Tekkyu Dai Bousou LV.2]
type = ChangeState
value = 3150
triggerall=!AILevel && RoundState=2 && (stateno!=[3150,3170]) && StateType != A && var(20) <= 60 && power >= 2000&&command ="Tekkyuu Dai Assatsu MAX"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno = [200,450]) && movecontact
;============================================================================================================================================
...
;============================================================================================================================================-----------------------------------------------------------------
;============================================================================================================================================
[State -1, Tekkyu Dai Bousou]
type = ChangeState
value = 3000
triggerall=!AILevel && RoundState=2 && (stateno!=[3000,3018]) && StateType != A && var(20) <= 60 && power >= 1000&&command ="Tekkyu Dai Bousou"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno = [200,450]) && movecontact
;============================================================================================================================================
[State -1, Tekkyuu Dai Assatsu]
type = ChangeState
value = 3100
triggerall=!AILevel && RoundState=2 && (stateno!=[3100,3101]) && StateType != A && var(20) <= 60 && power >= 1000&&command ="Tekkyuu Dai Assatsu"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno = [200,450]) && movecontact
;============================================================================================================================================
...
[State -1, Hienzan]
type = ChangeState
value=Ifelse(command="HienzanEX" &&var(20) <= 60&&power>=500,1350,1300)
...
type = ChangeState
value=Ifelse(command="Tekkyuu Taiko UchiEX" &&var(20) <= 60&&power>=500,1450,1400)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Tekkyuu Taiko Uchi1"|command="Tekkyuu Taiko Uchi2"|command="Tekkyuu Taiko Uchi3")||(command="Tekkyuu Taiko UchiEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="Tekkyuu Taiko UchiEX"&&power>=500&&var(20) <= 60)
;============================================================================================================================================
[State -1, Dai Hakai Nage]
type = ChangeState
value=Ifelse(command="Dai Hakai NageEX" &&var(20) <= 60&&power>=500,1250,1200)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Dai Hakai Nage1"|command="Dai Hakai Nage2"|command="Dai Hakai Nage3")||(command="Dai Hakai NageEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="Dai Hakai NageEX"&&power>=500&&var(20) <= 60)
;============================================================================================================================================
[State -1, Senpuu Hien Sashi]
type = ChangeState
value=Ifelse(command="Tekkyu Funsai GekiEX" &&var(20) <= 60&&power>=500,1150,1100)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Tekkyu Funsai Geki1"|command="Tekkyu Funsai Geki2"|command="Tekkyu Funsai Geki3")||(command="Tekkyu Funsai GekiEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="Tekkyu Funsai GekiEX"&&power>=500&&var(20) <= 60)
;============================================================================================================================================
[State -1, Tekkyu Dai Kaiten]
type = ChangeState
value=Ifelse((command="Tekkyu Dai KaitenEX")&&var(20) <= 60&&power>=500,1010,1000)
triggerall=!AILevel && RoundState=2 && StateType != A && Ifelse(!var(20),!Numhelper(1005),Numhelper(1005)<8)
triggerall=(var(45)=0&&(command="Tekkyu Dai Kaiten1")||(command="Tekkyu Dai Kaiten2")||(command="Tekkyu Dai Kaiten3")||(command="Tekkyu Dai KaitenEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="Tekkyu Dai KaitenEX"&&power>=500&&var(20) <= 60)
;============================================================================================================================================
...
trigger4=(stateno = [210,220])||(stateno=[410,420])&&movecontact
trigger5=((stateno=[200,210])||(stateno=[230,240])||(stateno=[410,420])||(stateno=[430,440]))&&movecontact&&var(55)
;--------------------------------------------------------------------------
...
type=ChangeState
value=3500
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && (stateno!=[3500,3590]) && var(20)<=0 && power >= 3000 && random < (250 * (AIlevel ** 2 / 64.0))
...
;============================================================================================================================================
[State -1, MAX Tekkyu Dai Bousou]
type=ChangeState
value=3050
triggerall=AILevel && numenemy && RoundState=2 && StateType != A && (stateno!=[3000,3018]) && var(20)<=60&& power >= 2000 && random < (200 * (AIlevel ** 2 / 64.0))
triggerall=(p2stateno != [120, 155]) && (enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x =[20,100]) && (p2bodydist y =[-70,5]) &&(enemynear, statetype != A)&&(enemynear, statetype != C)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=(var(6)|| var(7))&&movehit
trigger3=(stateno=[200,450])&&movehit&&random<200
...
trigger3=(stateno=[200,450])&&movehit&&random<200
;============================================================================================================================================
[State -1, MAX Tekkyuu Dai Assatsu]
type=ChangeState
value=3150
triggerall=AILevel && RoundState=2 && numenemy && StateType != A && (stateno!=[3150,3170]) && var(20)<=0 && power >= 2000 && random < (250 * (AIlevel ** 2 / 64.0))
...
[State -1, Hienzan]
type=ChangeState
value=Ifelse((power >= 900 && random < 100), 1350, 1300)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A &&var(20)<=60&& random < (250 * (AIlevel ** 2 / 64.0))
...
trigger2=(stateno = [210,220])||(stateno=[410,420]) && movehit && random<50
;============================================================================================================================================

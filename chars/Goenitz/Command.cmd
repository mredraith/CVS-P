...
[State -1, Super Yamidoukoku]
type = ChangeState
value = 3300
triggerAll = !AILevel
triggerAll = command = "SuperYamidoukoku"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, MAX Fuujin Ibuki]
type = ChangeState
value = 3250
triggerAll = !AILevel
triggerAll = command = "MAXFuujinIbuki"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Shin Yaotome: Mizuchi]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXShinYaotome:Mizuchi"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Yamidoukoku]
type = ChangeState
value = 3150 
triggerAll = !AILevel
triggerAll = command = "MAXYamidoukoku"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, Shin Yaotome: Mizuchi]
type = ChangeState
value = 3000
triggerAll = !AILevel
triggerAll = command = "ShinYaotome:Mizuchi"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Fuujin Ibuki]
type = ChangeState
value = 3200
triggerAll = !AILevel
triggerAll = command = "FuujinIbuki"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 3100
triggerAll = !AILevel
triggerAll = command = "Yamidoukoku"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, EX Cutting Wind]
type = ChangeState
value = 1530
triggerAll = !AILevel
triggerAll = command = "EXCuttingWind"
triggerAll = RoundState = 2 && StateType != A
...
value = 1430
triggerAll = !AILevel
triggerAll = command = "EXSouga"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Shin Aoi Hana: Seiran]
type = ChangeState
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXShinAoiHana:Seiran"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Wanpyou Tokobuse]
type = ChangeState
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXWanpyouTokobuse"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1500
triggerAll = !AILevel
triggerAll = command = "CuttingWind"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1400
triggerAll = !AILevel
triggerAll = command = "Souga"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Shin Aoi Hana: Seiran]
type = ChangeState
value = 1300
triggerAll = !AILevel
triggerAll = command = "ShinAoiHana:Seiran"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1200
triggerAll = !AILevel
triggerAll = command = "Hyouga"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Wanpyou Tokobuse]
type = ChangeState
value = 1100
triggerAll = !AILevel
triggerAll = command = "WanpyouTokobuse"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
trigger1 = (EnemyNear, MoveType != A) && P2BodyDist x >= 160 && Random < (50 * (AILevel ** 3 / 64.0))

;===============================================================================
;===========================<GOENITZ A.I NORMAL ATTACKS>========================
;===============================================================================
...
triggerAll = (EnemyNear, Const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = ctrl && P2StateType = C && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = Var(5) && MoveContact && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 3 / 64.0))
...
trigger3 = (StateNo = 5120 || StateNo = 5200) && !AnimTime && Random < (50 * (AILevel ** 2 / 64.0))
...
trigger2 = var(6) && MoveContact && Random < (100 * (AILevel ** 3 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
...
trigger3 = var(6) && MoveContact && Random < (100 * (AILevel ** 3 / 64.0))
trigger3 = EnemyNear, GetHitVar(HitTime) >= 4

;===============================================================================
;===========================<GOENITZ A.I SUPER MOVES>===========================
;===============================================================================
...
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
trigger3 = (StateNo = 5120 || StateNo = 5201) && !AnimTime && Random < (50 * (AILevel ** 3 / 64.0))
trigger4 = StateNo = 3010 && AnimElemTime(11) = 0 && MoveHit && Random < (50 * (AIlevel ** 3 / 64.0))
trigger5 = StateNo = 3201 && AnimElemTime(6) = 0 && MoveHit && Random < (50 * (AIlevel ** 3 / 64.0))

...
triggerAll = RoundState = 2 && StateType != A
triggerAll = ifelse(var(53) <= 0, power >= 3000 && !var(20), power >= 1000)
;triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Sunshine]
type = ChangeState
value = 3150
triggerAll = !AILevel
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = ifelse(var(53) <= 0, power >= 1000 && var(20) <=60, 1)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 1150
triggerAll = !AILevel
triggerAll = command = "fdf2k"
triggerAll = RoundState = 2 && StateType != A
triggerAll = ifelse(var(53) <= 0, power >= 500 && var(20) <= 60, 1)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = ifelse(var(53) <= 0, power >= 500 && var(20) <= 60, 1)
triggerAll = ifelse(!var(20), Cond(!NumHelper(1005), 1, (Helper(1005), StateNo = 1006)), 1)
triggerAll = ifelse(!var(20), Cond(!NumHelper(1055), 1, (Helper(1055), StateNo = 1006)), 1)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
type = ChangeState
value = 220 + (Abs(P2BodyDist X) <= 32) * 1
triggerAll = !AILevel
...
type = ChangeState
value = 240 + (Abs(P2BodyDist X) <= 32) * 1
triggerAll = !AILevel
...
[State -1, Standing Heavy Punch]
type = ChangeState
value = 220 + (Abs(P2BodyDist x) <= 25) * 1 
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
...
type = ChangeState
value = 240 + (Abs(P2BodyDist x) <= 25) * 1
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
...
triggerall = (enemynear, stateno = [200, 299]) || (enemynear, hitdefattr = S, NA, SA)
...
triggerall = (p2bodydist x = [0, 72]) && inguarddist && !var(26)
triggerall = p2statetype != A && p2statetype != L
triggerall = (enemynear, stateno = [400, 499]) || (enemynear, hitdefattr = C, NA, SA)
trigger1 = (ctrl || stateno = 52 || (stateno = [100, 101])) && random < (250 * (AIlevel ** 2 / 64.0))
...
triggerall = roundstate = 2 && statetype != A
triggerall = power >= 3000 && !var(20)
triggerall = !(enemynear, ctrl) && p2statetype != L; && (enemynear, stateno != [120, 155])

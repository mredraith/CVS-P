...
[State -1, Raging Slash]
type = ChangeState
value = 3200
triggerAll = !AILevel
triggerAll = command = "RagingSlash"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, MAX Double Typhoon]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXDoubleTyphoon"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, Raging Typhoon]
type = ChangeState
value = 3400
triggerAll = !AILevel
triggerAll = command = "RagingTyphoon"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Condor Splitter]
type = ChangeState
value = 3350
triggerAll = !AILevel
triggerAll = command = "MAXCanyonSplitter"
triggerAll = RoundState = 2 && StateType = A
triggerAll = (var(3) != [1,2]) && Pos y <= -12
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Canyon Splitter]
type = ChangeState
value = 3150 
triggerAll = !AILevel
triggerAll = command = "MAXCanyonSplitter"
...
[State -1, Condor Splitter]
type = ChangeState
value = 3300 
triggerAll = !AILevel
triggerAll = command = "CanyonSplitter"
triggerAll = RoundState = 2 && StateType = A
triggerAll = (var(3) != [1,2]) && Pos y <= -12
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
[State -1, EX Tomahawk Buster]
type = ChangeState
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXTomahawkBuster"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Condor Spire 2]
type = ChangeState
value = 1430
triggerAll = !AILevel
triggerAll = command = "EXCondorSpire2"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Condor Spire]
type = ChangeState
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXCondorSpire"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Condor Dive]
type = ChangeState
value = 1230
triggerAll = !AILevel
triggerAll = command = "EXCondorDive"
triggerAll = RoundState = 2 && StateType = A
triggerAll = (var(3) != [1,2]) && Pos y <= -12
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
trigger3 = StateNo = 1130 && MoveContact = [1,18]

[State -1, EX Mexican Typhoon]
type = ChangeState
value = 1030
triggerAll = !AILevel
triggerAll = command = "EXMexicanTyphoon"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Tomahawk Buster]
type = ChangeState
value = 1100
triggerAll = !AILevel
triggerAll = command = "TomahawkBuster"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Condor Spire 2]
type = ChangeState
value = 1400
triggerAll = !AILevel
triggerAll = command = "CondorSpire2"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Condor Spire]
type = ChangeState
value = 1300
triggerAll = !AILevel
triggerAll = command = "CondorSpire"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1200
triggerAll = !AILevel
triggerAll = command = "CondorDive"
triggerAll = RoundState = 2 && StateType = A
triggerAll = (var(3) != [1,2]) && Pos y <= -12
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Mexican Typhoon]
type = ChangeState
value = 1000
triggerAll = !AILevel
triggerAll = command = "MexicanTyphoon"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
triggerAll = !AILevel
trigger1 = StateNo = 150 || StateNo = 152
trigger1 = command = "b+y" && command = "holdfwd" && var(40) != 1
trigger1 = RoundState = 2 && StateType != A
trigger1 = power >= 1000 && !var(20)
...
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = (StateNo = 200 || StateNo = 205 || StateNo = 400 || StateNo = 430) && Time >= 10
trigger3 = var(4)
...
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = (StateNo = 200 || StateNo = 205 || StateNo = 400 || StateNo = 430) && Time >= 15
trigger3 = var(4)
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,53]) && (P2Dist y = [-80,0]) && P2StateType != C && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = var(5) && Random < (150 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,53]) && (p2dist y = [-80,0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
...
trigger4 = (StateNo = 5120 || StateNo = 5201) && !AnimTime && Random < (50 * (AILevel ** 2 / 64.0))
...
[State -1, Condor Spire 2]
type = ChangeState
value = ifElse(Power >= 500 && var(20) <= 60 && Random < 133, 1430, 1400)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = P2StateType != L && (P2Dist y = [-80,32])
...
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
trigger3 = (StateNo = 5120 || StateNo = 5201) && !AnimTime && Random < (50 * (AILevel ** 2 / 64.0))
trigger4 = StateNo = 1130 && MoveContact = [1,18]

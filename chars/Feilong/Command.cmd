...
[State -1, MAX Rekka Shinken]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXRekkaShinken"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Rekkashingeki]
type = null;ChangeState
value = 3450
triggerAll = !AILevel
triggerAll = command = "MAXRekkashingeki"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Ryu Yassai]
type = ChangeState
value = 3350
triggerAll = !AILevel
triggerAll = command = "MAXRyuYassai"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Shien Renkyaku]
type = ChangeState
value = 3150 
triggerAll = !AILevel
triggerAll = command = "MAXShienRenkyaku"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, Rekka Shinken]
type = ChangeState
value = 3000
triggerAll = !AILevel
triggerAll = command = "RekkaShinken"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Rekkashingeki]
type = null;ChangeState
value = 3400
triggerAll = !AILevel
triggerAll = command = "Rekkashingeki"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 3300 
triggerAll = !AILevel
triggerAll = command = "RyuYassai"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Shien Renkyaku]
type = ChangeState
value = 3100
triggerAll = !AILevel
triggerAll = command = "ShienRenkyaku"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, EX Shienkyaku]
type = ChangeState
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXShienkyaku"
triggerAll = RoundState = 2 && StateType != A
...
value = 1430
triggerAll = !AILevel
triggerAll = command = "EXTenshin"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Rekkukyaku]
type = null;ChangeState
value = 1230
triggerAll = !AILevel
triggerAll = command = "EXRekkukyaku"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Rekkukyaku 2]
type = ChangeState
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXRekkukyaku2"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1200
triggerAll = !AILevel
triggerAll = command = "Rekkukyaku"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Rekkukyaku 2]
type = ChangeState
value = 1300
triggerAll = !AILevel
triggerAll = command = "Rekkukyaku2"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
trigger1 = (EnemyNear, MoveType != A) && P2BodyDist x >= 160 && Random < (50 * (AILevel ** 2 / 64.0))

;===============================================================================
;===========================<FEILONG A.I NORMAL ATTACKS>========================
;===============================================================================
...
triggerAll = (P2BodyDist x = [0,55]) && (P2Dist y = [-80,80]) && P2StateType != L && !(EnemyNear, HitFall)
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0,60]) && (P2Dist y = [-60,50]) && P2StateType != L && !(EnemyNear, HitFall)
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 3 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
...
triggerAll = (EnemyNear, const(size.head.pos.y) <= -40) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (100 * (AILevel ** 3 / 64.0))
trigger2 = (StateNo = [200,499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3) && Random < (250 * (AILevel ** 3 / 64.0))

;===============================================================================
;===========================<FEILONG A.I SPECIAL MOVES>=========================
;===============================================================================
...
triggerAll = !var(16) && (var(15) < 1 || var(20))
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101]))
trigger1 = P2BodyDist x >= 15 && Random < (25 * (AILevel ** 3 / 64.0))
trigger2 = (ctrl || StateNo = 52 || (StateNo = [100,101]))
trigger2 = (EnemyNear, StateNo = 5120 || EnemyNear, StateNo = 5201) && (EnemyNear, AnimTime = -18) && Random < (50 * (AILevel ** 3 / 64.0))
trigger3 = var(6) && MoveHit && Random < (100 * (AILevel ** 3 / 64.0))
trigger3 = EnemyNear, GetHitVar(HitTime) >= 4

;===============================================================================
;===========================<FEILONG A.I SUPER MOVES>===========================
;===============================================================================
...
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
trigger3 = (StateNo = 5120 || StateNo = 5201) && !AnimTime && Random < (50 * (AILevel ** 3 / 64.0))
trigger4 = StateNo = 3000 && MoveHit && Time = 86 && Random < (50 * (AIlevel ** 3 / 64.0))
trigger5 = StateNo = 3301 && MoveHit && Time = 7 && Random < (50 * (AIlevel ** 3 / 64.0))
trigger6 = StateNo = 3412 && Random < (50 * (AIlevel ** 3 / 64.0))

...
[State -1, Saishu Kessen Ougi: "Homura No Ken"]
type = ChangeState
value = 3300
triggerAll = !AILevel
triggerAll = command = "HomuraNoKen"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Chou Yami Barai]
type = ChangeState
value = 3250
triggerAll = !AILevel
triggerAll = (command = "QCBx2+2P" && StateNo != [1000,1199]) || (command = "QCBx2+2PChou" && StateNo = [1000,1199])
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, MAX 1127 Shiki: Tsumugari]
type = ChangeState
value = 3150
triggerAll = !AILevel
...
;trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
;trigger2 = (command = "a" || command = "b") && var(7)

[State -1, 1127 Shiki: Tsumugari]
type = ChangeState
value = 3100
triggerAll = !AILevel
...
[State -1, EX 427 Shiki: Kamukakari]
type = ChangeState
value = 1450
triggerAll = !AILevel
...
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
trigger3 = StateNo = 229

[State -1, EX 100+ Shiki: Nataguruma]
type = ChangeState
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXNataguruma"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
trigger2 = var(6)
trigger3 = StateNo = 229
trigger4 = var(9) && StateNo = [3100,3150]
...
[State -1, 100+ Shiki: Nataguruma]
type = ChangeState
value = 1300
triggerAll = !AILevel
triggerAll = command = "Nataguruma"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
trigger3 = StateNo = 229
...
[State -1, Homuragasane]
type = ChangeState
value = 1200
triggerAll = !AILevel
triggerAll = command = "Homuragasane"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
trigger3 = StateNo = 229
...
[State -1, Standing Heavy Punch/Close Heavy Punch]
type = ChangeState
...
[State -1, Geshiki: Goutsui (Canceled)]
type = ChangeState
value = 212
triggerAll = !AILevel
...
[State -1, Oniyaki (after Homuragasane)]
type = ChangeState
...
[State -1, Kamukakari (after Homuragasane)]
type = ChangeState
value = 1400
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = (P2BodyDist x = [-8,200])
triggerAll = NumTarget(1201) && !var(10)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (60 * (AILevel ** 2 / 64.0))
...
trigger2 = var(6) && MoveHit && Random < (80 * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 9

[State -1, MAX Akai Ten Barai]
type = ChangeState
value = 3250
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
...
;[State -1, Akai Ten Barai (after Homuragasane)]
;type = ChangeState
;value = 3200
;triggerAll = AILevel && NumEnemy
;triggerAll = RoundState = 2 && StateType != A
...
;[State -1, MAX Tsumugari (after Akai Ten Barai)]
;type = ChangeState
;value = 3150
;triggerAll = AILevel && NumEnemy
;triggerAll = RoundState = 2 && StateType != A
...
;triggerAll = P2StateType != A && P2StateType != L
;trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (100 * (AILevel ** 2 / 64.0))
;trigger2 = var(7) && MoveHit && Random < (ifElse((var(20) = [1,30]),150,100) * (AILevel ** 2 / 64.0))

[State -1, MAX Tsumugari (after Yami Barai)]
type = ChangeState
value = 3150
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
...
triggerAll = P2StateType != A && P2StateType != L
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (100 * (AILevel ** 2 / 64.0))
trigger2 = var(7) && MoveHit && Random < (ifElse((var(20) = [1,30]),250,150) * (AILevel ** 2 / 64.0))

[State -1, Tsumugari (after Yami Barai)]
type = ChangeState
value = 3100
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
...
[State -1, MAX Orochinagi (after Homuragasane)]
type = ChangeState
value = 3050
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
...
[State -1, MAX Orochinagi (after Kamukakari)]
type = ChangeState
value = 3050
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
...
triggerAll = (EnemyNear, MoveType != A) || (EnemyNear, StateType = A)
triggerAll = (P2BodyDist x = [0,165])
triggerAll = NumTarget(1400) && var(10)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (80 * (AILevel ** 2 / 64.0))

[State -1, MAX Orochinagi (after Akai Ten Barai)]
type = ChangeState
value = 3050
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
...
[State -1, Orochinagi (after Homuragasane)]
type = ChangeState
value = 3000
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
...
[State -1, Orochinagi (after Kamukakari)]
type = ChangeState
value = 3000
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
...
trigger4 = (StateNo = 1201 || StateNo = 1300) && var(6)
...
triggerAll = P2StateType != A && P2StateType != L
trigger1 = var(20) > 30 && StateNo = 1201 && var(6)
...
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101])) && Random < (70 * (AILevel ** 2 / 64.0))
trigger2 = (ctrl || StateNo = 52 || (StateNo = [100,101]))
trigger2 = EnemyNear, StateNo = 195 && Random < (120 * (AILevel ** 2 / 64.0))
...
trigger2 = (ctrl || StateNo = 52 || (StateNo = [100,101]))
trigger2 = (EnemyNear, StateNo = 5120 || EnemyNear, StateNo = 5201) && (EnemyNear, AnimTime = -18) && Random < (150 * (AILevel ** 2 / 64.0))
trigger3 = var(6) && MoveHit && Random < (100 * (AILevel ** 2 / 64.0))
...
triggerAll = (P2BodyDist x = [-8,130]) && (P2StateType != L || P2StateNo = 5120)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100,101]))
trigger1 = P2BodyDist x >= 80 && Random < (25 * (AILevel ** 2 / 64.0))
trigger2 = (ctrl || StateNo = 52 || (StateNo = [100,101]))
trigger2 = var(10) >= 1 && Random < (250 * (AILevel ** 2 / 64.0))
trigger3 = var(6) && MoveHit && Random < (60 * (AILevel ** 2 / 64.0))
trigger3 = EnemyNear, GetHitVar(HitTime) >= 6

...
[State -2, Clone Hit Detection]
type = VarSet
trigger1 = IsHelper(3250)
trigger1 = MoveContact = 1 && var(30) < 0
var(30) = HitPauseTime
ignoreHitPause = 1

[State -2, Hit Sparks for Clone]
type = Helper
...
[State -2, Counter FX for Clone]
type = Helper
trigger1 = NumHelper(3250) && MoveHit = 1 && var(30) = HitPauseTime
...
[State -2, Hit Detection for Clone]
type = VarSet
trigger1 = IsHelper
var(30) = -1
...
trigger2 = var(6)
trigger3 = (StateNo=[200,251]) || (StateNo=[600,650])

[State -1, Luminous Illusion Alt]
type = ChangeState
value = 3200
triggerall = !IsHelper(10371) ;Always add this as well!
triggerall = numhelper(10371)
...
trigger1= ctrl || (stateno=[100,101])
trigger2 = (StateNo = 200 || StateNo = 430) && Time >=5

...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [-10,100]) && (P2Dist y = [-35,0]) && (P2StateType != L || P2StateNo = 5120) && P2StateType != C
...
triggerAll = ((P2BodyDist x = [-10,170]) && P2StateType != A) || ((P2BodyDist x = [-5,115]) && P2StateType = A)
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (100 * (AILevel ** 2 / 64.0))

...
triggerall = var(1) = 1 && !var(33) && roundstate = 2 && statetype = A && var(9) != 2 && power >= 500 && var(20) <= 60
trigger1 = ctrl || ((stateno = [200, 299]) && time <= 2) || (stateno = 200 || stateno = 230)
...
triggerall = !NumPartner || (NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])) 
value = 4100
triggerall = var(1) != 2 && AIlevel && numenemy
...
type = ChangeState
triggerall = !NumPartner || (NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])) 
value = ifelse((sysvar(4) = 1 || sysvar(4) = 15) && (numpartner) && (partner, life > 0) && (Partner, StateNo = [1251112,1251114]) && ((partner,name!="Dudley"||partner,authorname!="DickBuckus&Mr.Ansatsuken")&&(partner,name!="Akuma"||partner,authorname!="Mr.Ansatsuken")&&((partner,name!="Ryu"&&partner,name!="Dan Hibiki")||partner,selfanimexist(4201533)=0||partner,authorname!="Phantom.of.the.Server")) && (Partner, Time >= 9) && power >= 3000), 1251125, 3100)
triggerall = AIlevel && numenemy && enemynear, stateno != [821,823]
triggerall = !var(33) && roundstate = 2 && statetype != A && power >= 1000 && power < ifelse((sysvar(4) = 1 || sysvar(4) = 15) && (numpartner) && (partner, life > 0) && (Partner, StateNo = [1251112,1251114]) && ((partner, name != "Akuma" || partner, authorname != "Mr.Ansatsuken") && ((partner, name != "Ryu" && partner, name != "Dan Hibiki") || partner, authorname != "Phantom.of.the.Server" || partner, selfanimexist(4201533)=0)) && (Partner, Time >= 9), powermax*2, 2000)
triggerall = !(enemynear, ctrl) && (p2stateno != [120, 155]) && p2statetype != L
...
type = ChangeState
triggerall = !NumPartner || (NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])) 
value = ifelse((sysvar(4) = 1 || sysvar(4) = 15) && (numpartner) && (partner, life > 0) && (Partner, StateNo = [1251112,1251114]) && ((partner,name="Dudley"&&partner,authorname="DickBuckus&Mr.Ansatsuken")||((partner,name="Akuma"||partner,name="Q")&&partner,authorname="Mr.Ansatsuken")||((partner,name="Ryu"||partner,name="Dan Hibiki")&&partner,selfanimexist(4201533)&&partner,authorname="Phantom.of.the.Server")) && (Partner, Time >= 9) && power >= ifelse(partner,var(1)>1 && (partner, name = "Akuma" && partner, authorname = "Mr.Ansatsuken"),2000,3000), 1251125, ifelse(power>=2000,3500,3200))
...
type = ChangeState
triggerall = !NumPartner || (NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])) 
value = ifelse((sysvar(4) = 1 || sysvar(4) = 15) && (numpartner) && (partner, life > 0) && (Partner, StateNo = [1251112,1251114]) && ((partner,name="Dudley"&&partner,authorname="DickBuckus&Mr.Ansatsuken")||((partner,name="Akuma"||partner,name="Q")&&partner,authorname="Mr.Ansatsuken")||((partner,name="Ryu"||partner,name="Dan Hibiki")&&partner,selfanimexist(4201533)&&partner,authorname="Phantom.of.the.Server")) && (Partner, Time >= 9) && power >= ifelse(partner,var(1)>1 && (partner, name = "Akuma" && partner, authorname = "Mr.Ansatsuken"),2000,3000), 1251125, ceil(ifelse((p2dist x =[69,80]),3600,ifelse(random<300,3600,3500))))
triggerall = AIlevel && numenemy && !var(20)
...
type = ChangeState
triggerall = !NumPartner || (NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])) 
value = ifelse((var(1) = 1 && power >= 500 && power < 3000 && random < 200), 1210, 1200)
triggerall = AIlevel && numenemy
triggerall = !var(33) && roundstate = 2 && statetype != A
triggerall = (p2stateno != [120, 155]) && p2statetype != L
triggerall = (p2bodydist x = [0, 160]) && (enemynear, vel y > -1) && (enemynear, vel x > -2) && !(enemynear, hitfall)

...
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = (StateNo = 200 || StateNo = 400 || StateNo = 430) && Time >= 7
trigger3 = var(4)
...
trigger1 = (EnemyNear, MoveType = A) && !(EnemyNear, HitDefAttr = SCA, AT) && (P2BodyDist x = [85, 115])
...
trigger1 = Random < (ifElse((EnemyNear, HitDefAttr = SC, AT), 500, 25) * (AILevel ** 2 / 64.0))
trigger2 = (P2BodyDist x = [0, 80]) && BackEdgeBodyDist >= 80
trigger2 = EnemyNear, StateNo = 5120 && EnemyNear, AnimTime = -4 && Random < (125 * (AILevel ** 2 / 64.0))
...
trigger1 = RoundState = 2 && StateType != A
trigger1 = Power >= 1000 && var(20) <= 60 && Life <= 56
trigger1 = Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = (P2BodyDist x = [-20,30]) && P2BodyDist y = 0
...
triggerAll = P2StateType != L && (P2Dist y = [-52, 0])
triggerAll = (P2BodyDist x = [58, 70])
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (50 * (AILevel ** 2 / 64.0))
trigger2 = var(6) && (MoveHit || MoveGuarded)
...
triggerAll = var(40)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 58]) && (P2Dist y = [-72, 0]) && P2StateType != A && P2StateType != L
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (750 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200, 499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3)

[State -1, Raigeki Shuu]
type = ChangeState
value = 658
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType = A && pos y <= -12
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [15, 80]) && P2Dist y >= 0
trigger1 = ctrl
trigger1 = vel y > -6 && Random < (750 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 61]) && (P2Dist y = [-12, 0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -50) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100,101])) && (Random < (125 * (AILevel ** 2 / 64.0)) || P2StateNo = 1415)
trigger2 = (StateNo = [200, 499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 4)
trigger3 = (StateNo = [760, 761]) && !AnimTime && ctrl
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 55]) && (P2Dist y = [-23, 0]) && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -50) || (EnemyNear, StateType = A)
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 48]) && (P2Dist y = [-12, 0]) && P2StateType != A && P2StateType != L
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (50 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200, 499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 3)
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 57]) && (P2Dist y = [-50, 0]) && P2StateType != A && P2StateType != L
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (50 * (AILevel ** 2 / 64.0))
trigger2 = (StateNo = [200, 499]) && !AnimTime && ctrl
trigger2 = MoveHit && (EnemyNear, GetHitVar(HitTime) >= 2)
...
value = 1400
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !var(37)
triggerAll = P2StateType != A && P2StateType != L
triggerAll = P2Dist x >= 0 && P2Dist x <= 55 && P2Dist y = 0
...
[State -1, Byakko Soushouda]
type = ChangeState
value = ifElse(Power >= 500 && Random < 125 && var(20) <= 60 && !var(40), 1330, 1300)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2StateType != L || P2StateNo = 5120)
triggerAll = (P2BodyDist x = [-50, 50]) && (P2Dist y = [-70, 0]) 
trigger1 = Enemy, StateNo = 5120 && Enemy, AnimElemTime(1) = 0
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (75 * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, BackEdgeDist <= 64
trigger2 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = P2StateType != L && (P2Dist y = [-90, -15])
triggerAll = ((P2BodyDist x = [-5, 55]) && P2StateType = A)
...
type = ChangeState
value = 3200
trigger1 = AILevel && NumEnemy && !var(40)
trigger1 = RoundState = 2 && StateType != A && !NumProjID(131035)
trigger1 = Power >= 2500
trigger1 = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000, 4999]))
trigger1 = P2StateType != A
trigger1 = P2StateType != L && (P2Dist y = [-50, 0]) && P2BodyDist x = [0, 25]
...
trigger1 = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000, 4999]))
trigger1 = P2StateType != A
trigger1 = P2StateType != L && (P2Dist y = [-75, 0]) && P2BodyDist x = [25, 85]
trigger1 = var(7) && MoveHit
trigger1 = EnemyNear, GetHitVar(HitTime) >= 3

[State -1, MAX Tenshin Senkyuutai]
type = ChangeState
value = 3150
trigger1 = AILevel && NumEnemy && !var(40)
trigger1 = RoundState = 2 && StateType != A && !NumProjID(131035)
...
trigger1 = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000, 4999]))
trigger1 = P2StateType != A
trigger1 = P2StateType != L && (P2Dist y = [-85, 0]) && P2BodyDist x = [0, 75]
trigger1 = var(7) && MoveHit
trigger1 = EnemyNear, GetHitVar(HitTime) >= 2
...
trigger1 = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000, 4999]))
trigger1 = P2StateType != A
trigger1 = P2StateType != L && (P2Dist y = [-75, -50]) && P2BodyDist x = [0, 75]
trigger1 = var(7) && MoveHit
trigger1 = EnemyNear, GetHitVar(HitTime) >= 6

[State -1, Tenshin Senkyuutai]
type = ChangeState
value = 3100
trigger1 = AILevel && NumEnemy && !var(40)
trigger1 = RoundState = 2 && StateType != A && !NumProjID(131035)
...
trigger1 = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000, 4999]))
trigger1 = P2StateType != A
trigger1 = P2StateType != L && (P2Dist y = [-50, 0]) && P2BodyDist x = [0, 75]
trigger1 = var(7) && MoveHit
trigger1 = EnemyNear, GetHitVar(HitTime) >= 2
...
[State -1, Tourou Zan]
type = ChangeState
value = ifElse(Power >= 500 && var(20) <= 60 && !var(40), 1030, 1000)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = P2StateType != L && (P2Dist y = [-59, 0])

...
value = 3200
triggerAll = !AILevel
triggerAll = command = "SonicBlade"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, MAX Sonic Break]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXSonicBreak"
triggerAll = RoundState = 2 && StateType != A
...
[State -1, MAX Moonsault Strike]
type = ChangeState
value = 3650
triggerAll = !AILevel
triggerAll = command = "MAXMoonsaultStrike"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Reversed Sommersault]
type = ChangeState
value = 3550
triggerAll = !AILevel
triggerAll = command = "MAXReversedSommersault"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Crossfire Blitz]
type = ChangeState
value = 3350
triggerAll = !AILevel
triggerAll = command = "MAXCrossfireBlitz"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Sommersault Justice]
type = ChangeState
value = 3150
triggerAll = !AILevel
triggerAll = command = "MAXSommersaultJustice"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)
...
value = 3500
triggerAll = !AILevel
triggerAll = command = "ReversedSommersault"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 3600
triggerAll = !AILevel
triggerAll = command = "MoonsaultStrike"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 3300 
triggerAll = !AILevel
triggerAll = command = "CrossfireBlitz"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 3100
triggerAll = !AILevel
triggerAll = command = "SommersaultJustice"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 1230
triggerAll = !AILevel
triggerAll = command = "EXMoonsaultSlash"
triggerAll = RoundState = 2 && StateType = A
...
value = 1200
triggerAll = !AILevel
triggerAll = command = "MoonsaultSlash"
triggerAll = RoundState = 2 && StateType = A
triggerAll = (var(3) != [1,2]) && Pos y <= -32
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
type = ChangeState
value = 220 + (Abs(P2BodyDist X) <= 35) * 5
triggerAll = !AILevel
...
[State -1, Standing Forward Heavy Kick]
type = ChangeState
value = 259
triggerAll = !AILevel
...
value = 751
trigger1 = AILevel && NumEnemy
trigger1 = StateNo = 50 || StateNo = 152
trigger1 = RoundState = 2 && StateType != A
trigger1 = Power >= 1000 && var(20) <= 60
trigger1 = Random < (25 * (AILevel ** 2 / 64.0))
trigger1 = (P2BodyDist x = [0,50]) && (Life < 0.5 * LifeMax)
...
trigger1 = P2StateType = A && Random < (100 * (AILevel ** 2 / 64.0))
...
;===============================================================================
;===========================<CHARLIE A.I SPECIAL MOVES>=========================
;===============================================================================

[State -1, Moonsault Slash]
type = ChangeState
value = ifElse(Power >= 1000 && Random < 133, 1230, 1200)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType = A
triggerAll = (var(3) != [1,2]) && Pos y <= -32
triggerAll = !var(16) && (var(15) < 1 || var(20))
...
[State -1, Somersault Shell]
type = ChangeState
value = ifElse(Power >= 1000 && Random < 133, 1130, 1100)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = P2StateType != L && (P2Dist y = [-80,32])
...
[State -1, Sonic Boom]
type = ChangeState
value = ifElse(Power >= 1000 && Random < 133, 1030, 1000)
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
triggerAll = !var(16) && (var(15) < 1 || var(20))
...
[State -1, MAX Somersault Justice]
type = ChangeState
value = 3150
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A
...
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
trigger3 = (StateNo = 5120 || StateNo = 5201) && !AnimTime && Random < (50 * (AILevel ** 2 / 64.0))
trigger4 = StateNo = 3300 && AnimElemTime(21) = 0 && MoveHit && Random < (50 * (AIlevel ** 2 / 64.0))
...
trigger2 = var(7) && MoveContact && Random < (ifElse((var(20) = [1,30]), 200, 50) * (AILevel ** 2 / 64.0))
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
trigger3 = StateNo = 3300 && AnimElemTime(21) = 0 && MoveHit && Random < (50 * (AIlevel ** 2 / 64.0))

...
trigger2 = NumHelper(3105) <= 2
trigger2 = Helper(3105),StateNo=1015 || Helper(3105),StateNo=3115
...
trigger2 = Helper(3210),StateNo=1015
...
trigger2 = NumHelper(3015) <= 3
trigger2 = Helper(3015),StateNo=1015

[State -1, Diamond Edge]
type = ChangeState
value = 3000
...
trigger2 = Helper(3010),StateNo=1015
...
trigger1 = NumHelper(1235) <= 0
trigger2 = NumHelper(1235) <= 1
trigger2 = Helper(1235),StateNo = 1015

[State -1, EX Diamond Shoot]
type = ChangeState
value = 1430
triggerall = !IsHelper(10371) ;Always add this as well!
triggerall = numhelper(10371)
...
trigger2 = (Helper(1410),StateNo=[1414,1415]) || Helper(1410),StateNo=1015

[State -1, EX Diamond Breath]
type = ChangeState
value = 1030
triggerall = !IsHelper(10371) ;Always add this as well!
triggerall = numhelper(10371)
...
trigger2 = (Helper(1010),StateNo=[1014,1015])

[State -1, Crow Bites Strong]
type = ChangeState
value = 1120
triggerall = !IsHelper(10371) ;Always add this!
triggerall = numhelper(10371)
...
trigger2 = NumHelper(1205) <= 1
trigger2 = Helper(1205),StateNo = 1015

[State -1, Diamond Shoot]
type = ChangeState
value = 1400
triggerall = !IsHelper(10371) ;Always add this!
triggerall = numhelper(10371)
...
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = (StateNo = 200 || StateNo = 230 || StateNo = 430) && Time >=5
trigger3 = StateNo = 231 && Time > 5

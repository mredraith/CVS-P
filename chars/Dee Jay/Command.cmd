...
value = 3200
triggerAll = !AILevel
triggerAll = command = "ClimaxBeat"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Sobat Festeval]
type = ChangeState
value = 3400
triggerAll = !AILevel
triggerAll = command = "SobatFesteval"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, MAX Theme Of Sunrise]
type = ChangeState
value = 3350
triggerAll = !AILevel
triggerAll = command = "MAXThemeOfSunrise"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Sobat Carnival]
type = ChangeState
value = 3150 
triggerAll = !AILevel
triggerAll = command = "MAXSobatCarnival"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Climax Break]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXClimaxBreak"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, Theme Of Sunrise]
type = ChangeState
value = 3300 
triggerAll = !AILevel
triggerAll = command = "ThemeOfSunrise"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Sobat Carnival]
type = ChangeState
value = 3100
triggerAll = !AILevel
triggerAll = command = "SobatCarnival"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, Climax Break]
type = ChangeState
value = 3000
triggerAll = !AILevel
triggerAll = command = "ClimaxBreak"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, EX Jackknife Maximum]
type = ChangeState
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXJackknifeMaximum" && ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(50) > 16)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Double Rolling Sobat]
type = ChangeState
value = 1230
triggerAll = !AILevel
triggerAll = command = "EXDoubleRollingSobat" && ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(48) > 16)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Machine Gun Upper]
type = ChangeState
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXMachineGunUpper" && ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(50) > 16)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1030
triggerAll = !AILevel
triggerAll = command = "EXAirSlasher" && ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(48) > 16)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
...
[State -1, Jackknife Maximum]
type = ChangeState
value = 1300
triggerAll = !AILevel
triggerAll = command = "JackknifeMaximum" && ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(50) > 16)
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Double Rolling Sobat]
type = ChangeState
value = 1200
triggerAll = !AILevel
triggerAll = command = "DoubleRollingSobat" && ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(48) > 16)
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Machine Gun Upper]
type = ChangeState
value = 1100
triggerAll = !AILevel
triggerAll = command = "MachineGunUpper" && ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(50) > 16)
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1000
triggerAll = !AILevel
triggerAll = command = "AirSlasher" && ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(48) > 16)
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 && AnimElemTime(1) > 0 || StateNo = 5120 && AnimElemTime(5) > 0 || (StateNo = [100,101])
trigger2 = var(6)
...
trigger1 = ctrl || StateNo = 52 && AnimElemTime(1) > 0 || (StateNo = [100,101])
trigger2 = var(4)
...
triggerAll = StateType != A
trigger1 = ctrl || StateNo = 52 && AnimElemTime(1) > 0 || (StateNo = [100,101])
trigger2 = (StateNo = 200 || StateNo = 205 || StateNo = 230 || StateNo = 400 || StateNo = 430) && Time >= 8
trigger3 = var(4)
...
triggerAll = StateType != A
trigger1 = ctrl || StateNo = 52 && AnimElemTime(1) > 0 || (StateNo = [100,101])
trigger2 = (StateNo = 200 || StateNo = 205 || StateNo = 230 || StateNo = 400 || StateNo = 430) && Time >= 6
trigger3 = var(4)
...
trigger1 = !InGuardDist && P2BodyDist x >= 160 && Random < (10 * (AILevel ** 2 / 64.0))
...
;===============================================================================
;===========================<DEE JAY A.I SUPER MOVES>===========================
;===============================================================================

[State -1, Sobat Festival]
type = ChangeState
value = 3400
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A

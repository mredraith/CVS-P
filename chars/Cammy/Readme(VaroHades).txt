...
===============================| Cammy Delta Red by Varo_Hades(Coder) & chuchoryu (spriter)  |==============================

    "Bueno primero que nada aclaro, esta es mi versión de cammy estilo Sf2 esta a base de la de pots (phantom of the server),
    la jugabilidad es la misma solo que esta tiene algunos detalles mas claro y claro graficamente hablando es psycho weapon,
    espero no faltar al respeto todo lo contrario es mi contribucion a al fabuloso sistema de juegos mugen
     y mi regalo para todos espero lo disfruten."

 - Contact: varo_hades@hotmail.com
 - Website: http://ssf2me.blogspot.com/2011/09/de-regreso-street-fighter.html
 - Customized version of Capcom's Cammy character, for Linux and Windows Mugen
...
=====<Special Thanks>=====
 -Yo Varo_Hades(Claudio)
 -Darek (alguien que contribullo en la separacion de cammy de killer bee)

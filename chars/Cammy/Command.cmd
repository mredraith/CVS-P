...
triggerall = statetype != A
triggerall = p2bodydist x <= (const(size.xscale) * 24)
trigger1 = ctrl || (stateno = [100, 101])
trigger2 = var(4)
...
type = changestate
value = 1500
triggerall = AIlevel && numenemy && palno >= 7
...
type = changestate
value = 1000
triggerall = AIlevel && numenemy && palno <= 6
triggerall = roundstate = 2 && statetype != A

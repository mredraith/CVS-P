...
trigger2= enemynear,stateno=5120 && enemynear,animtime=-4 && random<750
...
trigger1= (enemynear,stateno=[200,699]) && random<250
...
trigger2= ctrl && (p2stateno=[120,140]) && random<250
...
trigger2= movehit && (enemynear,gethitvar(hittime)>=3) && random<250
...
triggerall= (enemynear,const(size.head.pos.y)<=-40) || (enemynear,statetype=A)
trigger1= (ctrl || (stateno=[100,101])) && random<ifelse(p2statetype=A, 200, 25)
trigger2= (stateno=[200,499]) && !animtime && ctrl
trigger2= movehit && (enemynear,gethitvar(hittime)>=5) && random<250
...
trigger1= (ctrl || (stateno=[100,101])) && random<25
trigger2= (stateno=[200,499]) && !animtime && ctrl
trigger2= movehit && (enemynear,gethitvar(hittime)>=4) && random<250
...
trigger1= (ctrl || (stateno=[100,101])) && random<25
trigger2= (stateno=[200,499]) && !animtime && ctrl
trigger2= movehit && (enemynear,gethitvar(hittime)>=6) && random<250
...
trigger1= (ctrl || (stateno=[100,101])) && random<25
trigger2= (stateno=[200,499]) && !animtime && ctrl
trigger2= movehit && (enemynear,gethitvar(hittime)>=2) && random<250
...
trigger1= ctrl
trigger1= vel y>0 && random<ifelse(p2dist x<0, 250, 50)
...
triggerall= !(enemynear,ctrl) && p2statetype!=A && p2statetype!=L
triggerall= (p2bodydist x=[-128,128]) && (p2dist y=[-32,32])
trigger1= var(7) && movehit && random<ifelse((var(20)=[1,30]), 200, 50)
...
trigger1= (enemynear,movetype=H) && (enemynear,hitfall) && random<50

...
[Command]
name="MaxCrazyPuncher1"
command=~D, DB,B, D, DF, F, x+y
time=32

[Command]
name="MaxCrazyPuncher2"
command=~D, DB,B, D, DF, F, y+z
time=32

[Command]
name="MaxCrazyPuncher3"
...
[Command]
name = "MachineGunPuncher1"
command = ~D, DF, F, x
time = 15

[Command]
name = "MachineGunPuncher2"
command = ~D, DF, F, y
time = 15

[Command]
name = "MachineGunPuncher3"
command = ~D, DF, F, z
time = 15
...
[Command]
name = "ForbiddenEagle1"
command = ~F,D,DF,x
time = 15

[Command]
name = "ForbiddenEagle2"
command = ~F,D,DF,y
time = 15

[Command]
name = "ForbiddenEagle3"
command = ~F,D,DF,z
time = 15
...
[Command]
name = "PuncherWeaving1"
command = ~D, DB, B, x
time = 15

[Command]
name = "PuncherWeaving2"
command = ~D, DB, B, y
time = 15

[Command]
name = "PuncherWeaving3"
command = ~D, DB, B, z
time = 15
...
[Command]
name = "PuncherVisionEX1"
command = ~D, DF, F, a+b
time = 15

[Command]
name = "PuncherVisionEX2"
command = ~D, DF, F, b+c
time = 15

[Command]
name = "PuncherVisionEX3"
command = ~D, DF, F, a+c
time = 15
...
[Command]
name = "PuncherVisionEX4"
command = ~D, DB, B, a+b
time = 15

[Command]
name = "PuncherVisionEX5"
command = ~D, DB, B, b+c
time = 15

[Command]
name = "PuncherVisionEX6"
command = ~D, DB, B, a+c
time = 15
...
trigger2=var(6)
;----------------------------------------------------------------------
[State -1, Max Crazy Puncher]
type=ChangeState
value=3150
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000
triggerall=command ="MaxCrazyPuncher1" || command ="MaxCrazyPuncher2" || command ="MaxCrazyPuncher3"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Crazy Puncher]
type=ChangeState
value=3100
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 1000
triggerall=command ="CrazyPuncher1" || command ="CrazyPuncher2" || command ="CrazyPuncher3"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;----------------------------------------------------------------------
[State -1, Max Champion Puncher]
type=ChangeState
value=3050
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="MaxChampionPuncher"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Champion Puncher]
type=ChangeState
value=3000
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 1000&&command ="ChampionPuncher"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;========================================================================
[State -1, DashPuncher]
type=ChangeState
value=Ifelse(command="DashPuncherEX"&&var(20) <= 60&&power>=500,1430,1400)
triggerall=ifElse(var(20) > 0 || (StateNo = [1000,4999]), 1, var(48) > 0)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="DashPuncher1")||(command="DashPuncher2")||(command="DashPuncher3")||(command="DashPuncherEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="DashPuncherEX"&&power>=500&&var(20) <= 60)

[State -1, ForbiddenEagle]
type=ChangeState
value=Ifelse(command="ForbiddenEagleEX"&&var(20) <= 60&&power>=500,1130,1100)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="ForbiddenEagle1")||(command="ForbiddenEagle2")||(command="ForbiddenEagle3")||(command="ForbiddenEagleEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="ForbiddenEagleEX"&&power>=500&&var(20) <= 60)

[State -1, Puncher Weaving]
type=ChangeState
value=Ifelse(command="PuncherWeavingEX"&&var(20) <= 60&&power>=500,1330,1300)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="PuncherWeaving1")||(command="PuncherWeaving2")||(command="PuncherWeaving3")||(command="PuncherWeavingEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="PuncherWeavingEX"&&power>=500&&var(20) <= 60)

[State -1, Puncher Vision(Fwd)]
type=ChangeState
value=Ifelse(command="PuncherVisionEX1" || command="PuncherVisionEX2" ||command="PuncherVisionEX3"&&var(20) <= 60&&power>=500,1230,1200)
triggerall = StateType != A && !AILevel && RoundState=2 
triggerall= ((command="PuncherVision1")||(command="PuncherVision2")||(command="PuncherVision3")||(command="PuncherVisionEX1"&&power>=500&&var(20) <= 60)) || (command="PuncherVisionEX2"&&power>=500&&var(20) <= 60)  || (command="PuncherVisionEX3"&&power>=500&&var(20) <= 60)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="PuncherVisionEX1"&&power>=500&&var(20) <= 60) || (command="PuncherVisionEX2"&&power>=500&&var(20) <= 60)  || (command="PuncherVisionEX3"&&power>=500&&var(20) <= 60)

[State -1, Puncher Vision(Back)]
type=ChangeState
value=Ifelse(command="PuncherVisionEX4" || command="PuncherVisionEX5" ||command="PuncherVisionEX6"&&var(20) <= 60&&power>=500,1231,1203)
triggerall = StateType != A && !AILevel && RoundState=2 
triggerall=((command="PuncherVision4")||(command="PuncherVision5")||(command="PuncherVision6")||(command="PuncherVisionEX4"&&power>=500&&var(20) <= 60)) || (command="PuncherVisionEX5"&&power>=500&&var(20) <= 60)  || (command="PuncherVisionEX6"&&power>=500&&var(20) <= 60)
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="PuncherVisionEX4"&&power>=500&&var(20) <= 60) || (command="PuncherVisionEX5"&&power>=500&&var(20) <= 60)  || (command="PuncherVisionEX6"&&power>=500&&var(20) <= 60)

[State -1, Machine Gun Puncher]
type=ChangeState
value=Ifelse(command="MachineGunPuncherEX"&&var(20) <= 60&&power>=500,1030,1000)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="MachineGunPuncher1")||(command="MachineGunPuncher2")||(command="MachineGunPuncher3")||(command="MachineGunPuncherEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="MachineGunPuncherEX"&&power>=500&&var(20) <= 60)
;========================================================================

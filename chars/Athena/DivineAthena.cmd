...
time = 24
;------------------------------
;If you're using a keyboard/find a true/easier HCB/F difficult-
;try using this command.
;Be sure to comment out the above command.
;Also be sure to adjust the tiny buffer frame window value.
;[command];easiest HCB/F
;name = "HCB"
;command = ~F, $D, B
;time = 18
...
[State -1, AngleDraw: EX Psycho Ball];special thanks to 20S
type = AngleDraw
trigger1 = IsHelper(1010)
trigger1 = StateNo = 1020
scale = 1-(GameTime%5)*0.1,1-(GameTime%5)*0.1
ignorehitpause = 1

[State -1, Air MAX Shining Crystal Bit]
type = ChangeState
value = 3150
...
trigger2 = Helper(3105),StateNo = [3017,3018]

[State -1, MAX Shining Crystal Bit]
type = ChangeState
value = 3100
triggerall = !IsHelper(10371) ;Always add this!
triggerall = numhelper(10371)
...
[State -1, Air Shining Crystal Bit]
type = ChangeState
value = 3050
triggerall = !IsHelper(10371) ;Always add this!
triggerall = numhelper(10371)
...
trigger2 = Helper(3005),StateNo = [3017,3018]
...
[State -1, Air Super Phoenix Infinity]
type = ChangeState
value = 3350
triggerall = !IsHelper(10371) ;Always add this!
triggerall = numhelper(10371)
...
[State -1, Super Phoenix Infinity]
type = ChangeState
value = 3300
triggerall = !IsHelper(10371) ;Always add this!
triggerall = numhelper(10371)
...
[State -1, MAX Phoenix Fang Arrow]
type = ChangeState
value = 3250
triggerall = !IsHelper(10371) ;Always add this!
triggerall = numhelper(10371)
...
[State -1, EX Super Psychic Throw]
type = ChangeState
value = 1230
triggerall = !IsHelper(10371) ;Always add this!
triggerall = numhelper(10371)
...
triggerall = (helper(10371), var(3)) && (helper(10371), var(4)) || (helper(10371), var(4)) && (helper(10371), var(5)) || (helper(10371), var(3)) && (helper(10371), var(5))
triggerall = !NumHelper(1505) && !NumHelper(1535)
triggerall = RoundState = 2 && StateType != A
triggerall = ifelse(var(20) <= 0, power >= 500, power >= 0)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(5)

[State -1, Super Psychic Throw]
type = ChangeState
value = 1200
triggerall = !IsHelper(10371) ;Always add this!
triggerall = numhelper(10371)
...
[State -1, Air Strong Psycho Sword]
type = ChangeState
value = 1160
triggerall = !IsHelper(10371) ;Always add this!
triggerall = numhelper(10371)
...
type = ChangeState
value = 200 + (Abs(P2BodyDist X) <= 18) * 1
...
type = ChangeState
value = 210 + (Abs(P2BodyDist X) <= 20) * 1
triggerall = !IsHelper(10371) ;Always add this as well!
triggerall = numhelper(10371) ;Prevent debug flood.

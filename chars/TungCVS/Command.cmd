...
[Command]
name = "Arrow Step Hard"
command = ~D,B, z
time = 18

[Command]
name = "EX Arrow Apical"
command = ~D,B, x+y
time = 18
...
;-----------------------------------------------------------------------
;Hyper MOVES
[State -1, Chou Shou Ha]
type=ChangeState
value=3500
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="Chou Shou Ha"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)

[State -1, Dai Geki Hou]
type=ChangeState
value=3100
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="Dai Geki Hou"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7) && var(22) < 1


[State -1, Senpuu Gouken]
type=ChangeState
value=3000
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && stateno!= 3000 && StateType != A &&var(20) <= 60 && power >= 1000&&command ="Senpuu Gouken"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7) && var(22) < 2
;----------------------------------------------------------------------
;SP MOVES
[State -1, EX Geki Hou Sumoned]
type=ChangeState
value=1430
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= command="EX Geki Hou Sumoned"
triggerall = power >= 500
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)

[State -1, Geki Hou Sumoned]
type=ChangeState
value=1420
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= command="Geki Hou Sumoned"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)

[State -1, EX Shou Há Air]
type=ChangeState
value=1341
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType = A
triggerall= command="EX Shou Há Air"
triggerall = power >= 500
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
...
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType = A
triggerall= command="Shou Há Air"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [600,650]) && movecontact

[State -1, EX Stomp Kicks]
type=ChangeState
value=1331
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType = A
triggerall= command="EX Stomp Kicks"
triggerall = power >= 500
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [600,650]) && movecontact  
...
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType = A
triggerall= command="Stomp Kicks"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [600,650]) && movecontact 

[State -1, EX Head Blow Down]
type=ChangeState
value=1312
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType = A
triggerall= command="EX Head Blow Down"
triggerall = power >= 500
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [600,650]) && movecontact 

[State -1, Head blow Down]
type=ChangeState
value=1311
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType = A
triggerall= command="Head blow Down"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [600,650]) && movecontact 

[State -1, Head blow Right]
type=ChangeState
value=1310
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType = A
triggerall= command="Head blow Right"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [600,650]) && movecontact 

[State -1, Thunder Kick Up]
type=ChangeState
value=1301
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType = A
triggerall= command="Thunder Kick Up"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [600,650]) && movecontact 

[State -1, Thunder Kick]
type=ChangeState
value=1300
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType = A
triggerall= command="Thunder Kick"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [600,650]) && movecontact 

[State -1, EX Fierce Thousand Feet]
type=ChangeState
value=1230 
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= command="EX Fierce Thousand Feet"
triggerall = power >= 500
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)

[State -1, Fierce Thousand Feet]
type=ChangeState
value=1210
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= command="Fierce Thousand Feet"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
...
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= command="Fierce Foot"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)

[State -1, EX Arrow Apical]
type=ChangeState
value=1130 
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= command="EX Arrow Apical"
triggerall = power >= 500
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)

[State -1, Arrow Step Hard]
type=ChangeState
value=1120
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= command="Arrow Step Hard"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
...
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= command="Arrow Step"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)

[State -1, Apical elbow]
type=ChangeState
value=1100
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= command="Apical elbow"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)

[State -1, Geki Hou]
type=ChangeState
value=Ifelse(command="EX Geki Hou"&&var(20) <= 60&&power>=500,1070,1060)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= (command="Geki Hou"||command="EX Geki Hou")
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)

[State -1, EX Dai Shou Ha]
type=ChangeState
value=1030 
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= command="EX Dai Shou Ha"
triggerall = power >= 500
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
...
type = ChangeState
value = Ifelse(((command = "BB" && p2dist x >= 0) || (command = "FF" && p2dist x < 0)), 105, 100)
trigger1 = !AILevel&&Roundstate=2&&statetype = S
...
trigger1=ctrl||stateno=[100,101]
trigger2=var(4)
trigger3=!var(55)&&stateno=200&&(movecontact|animelemtime(3)>0)
;---------------------------------------------------------------------------
...
trigger4=!var(55)&&stateno=430&&(movecontact|animelemtime(3)>0)
;---------------------------------------------------------------------------
...
trigger1 = !numhelper(6085) && (P2Dist x >= 0 || StateType != A)
...
[State -1]
type=ChangeState
value=Ifelse((power >= 2000 && var(22) < 1 && random < 250), 3100, 3000)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
...
[State -1]
type=ChangeState
value=Ifelse((var(20) <= 60 && power >= 500 && random < 250), 1230, 1210)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=AILevel && numenemy
...
[State -1]
type=ChangeState
value=Ifelse((var(20) <= 60 && power >= 500 && random < 250), 1230, 1200)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=AILevel && numenemy
triggerall=RoundState=2 && StateType != A &&var(20)<=60&& random < (150 * (var(59) ** 2 / 64.0))
triggerall=(p2stateno != [120, 155]) && (enemynear,statetype != L) && !(enemynear, hitfall)&&(enemynear,stateno!=[5100,5220]) &&(p2bodydist x =[10,80]) && (p2bodydist y =[-90,5]) &&(enemynear, statetype != A)
...
[State -1]
type=ChangeState
value=Ifelse((var(20) <= 60 && power >= 500 && random < 300), 1130, 1120)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
...
[State -1]
type=ChangeState
value=Ifelse((var(20) <= 60 && power >= 500 && random < 300), 1130, 1110)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A && random < (150 * (var(59) ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
triggerall=(p2bodydist x =[80,200])&&(p2bodydist y=[-80,5])&&(enemynear,statetype!=A)
...
[State -1]
type=ChangeState
value=Ifelse((var(20) <= 60 && power >= 500 && random < 300), 1130, 1100)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A && random < (150 * (var(59) ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
triggerall=(p2bodydist x =[80,200])&&(p2bodydist y=[-80,5])&&(enemynear,statetype!=A)
...
[State -1,]
type=ChangeState
value=Ifelse((var(20) <= 60 && power >= 500 && random < 300), 1070, 1060)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A && random < (150 * (var(59) ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
triggerall=(p2bodydist x =[80,200])&&(p2bodydist y=[-80,5])&&(enemynear,statetype!=A)
...
[State -1,]
type=ChangeState
value=Ifelse(var(20) <= 60 && power>=800&&random<=250,1030,1020)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=AILevel && numenemy
triggerall=RoundState=2 && StateType != A&&(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&random < (250 * (var(59) ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155])&&(enemynear,statetype=A) && (p2bodydist x =[0,60])&&(p2bodydist y=[-140,5])
...
[State -1,]
type=ChangeState
value=Ifelse((var(20) <= 60 && power >= 500 && random < 100), 1341, 1340)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=AILevel && numenemy && RoundState=2 && StateType = A && Pos Y<=-30 && random < (150 * (var(59) ** 2 / 64.0))
triggerall=(enemynear,stateno!=[5110,5220])&&(enemynear,stateno!=[120,155])
triggerall=p2statetype!=L
...
[State -1,]
type=ChangeState
value=Ifelse((var(20) <= 60 && power >= 500 && random < 100), 1312, 1311)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=AILevel && numenemy && RoundState=2 && StateType = A && Pos Y<=-30 && random < (150 * (var(59) ** 2 / 64.0))
triggerall=(enemynear,stateno!=[5110,5220])&&(enemynear,stateno!=[120,155])
triggerall=p2statetype!=L
...
[State -1,]
type=ChangeState
value=Ifelse((var(20) <= 60 && power >= 500 && random < 100), 1331, 1330)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=AILevel && numenemy && RoundState=2 && StateType = A && Pos Y<=-30 && random < (150 * (var(59) ** 2 / 64.0))
triggerall=(enemynear,stateno!=[5110,5220])&&(enemynear,stateno!=[120,155])
triggerall=p2statetype!=L

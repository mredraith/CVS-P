...
;The charge moves below are patterned after Capcom's style of charge moves; for the SNK style, please
;see http://mugenguild.com/forum/msg.2366956, where code that replicates SNK behavior is provided, as
;well as further discussion about the nuances of Capcom and SNK's style of charge moves.
;==============================================================================================

;===============================<(CAPCOM) CHARGE BACK, FORWARD>================================


;==============================================================================================
;this is the standard method of coding charge moves in MUGEN (since MUGEN's in-built charge commands
;are completely broken), with the only change being that the triggers are adjusted to ensure
;that the correct behavior occurs when switching sides.

;When a right-facing character holds left, or a left-facing character holds right, var(47) will
;increase by one every tick. If at any point the character stops holding that respective direction,
;var(47) will be reset to 0. And if var(47) has a value greater than or equal to 45 (meaning left
;or right has been held for 45 or more ticks), then var(48) is set to 48. This is our charge buffer,
;and as long as it's non-zero, the character is able to perform a charge move. var(48) will slowly
;start counting down to 0, however, if the player stops hold left or right!
;==============================================================================================
[State -1, Back Charge Increment]
type = VarAdd
triggerAll = NumHelper(90000005) && !IsHelper && !AILevel
trigger1 = !AILevel
trigger1 = ifElse(P2dist x < 0 && StateType = A, Facing = -1, Facing = 1) && Helper(90000005), command = "holdback"
trigger2 = !AILevel
trigger2 = ifElse(P2dist x < 0 && StateType = A, Facing = 1, Facing = -1) && Helper(90000005), command = "holdfwd"
trigger3 = AILevel
var(47) = 1

[State -1, Back Charge Reset]
type = VarSet
triggerAll = NumHelper(90000005) && !IsHelper && !AILevel
trigger1 = !AILevel
trigger1 = ifElse(P2dist x < 0 && StateType = A, Facing = -1, Facing = 1) && Helper(90000005), command != "holdback"
...
[State -1, Back Charge Buffer Activation]
type = VarSet
trigger1 = var(47) >= 45
var(48) = 32

[State -1, Back Charge Buffer Decrement]
type = VarAdd
...
;than with standard commands, instead of having the RemoveTime be a constant value, we use the current
...
[State -1, L, DL, D, DR, R, L: 1st Left]
type = Explod
triggerAll = NumExplod(90000004)
triggerAll = NumHelper(90000005) && !IsHelper && !AILevel
trigger1 = Helper(90000005), command != "back" && Helper(90000005), command != "holdback"
...
;These two ChangeStates are only in use when the character has landed from a jump after switching
...
triggerAll = !AILevel
triggerAll = InGuardDist
triggerAll = P2dist x < 0 && StateType != A
...
triggerAll = !AILevel
;command = "720"
triggerAll = (NumExplod(90031018) || NumExplod(90031112) || NumExplod(90031214) || NumExplod(90031316) || (NumExplod(90031418) || NumExplod(90031512) || NumExplod(90031614) || NumExplod(90031716)))
;a + b / a + c / b + c
triggerAll = (ifElse(NumExplod(90000230), 1, 0) + ifElse(NumExplod(90000240), 1, 0) + ifElse(NumExplod(90000250), 1, 0) >= 2) || (ifElse(NumExplod(90000235), 1, 0) + ifElse(NumExplod(90000245), 1, 0) + ifElse(NumExplod(90000255), 1, 0) >= 2)
triggerAll = RoundState = 2 && StateType != A
...
[State -1, EX Thunder Crush Bomb]
type = ChangeState
value = 1530
triggerAll = !AILevel
;command = "360"
triggerAll = (NumExplod(90011008) || NumExplod(90011102) || NumExplod(90011204) || NumExplod(90011306) || (NumExplod(90011408) || NumExplod(90011502) || NumExplod(90011604) || NumExplod(90011706)))
;a + b / a + c / b + c
triggerAll = (ifElse(NumExplod(90000230), 1, 0) + ifElse(NumExplod(90000240), 1, 0) + ifElse(NumExplod(90000250), 1, 0) >= 2) || (ifElse(NumExplod(90000235), 1, 0) + ifElse(NumExplod(90000245), 1, 0) + ifElse(NumExplod(90000255), 1, 0) >= 2)
triggerAll = RoundState = 2 && StateType != A
...
[State -1, EX Combination Bodyblow]
type = ChangeState
value = 1430
triggerAll = !AILevel
;command = "B, D, DB"
...
[State -1, EX Jumping Lariat Drop]
type = ChangeState
value = 1330
triggerAll = !AILevel
;command = "F, D, DF"
...
value = 1230
triggerAll = !AILevel
triggerAll = Var(51) > 2358 && Var(52) = 0
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1220
triggerAll = !AILevel
triggerAll = (Var(51) = [1011,2358]) && Var(52) = 0
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1210
triggerAll = !AILevel
triggerAll = (Var(51) = [337,1011]) && Var(52) = 0
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1200
triggerAll = !AILevel
triggerAll = (Var(51) = [42,337]) && Var(52) = 0
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
triggerAll = !AILevel
;command = "[charge] B, F" 
triggerAll = ((ifElse(P2DisT x < 0, Facing = -1, Facing = 1) && NumExplod(90010606)) || (ifElse(P2DisT x < 0, Facing = 1, Facing = -1) && NumExplod(90010704))) && ifElse(var(20) > 0 || (StateNo = [1000, 4999]), 1, var(48) > 16)
;x / y / z
triggerAll = NumExplod(90000200) || NumExplod(90000205) || NumExplod(90000210) || NumExplod(90000215) || NumExplod(90000220) || NumExplod(90000225)
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
...
triggerAll = (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90000003)) && NumExplod(90000250) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90000001)) && NumExplod(90000250)
triggerall = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = var(4)
...
type = ChangeState
value = 220 + (Abs(P2bodydist X) <= 40) * 5
triggerAll = !AILevel
;command != "holddown" && command = "z"
triggerAll = (!NumExplod(90000002) && !NumExplod(90000003) && !NumExplod(90000001)) && NumExplod(90000220)
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = var(4)
...
triggerAll = (!NumExplod(90000002) && !NumExplod(90000003) && !NumExplod(90000001)) && NumExplod(90000250)
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = var(4)
...
triggerAll = (!NumExplod(90000002) && !NumExplod(90000003) && !NumExplod(90000001)) && NumExplod(90000210)
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = var(4)
...
triggerAll = (!NumExplod(90000002) && !NumExplod(90000003) && !NumExplod(90000001)) && NumExplod(90000200)
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = (StateNo = 400 && AnimElem = 4,> 1)
trigger3 = var(4)
...
triggerAll = (!NumExplod(90000002) && !NumExplod(90000003) && !NumExplod(90000001)) && NumExplod(90000230)
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = var(4)
...
triggerAll = !AILevel
;command = "holddown" && command = "c"
triggerAll = (NumExplod(90000002) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90000003)) || NumExplod(90000001)) && NumExplod(90000250)
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = var(4)
...
triggerAll = (NumExplod(90000002) || NumExplod(90000003) || NumExplod(90000001)) && NumExplod(90000240)
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = var(4)

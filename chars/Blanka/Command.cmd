...
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXDirect Lightning" && ifelse(var(20)>0 || (stateno=[1000,4999]), 1, var(48)>16)
triggerAll = RoundState = 2 && StateType != A
...
value = 3150 
triggerAll = !AILevel
triggerAll = command = "MAXGround Shave Rolling" && ifelse(var(20)>0 || (stateno=[1000,4999]), 1, var(48)>16)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)
...
value = 3000
triggerAll = !AILevel
triggerAll = command = "Direct Lightning" && ifelse(var(20)>0 || (stateno=[1000,4999]), 1, var(48)>16)
triggerAll = RoundState = 2 && StateType != A
...
value = 3100
triggerAll = !AILevel
triggerAll = command = "Ground Shave Rolling" && ifelse(var(20)>0 || (stateno=[1000,4999]), 1, var(48)>16)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 1000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXVertical Rolling" && ifElse(var(20) > 0 || (StateNo = [1000, 4999]), 1, var(50) > 16)
triggerAll = RoundState = 2 && StateType != A
...
value = 1230
triggerAll = !AILevel
triggerAll = command = "EXBackstep Rolling" && ifelse(var(20)>0 || (stateno=[1000,4999]), 1, var(48)>16)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1130
triggerAll = !AILevel
triggerAll = command = "EXRolling Attack" && ifelse(var(20)>0 || (stateno=[1000,4999]), 1, var(48)>16)
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1300
triggerAll = !AILevel
triggerAll = command = "Vertical Rolling" && ifElse(var(20) > 0 || (StateNo = [1000, 4999]), 1, var(50) > 16)
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1200
triggerAll = !AILevel
triggerAll = command = "Backstep Rolling" && ifelse(var(20)>0 || (stateno=[1000,4999]), 1, var(48)>16)
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1100
triggerAll = !AILevel
triggerAll = command = "Rolling Attack" && ifelse(var(20)>0 || (stateno=[1000,4999]), 1, var(48)>16)
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

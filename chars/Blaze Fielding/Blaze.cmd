...
trigger1= ctrl || StateNo = 40 || StateNo = 52 ||(stateno=[100,101]) || StateNo = 5110
trigger2 = var(5)
...
[State -1, Uppercut];Heavy
type = ChangeState
value = 1120
triggerall = !IsHelper(10371)
triggerall = numhelper(10371)
triggerall = helper(10371), var(22)
triggerall = (helper(10371), var(2)) || (helper(10371), var(12))
triggerall = RoundState = 2 && StateType != A
trigger1= ctrl || StateNo = 40 || StateNo = 52 ||(stateno=[100,101])
trigger2 = var(5)

[State -1, Uppercut];Medium
type = ChangeState
value = 1110
triggerall = !IsHelper(10371)
triggerall = numhelper(10371)
triggerall = helper(10371), var(22)
triggerall = (helper(10371), var(1)) || (helper(10371), var(11))
triggerall = RoundState = 2 && StateType != A
trigger1= ctrl || StateNo = 40 || StateNo = 52 ||(stateno=[100,101])
trigger2 = var(5)

[State -1, Uppercut];Light
type = ChangeState
value = 1100
triggerall = !IsHelper(10371)
triggerall = numhelper(10371)
triggerall = helper(10371), var(22)
triggerall = (helper(10371), var(0)) || (helper(10371), var(10))
triggerall = RoundState = 2 && StateType != A
trigger1= ctrl || StateNo = 40 || StateNo = 52 ||(stateno=[100,101])
trigger2 = var(5)

[State -1, Blaze Strike]
type = ChangeState
value = 1200
triggerall = !IsHelper(10371)
triggerall = numhelper(10371)
...
trigger1 = statetype != A
trigger1= ctrl || (stateno=[100,101])
trigger2= (StateNo = 200 || StateNo = 201 || StateNo = 230 ||StateNo = 400 || StateNo = 430) && Time >=4
...
type = ChangeState
value = 240 + (Abs(P2BodyDist X) <= 13) * 1
triggerall = !IsHelper(10371) ;Always add this as well!
triggerall = numhelper(10371) ;Prevent debug flood.

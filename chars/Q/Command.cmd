...
triggerAll = power >= 3000 && !var(20) && !var(40)
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = power >= 2000 && !var(20) && !var(40)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Deadly Double Combination]
type = ChangeState
value = 3150
triggerAll = !AILevel
;command = "QCB, QCB"
...
triggerAll = (ifElse(NumExplod(90000200), 1, 0) + ifElse(NumExplod(90000210), 1, 0) + ifElse(NumExplod(90000220), 1, 0) >= 2) || (ifElse(NumExplod(90000205), 1, 0) + ifElse(NumExplod(90000215), 1, 0) + ifElse(NumExplod(90000225), 1, 0) >= 2)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = power >= 2000 && var(20) <= 60 && !var(40)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Critical Combo Attack]
type = ChangeState
value = 3050
triggerAll = !AILevel
;command = "QCF, QCF"
...
[State -1, Deadly Double Combination]
type = ChangeState
value = 3100
triggerAll = !AILevel
;command = "QCB, QCB"
...
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = power >= 1000 && var(20) <= 60 && !var(40)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)
...
[State -1, EX Capture & Deadly Blow]
type = ChangeState
value = 1330
triggerAll = !AILevel
;command = "HCB"
...
[State -1, EX Dashing Leg Attack]
type = ChangeState
value = 1130
triggerAll = !AILevel
;command = "charge B, F"
triggerAll = ifElse(var(20) > 0 || (StateNo = [1000,4999]), (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90010616)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90010714)), (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90010606)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90010704)))
;a + b / a + c / b + c
triggerAll = (ifElse(NumExplod(90000230), 1, 0) + ifElse(NumExplod(90000240), 1, 0) + ifElse(NumExplod(90000250), 1, 0) >= 2) || (ifElse(NumExplod(90000235), 1, 0) + ifElse(NumExplod(90000245), 1, 0) + ifElse(NumExplod(90000255), 1, 0) >= 2)
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = power >= 500 && var(20) <= 60 && !var(40)
...
[State -1, Total Destruction: Danger]
type = ChangeState
value = 3270
triggerAll = !AILevel
;command = "QCF"
...
[State -1, Total Destruction: Activate]
type = ChangeState
value = 3250
triggerAll = !AILevel
;command = "QCF"
...
trigger1 = power >= 1000 && !var(20) && !var(40)
...
trigger1 = power < const(data.power) && power < PowerMax && !var(20) && !var(40)
trigger1 = ctrl || (StateNo = [100,101])
...
[State -1, Advancing Attack]
type = ChangeState
value = 228
triggerAll = !AILevel
;command = "holdback" && command = "z"
...
[State -1, Inversion Attack]
type = ChangeState
value = 258
triggerAll = !AILevel
;command = "holdback" && command = "c"
triggerAll = (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90000004)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90000006))
triggerAll = NumExplod(90000220) || command = "c"
triggerAll = StateType != A && !NumProjID(131035)
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = var(4)
...
triggerAll = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = (StateNo = 200 || StateNo = 205 || StateNo = 230 || StateNo = 400) && Time >= 5
trigger3 = var(4)
...
[State -1, Leg Attack (Backwards)]
type = ChangeState
value = 458
triggerAll = !AILevel && !NumProjID(131035)
;command = "holddown" && command = "holdback" && command = "c"
triggerAll = (ifElse(P2dist x < 0, Facing = -1, Facing = 1) && NumExplod(90000001)) || (ifElse(P2dist x < 0, Facing = 1, Facing = -1) && NumExplod(90000003))
triggerAll = NumExplod(90000250) || command = "c"
triggerall = StateType != A
trigger1 = ctrl || (StateNo = [100,101])
trigger2 = var(4)
...
[State -1, Neutral/Angled Jumping Light Punch]
type = ChangeState
...
trigger1 = StateNo = 40 && Random < (250 * (AILevel ** 2 / 64.0))
ctrl = 1
...
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = power >= 3000 && var(20) <= 60 && !var(40)
...
trigger1 = (ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])) && Random < (750 * (AILevel ** 2 / 64.0))
...
triggerAll = AILevel && NumEnemy
trigger1 = RoundState = 2 && StateType != A
trigger1 = Power < const(data.power) && !var(20) && !var(40)
trigger1 = ctrl && Power < const(data.power) && Power < PowerMax && !var(20) && PrevStateNo != 5120
trigger1 = !InGuardDist && P2BodyDist x >= 160 && Random < (25 * (AILevel ** 2 / 64.0))
...
trigger3 = ctrl && (PrevStateNo = 205 || PrevStateNo = 230 || PrevStateNo = 430) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = (P2BodyDist x = [0, 40]) && (P2Dist y = [-90, 0]) && P2StateType != C && P2StateType != L
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 55]) && (P2Dist y = [-50, 0]) && P2StateType != A && P2StateType != L
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 40]) && (P2Dist y = [-60, -40]) && P2StateType = A
trigger1 = ctrl
trigger1 = Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [100, 125]) && (P2Dist y = [-100, 0]) && P2StateType != C && P2StateType != L
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 35]) && (P2Dist y = [-30, 0]) && P2StateType != A && P2StateType != L
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 58]) && (P2Dist y = [-15, 0]) && P2StateType != A && P2StateType != L
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 80]) && (P2Dist y = [-70, -55]) && P2StateType = A
trigger1 = ctrl
trigger1 = Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 55]) && (P2Dist y = [-120, -60]) && P2StateType = A
trigger1 = ctrl
trigger1 = Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [60, 80]) && (P2Dist y = [-75, 0]) && P2StateType != C && P2StateType != L
triggerAll = (EnemyNear, const(size.head.pos.y) <= -28) || (EnemyNear, StateType = A)
trigger1 = (ctrl || (StateNo = [100, 101])) && Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (EnemyNear, GetHitVar(chainID) = 1300)
trigger1 = (ctrl || (StateNo = [100, 101])) && (EnemyNear, Vel Y <= 5)
...
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [65, 80]) && (P2Dist y = [-50, 0]) && P2StateType != A && P2StateType != L
trigger1 = (ctrl || (StateNo = [100,101])) && Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [-10, 60]) && (P2Dist y = [-80, 80]) && P2StateType != A && P2StateType != L
trigger1 = ctrl
trigger1 = (Vel Y >= 0 && Vel Y < 2.5) && Random < (250 * (AILevel ** 2 / 64.0))
...
triggerAll = RoundState = 2 && StateType = A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = (P2BodyDist x = [0, 65]) && (P2Dist y = [-50, 50]) && P2StateType != A && P2StateType != L
trigger1 = ctrl
trigger1 = (Vel Y >= -1.25 && Vel Y < 0) && Random < (250 * (AILevel ** 2 / 64.0)) && var(3) = 1
...
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = (P2BodyDist x = [0, 100]) && (P2Dist y = [-80, 0]) && P2StateType != A && P2StateType != L
trigger1 = (ctrl || StateNo = 52 || (StateNo = [100, 101])) && P2BodyDist x >= 60 && Random < (25 * (AILevel ** 2 / 64.0))
...
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
trigger1 = (EnemyNear, GetHitVar(chainID) = 1301) 
trigger1 = (ctrl || (StateNo = [100, 101])) && (EnemyNear, Vel Y <= 5)
trigger2 = (EnemyNear, GetHitVar(chainID) = 3150) 
trigger2 = (ctrl || (StateNo = [100, 101])) && (EnemyNear, Vel Y >= 5) && (EnemyNear, Vel Y <= 6.5)
...
triggerAll = AILevel && NumEnemy
triggerAll = RoundState = 2 && StateType != A && !NumProjID(131035)
triggerAll = (P2BodyDist x = [0, 75]) && (P2Dist y = [-110, 0]) && P2StateType != L && P2MoveType != H
...
triggerAll = P2Dist x >= 0 && P2Dist x <= 50 && P2Dist y = 0
...
trigger3 = StateNo = 400 && !AnimTime && Random < (250 * (AILevel ** 2 / 64.0))

[State -1, (MAX) Capture & Deadly]
type = ChangeState
...
triggerAll = (P2BodyDist x = [0, 50]) && (P2Dist y = [-65, 0]) && P2StateType != A && P2StateType != L
trigger1 = var(7) && MoveHit && (StateNo != 1200)
...
triggerAll = Power >= 1000 && var(20) <= 60 && !var(40)
triggerAll = !var(16) && (var(15) < 1 || var(20) || (StateNo = [1000, 4999]))
triggerAll = (P2BodyDist x = [50, 100]) && (P2Dist y = [-80, 0]) && P2StateType != A && P2StateType != L
...
value = 195
triggerAll = AILevel && NumEnemy
triggerAll = StateType != A && var(11) < 3

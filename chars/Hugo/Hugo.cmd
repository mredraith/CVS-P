...
[Command]
name = "ShootdownBackbreaker1"
command = ~F, D, DF, a
time = 15

[Command]
name = "ShootdownBackbreaker2"
command = ~F, D, DF, b
time = 15

[Command]
name = "ShootdownBackbreaker3"
command = ~F, D, DF, c
time = 15
...
[Command]
name = "GiantPalmBomber1"
command = ~D, DB, B, x
time = 15

[Command]
name = "GiantPalmBomber2"
command = ~D, DB, B, y
time = 15

[Command]
name = "GiantPalmBomber3"
command = ~D, DB, B, z
time = 15
...
time = 5
;--------------------------------------------------------------------
[State -1, Gigas Breaker]
type=ChangeState
value=3000
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 3000&&command ="Lv3"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Megaton Press]
type=ChangeState
value=3100
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="MaxSuper"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Hammer Frenzy]
type=ChangeState
value=3200
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 1000&&command ="HammerFrenzy"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Lv3]
type=null
value=3400
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="Super"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;========================================================================
[State -1, Moonsault Press]
type=ChangeState
value=Ifelse(command="MoonsaultPressEX"&&var(20) <= 60&&power>=500,1030,1000)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="MoonsaultPress1")||(command="MoonsaultPress2")||(command="MoonsaultPress3")||(command="MoonsaultPressEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="MoonsaultPressEX"&&power>=500&&var(20) <= 60)

[State -1, Meat Squasher]
type=ChangeState
value=Ifelse(command="MeatSquasherEX"&&var(20) <= 60&&power>=500,1230,1200)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="MeatSquasher1")||(command="MeatSquasher2")||(command="MeatSquasher3")||(command="MeatSquasherEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="MeatSquasherEX"&&power>=500&&var(20) <= 60)

[State -1, Shootdown Backbreaker]
type=ChangeState
value=Ifelse(command="ShootdownBackbreakerEX"&&var(20) <= 60&&power>=500,1130,1100)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="ShootdownBackbreaker1")||(command="ShootdownBackbreaker2")||(command="ShootdownBackbreaker3")||(command="ShootdownBackbreakerEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="ShootdownBackbreakerEX"&&power>=500&&var(20) <= 60)

[State -1, Ultra Throw]
type=ChangeState
value=Ifelse(command="UltraThrowEX"&&var(20) <= 60&&power>=500,1330,1300)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="UltraThrow1")||(command="UltraThrow2")||(command="UltraThrow3")||(command="UltraThrowEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="UltraThrowEX"&&power>=500&&var(20) <= 60)

[State -1, Monster Lariat]
type=ChangeState
value=Ifelse(command="MonsterLariatEX"&&var(20) <= 60&&power>=500,1530,1500)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="MonsterLariat1")||(command="MonsterLariat2")||(command="MonsterLariat3")||(command="MonsterLariatEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="MonsterLariatEX"&&power>=500&&var(20) <= 60)

[State -1, Giant Palm Bomber]
type=ChangeState
value=Ifelse(command="GiantPalmBomberEX"&&var(20) <= 60&&power>=500,1430,1400)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="GiantPalmBomber1")||(command="GiantPalmBomber2")||(command="GiantPalmBomber3")||(command="GiantPalmBomberEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="GiantPalmBomberEX"&&power>=500&&var(20) <= 60)
;========================================================================
...
type = ChangeState
value = 225
triggerall=!AILevel&&Roundstate=2&&statetype!=A&&command="z" && command = "holdfwd"
trigger1=ctrl||stateno=[100,101]
trigger2=var(4)
...
type=ChangeState
value=3000
triggerall=AILevel && numenemy && RoundState=2 && StateType != A && var(20) <= 60 && power >= 3000 && random < (100 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220]) && p2bodydist x <= 40 && (p2bodydist y =[-5,5])
...
type=ChangeState
value=3100
triggerall=AILevel && numenemy && RoundState=2 && StateType != A && var(20) <= 60 && power >= 2000 && random < (100 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220]) && p2bodydist x <= 70 && (p2bodydist y =[-150,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
;--------------------------------------------------------------------------
[State -1, Hammer Frenzy]
type=ChangeState
value=3200
triggerall=AILevel && numenemy && RoundState=2 && StateType != A && var(20) <= 60 && power >= 1000 && random < (100 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220]) && p2bodydist x <= 70 && (p2bodydist y =[-50,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])|| (StateNo=[110,111])
trigger2=(var(6)) && movehit && random<200
;--------------------------------------------------------------------------
;SPECIALS
...
[State -1, Monster Lariat]
type=ChangeState
value=Ifelse(power>=500&&random<=250,1530,1500)
...
triggerall=(enemynear,stateno!=[120,155])&&(enemynear,statetype!=C) && (p2bodydist x =[20,160])&&(p2bodydist y=[-65,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
;----------------------------------------------------------------
[State -1, Giant Palm Bomber]
type=ChangeState
value=Ifelse(power>=500&&random<=250,1430,1400)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A&&(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155])&&(enemynear,statetype!=C) && (p2bodydist x =[0,50])&&(p2bodydist y=[-65,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
;----------------------------------------------------------------
[State -1, Ultra Throw]
type=ChangeState
value=Ifelse(power>=500&&random<=250,1330,1300)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A&&(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155])&&(enemynear,statetype!=C) && (p2bodydist x =[0,50])&&(p2bodydist y=[-5,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
;----------------------------------------------------------------
[State -1, Meat Squasher]
type=ChangeState
value=Ifelse(power>=500&&random<=250,1230,1200)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A&&(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155])&&(enemynear,statetype!=C) && (p2bodydist x =[10,100])&&(p2bodydist y=[-30,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
;----------------------------------------------------------------
[State -1, Shootdown Backbreaker]
...
triggerall=AILevel && numenemy && RoundState=2 && StateType != A&&(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&random < (350 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155])&&(enemynear,statetype!=C) && (p2bodydist x =[20,90])&&(p2bodydist y=[-140,-10])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
;----------------------------------------------------------------
[State -1, Moonsault Press]
type=ChangeState
value=Ifelse(power>=500&&random<=250,1030,1000)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A&&(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&random < (250 * (AIlevel ** 2 / 64.0))
triggerall=(enemynear,stateno!=[120,155])&&(enemynear,statetype!=C) && (p2bodydist x =[0,60])&&(p2bodydist y=[-5,5])
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
;----------------------------------------------------------------

...
time = 5
;--------------------------------------------------------------------
[State -1, Shin Yukishi Maki]
type=ChangeState
value=3300
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 2000&&command ="ShinYukishiMaki"
...
;type=ChangeState
;value=3050
;triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="MaxJuuyou"
;trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
;trigger2=var(6)|| var(7)
;----------------------------------------------------------------------
[State -1, Juuyou]
type=ChangeState
value=3000
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 1000&&command ="Juuyou"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
;========================================================================
[State -1, Suizan]
type=ChangeState
value=Ifelse(command="SuizanEX"&&var(20) <= 60&&power>=500,1330,1300)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Suizan1")||(command="Suizan2")||(command="Suizan3")||(command="SuizanEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="SuizanEX"&&power>=500&&var(20) <= 60)

[State -1, Hyoukyou]
type=ChangeState
value=Ifelse(command="HyoukyouEX"&&var(20) <= 60&&power>=500,1430,1400)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Hyoukyou1")||(command="Hyoukyou2")||(command="Hyoukyou3")||(command="HyoukyouEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="HyoukyouEX"&&power>=500&&var(20) <= 60)

[State -1, Souka]
type=ChangeState
value=Ifelse(command="SoukaEX"&&var(20) <= 60&&power>=500,1130,1100)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Souka1")||(command="Souka2")||(command="Souka3")||(command="SoukaEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="SoukaEX"&&power>=500&&var(20) <= 60)

[State -1, ShunSetsuZan]
type=ChangeState
value=Ifelse(command="ShunSetsuZanEX"&&var(20) <= 60&&power>=500,1230,1200)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="ShunSetsuZan1")||(command="ShunSetsuZan2")||(command="ShunSetsuZan3")||(command="ShunSetsuZanEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="ShunSetsuZanEX"&&power>=500&&var(20) <= 60)

[State -1, Hyoujin]
type=ChangeState
value=Ifelse(command="HyoujinEX"&&var(20) <= 60&&power>=500,1030,1000)
triggerall = Numhelper(1005) = 0
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Hyoujin1")||(command="Hyoujin2")||(command="Hyoujin3")||(command="HyoujinEX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = 450) && movecontact && (command="HyoujinEX"&&power>=500&&var(20) <= 60)
;========================================================================
...
trigger2=var(4)
;---------------------------------------------------------------------------
[State -1, Forward Medium Punch]
type=ChangeState
value=245
triggerall=!AILevel&&Roundstate=2&&statetype != A&&command != "holddown"&& command="b" && command = "holdfwd"
trigger1=ctrl||stateno=[100,101]
trigger2=var(4)
trigger3=((stateno=[200,219])||(stateno=[230,240])||(stateno=[400,419])||(stateno=[430,449]))&&movecontact
;--------------------------------------------------------------------------

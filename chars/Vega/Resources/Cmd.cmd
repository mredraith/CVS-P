;***************************************************************************;
;***************************************************************************;
; CVS Vega (Claw) POTS/Infinite by Falcon Rapper
;***************************************************************************;
;***************************************************************************;
...
[Command]
name = "Bloody High Claw_EASY"
command = ~D, DB, B, D, DB, x+a
time = 42
[Command]
name = "Bloody High Claw_EASY"
command = ~D, DB, B, D, DB, y+b
time = 42
[Command]
name = "Bloody High Claw_EASY"
command = ~D, DB, B, D, DB, z+c
time = 42
[Command]
name = "Bloody High Claw_EASY"
...
[Command]
name = "MAX Flying Barcelona Special_EASY"
...
[Command]
name = "Flying Barcelona Special_EASY"
...
time = 5
;--------------------------------------------------------------------
[State -1, Bloody High Claw]
type=ChangeState
value=3600
triggerall=!AILevel && RoundState=2 && (stateno!=[3500,3599]) && StateType != A && var(20)<=0 && power >= 3000 && Ifelse(var(45)=0,command="Bloody High Claw",command="Bloody High Claw_EASY")
...
type=ChangeState
value=3500
triggerall=!AILevel && RoundState=2 && (stateno!=[3500,3599]) && StateType != A && var(20)<=0 && power >= 3000 && command="Red Impact"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)
trigger3=(stateno=[200,450])
;--------------------------------------------------------------------
[State -1, Red Impact (Cancel)]
type=ChangeState
value=3500
triggerall=!AILevel && RoundState=2 && (stateno!=[3500,3599]) && StateType = A && var(20)<=0 && power >= 3000 && command="Red Impact"
trigger1=ctrl || (stateno=[1000,1030]) && movecontact
;------------------------------------------------------------------------------------------------------------------------------------------------------
[State -1, Max Flying Barcelona Special]
type=ChangeState
value=3050
triggerall=!AILevel && RoundState=2 && (stateno!=[3050,3099])&& StateType != A &&var(20) <= 60 && power >= 2000 && Ifelse(var(45)=0,command="MAX Flying Barcelona Special",command="MAX Flying Barcelona Special_EASY")
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno=[200,450]) && movecontact
;------------------------------------------------------------------------------------------------------------------------------------------------------
[State -1, Flying Barcelona Special]
type=ChangeState
value=3000
triggerall=!AILevel && RoundState=2 && (stateno!=[3000,3049])&& StateType != A &&var(20) <= 60 && power >= 1000 && Ifelse(var(45)=0,command="Flying Barcelona Special",command="Flying Barcelona Special_EASY")
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno=[200,450]) && movecontact
;------------------------------------------------------------------------------------------------------------------------------------------------------
[State -1, Max Scarlet Mirage]
type=ChangeState
value=3250
triggerall=!AILevel && RoundState=2 && (stateno!=[3250,3299])&& StateType != A &&var(20) <= 60 && power >= 2000 && command="MAX Scarlet Mirage"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno=[200,450]) && movecontact
;------------------------------------------------------------------------------------------------------------------------------------------------------
[State -1, Max Scarlet Mirage (Cancel)]
type=ChangeState
value=3250
triggerall=!AILevel && RoundState=2 && (stateno!=[3250,3299])&& StateType = A &&var(20) <= 60 && power >= 2000 && command="MAX Scarlet Mirage"
trigger1=ctrl || (stateno=[1000,1030]) && movecontact
;------------------------------------------------------------------------------------------------------------------------------------------------------
[State -1, Scarlet Mirage]
type=ChangeState
value=3200
triggerall=!AILevel && RoundState=2 && (stateno!=[3200,3249])&& StateType != A &&var(20) <= 60 && power >= 1000 && command="Scarlet Mirage"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7)
trigger3=(stateno=[200,450]) && movecontact
;------------------------------------------------------------------------------------------------------------------------------------------------------
[State -1, Scarlet Mirage (Cancel)]
type=ChangeState
value=3200
triggerall=!AILevel && RoundState=2 && (stateno!=[3200,3249])&& StateType = A &&var(20) <= 60 && power >= 1000 && command="Scarlet Mirage"
trigger1=ctrl ||(stateno=[1000,1030]) && movecontact
;======================================================================================================================================================
[State -1, Scarlet Terror]
type = ChangeState
value=Ifelse(command="Scarlet Terror EX"&&var(20) <= 60&&power>=500,1330,1300)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Scarlet Terror")||(command="Scarlet Terror EX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="Scarlet Terror EX"&&power>=500&&var(20) <= 60)
;========================================================================
[State -1, Sky High Claw]
type=ChangeState
value=Ifelse(command="Sky High Claw EX"&&var(20) <= 60&&power>=500,1230,1200)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Sky High Claw")||(command="Sky High Claw EX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="Sky High Claw EX"&&power>=500&&var(20) <= 60)
;========================================================================
[State -1, Flying Barcelona Attack]
type=ChangeState
value=Ifelse(command="Flying Barcelona Attack EX"&&var(20) <= 60&&power>=500,1130,1100)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Flying Barcelona Attack")||(command="Flying Barcelona Attack EX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="Flying Barcelona Attack EX"&&power>=500&&var(20) <= 60)
;========================================================================
[State -1, Rolling Crystal Flash]
type = ChangeState
value=Ifelse(command="Rolling Crystal Flash EX"&&var(20) <= 60&&power>=500,1030,1000)
triggerall=!AILevel && RoundState=2 && StateType != A && ((command="Rolling Crystal Flash")||(command="Rolling Crystal Flash EX"&&power>=500&&var(20) <= 60))
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)
trigger3=(stateno = [200,450]) && movecontact && (command="Rolling Crystal Flash EX"&&power>=500&&var(20) <= 60)
;======================================================================================================================================================
[State -1, Short Back Slash]
type=ChangeState
value =1500
trigger1=command="holddown"&&command="kk"
...
trigger1 = RoundState = 2 && StateType = A
trigger1 = ctrl && pos y <= -32 && FrontEdgeBodyDist <= 0
;---------------------------------------------------------------------
...
trigger1=ctrl||stateno=[100,101]
trigger2=var(4)
trigger3=((stateno=[200,249])||(stateno=[400,449]))&&movecontact&&var(55)=2
;---------------------------------------------------------------------------
...
trigger1=ctrl
trigger2=var(4)&&(stateno!=[1000,1900])
;---------------------------------------------------------------------------
...
;----------------------------------------------------------------------
[State -1, Max Scarlet Mirage AI]
type=ChangeState
value=3250
triggerall=AILevel && RoundState=2 && Numenemy && StateType != A && (stateno!=[3250,3299]) &&var(20) <= 60 && power >= 2000
...
;----------------------------------------------------------------------
[State -1, Scarlet Mirage AI]
type=ChangeState
value=3200
triggerall=AILevel && RoundState=2 && Numenemy && StateType != A && (stateno!=[3200,3249]) &&var(20) <= 60 && power >= 1000
...
;----------------------------------------------------------------------
[State -1, Max Flying Barcelona Special AI]
type=ChangeState
value=3050
...
;----------------------------------------------------------------------
[State -1, Flying Barcelona Special AI]
type=ChangeState
value=3000
...
trigger3=(var(7)) && movehit && time>60 && random<50
;========================================================================
[State -1, Flying Barcelona Attack AI]
type=ChangeState
...
trigger3=(stateno=[200,440])&&movehit&&random<200
;========================================================================
[State -1, Rolling Crystal Flash AI]
type=ChangeState

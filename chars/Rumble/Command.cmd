...
value = 1
;----------------------------------------------------------------------
[State -1, Super Rumble Finish]
type=ChangeState
value=4000
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="SRCombo"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)

[State -1, Ultimate Combo]
type=ChangeState
value=4100
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20)<=0&& power >= 3000&&command ="UCombo"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101]) || (StateNo=[200,450])
trigger2=var(6)

[State -1, LV2 Fist Punch Rain]
type=ChangeState
value=3150
triggerall= !numhelper(3086)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
...
;----------------------------------------------------------------------
[State -1, LV1 Fist Punch Rain]
type=ChangeState
value=3100
triggerall= !numhelper(3085)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && stateno!= 3000 && StateType != A &&var(20) <= 60 && power >= 1000&&command ="214214p"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)

;----------------------------------------------------------------------
[State -1, LV2 FLBall Fire]
type=ChangeState
value=3050
triggerall= !numhelper(3055)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A &&var(20) <= 60 && power >= 2000&&command ="236236pp"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7) && var(22) < 1

;----------------------------------------------------------------------
[State -1, LV1 FLBall Fire]
type=ChangeState
value=3000
triggerall= !numhelper(3005)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && stateno!= 3000 && StateType != A &&var(20) <= 60 && power >= 1000&&command ="236236p"
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(6)|| var(7) && var(22) < 2

;----------------------------------------------------------------------
[State -1, Special and Ex Special]
type=null
value=Ifelse(command="236pp"&&var(20) <= 60&&power>=500,1050,1000)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= (command="236p"||command="236pp")
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)

[State -1, 360° Kick & EX]
type=ChangeState
value=Ifelse(command="214kk"&&var(20) <= 60&&power>=500,1350,1300)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= (command="214k"||command="214kk")
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)

[State -1, 1000 Hands & EX]
type=ChangeState
value=Ifelse(command="623kk"&&var(20) <= 60&&power>=500,1250,1200)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= (command="623k"||command="623kk")
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)

[State -1, Uppercut]
type=ChangeState
value=Ifelse(command="623pp"&&var(20) <= 60&&power>=500,1150,1100)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=!AILevel && RoundState=2 && StateType != A
triggerall= (command="623p"||command="623pp")
trigger1=ctrl || StateNo=40 || StateNo=52 || (StateNo=[100,101])
trigger2=var(5)

[State -1, Fire Ball & EX]
type=ChangeState
value=Ifelse(command="236pp"&&var(20) <= 60&&power>=500,1050,1000)
...
type=ChangeState
value=ifelse(p2bodydist x <= (const(size.xscale) * 25),225,220)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
...
[State -1, AI LV1 and LV2 Super]
type=ChangeState
value=Ifelse((power >= 2000 && var(22) < 1 && random < 250), 3150, 3100)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=(stateno!=[3600,3649])
triggerall=AILevel && numenemy && RoundState=2 && stateno!= 3000 && StateType != A &&var(20)<=60 && power >= 1000 && random < (300 * (var(59) ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155]) && !(enemynear, hitfall)
...
;-------------------------------------------------------------------------
[State -1, AI Special and Ex Special]
type=ChangeState
value=Ifelse((var(20) <= 60 && power >= 500 && random < 300), 1050, 1000)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
...
[State -1, AI Special and Ex Special]
type=ChangeState
value=Ifelse((var(20) <= 60 && power >= 500 && random < 300), 1150, 1100)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A && random < (150 * (var(59) ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
triggerall=(p2bodydist x =[80,200])&&(p2bodydist y=[-80,5])&&(enemynear,statetype!=A)
...
[State -1, AI Special and Ex Special]
type=ChangeState
value=Ifelse((var(20) <= 60 && power >= 500 && random < 300), 1350, 1300)
triggerall=!var(58)||(var(58)&&sysfvar(4)=0)
triggerall=AILevel && numenemy && RoundState=2 && StateType != A && random < (150 * (var(59) ** 2 / 64.0))
triggerall=(enemynear,statetype != L)&&(enemynear,stateno!=[5100,5220])&&(enemynear,stateno!=[120,155])
triggerall=(p2bodydist x =[80,200])&&(p2bodydist y=[-80,5])&&(enemynear,statetype!=A)

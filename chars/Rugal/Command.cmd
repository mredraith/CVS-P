...
[State -1, Last Judgement]
type = ChangeState
value = 3500
triggerAll = !AILevel && var(40) = 1
triggerAll = command = "LastJudgement"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
triggerAll = command = "MAXDeadEndScreamer"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, Kaiser Phoenix]
type = ChangeState
value = 3200
triggerAll = !AILevel && var(40) = 0
triggerAll = command = "KaiserPhoenix"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 3000 && !var(20)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7)

[State -1, MAX Gigantic Pressure]
type = ChangeState
value = 3050
triggerAll = !AILevel
triggerAll = command = "MAXGiganticPressure"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Destruction Omega]
type = ChangeState
value = 3350
triggerAll = !AILevel && var(40) = 1
triggerAll = command = "MAXDestructionOmega"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)

[State -1, MAX Genocide Heaven]
type = ChangeState
value = 3160
triggerAll = !AILevel && var(40) = 1
triggerAll = command = "MAXGenocideHeaven"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 2000 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(7) || var(8)
...
value = 1800
triggerAll = !AILevel && var(40) = 1
triggerAll = command="GodLaneFwd1" || command="GodLaneFwd2" || command="GodLaneBack1" || command="GodLaneBack2"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1160
triggerAll = !AILevel && var(40) = 1
triggerAll = command = "EXGenocideCutter"
triggerAll = RoundState = 2 && StateType != A
...
[State -1, EX Rugal Execution]
type = ChangeState
value = 1730
triggerAll = !AILevel && var(40) = 1
triggerAll = command = "EXRugalExecution"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1630
triggerAll = !AILevel
triggerAll = command = "EXDarkSmash"
triggerAll = RoundState = 2 && StateType = A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1530
triggerAll = !AILevel
triggerAll = command = "EXDarkBarrier"
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
[State -1, EX Beads Destruction]
type = ChangeState
value = 1430
triggerAll = !AILevel && var(40) = 0
triggerAll = command = "EXBeadsDestruction"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, EX Kaiser Wave]
type = ChangeState
value = 1330
triggerAll = !AILevel
triggerAll = command = "EXKaiserWave"
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
...
value = 1150
triggerAll = !AILevel && var(40) = 1
triggerAll = command = "GenocideCutter"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
[State -1, Rugal Execution]
type = ChangeState
value = 1700
triggerAll = !AILevel && var(40) = 1
triggerAll = command = "RugalExecution"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
value = 1500
triggerAll = !AILevel
triggerAll = command = "DarkBarrier"
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(39)
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)

[State -1, Beads Destruction]
type = ChangeState
value = 1400
triggerAll = !AILevel && var(40) = 0
triggerAll = command = "BeadsDestruction"
triggerAll = RoundState = 2 && StateType != A
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
[State -1, God Rugal Genocide Cutter]
type = ChangeState
value = ifElse(Power >= 500 && Random < 133, 1160, 1150)
triggerAll = AILevel && NumEnemy && var(40) = 1
triggerAll = RoundState = 2 && StateType != A
triggerAll = !var(16) && (var(15) < 1 || var(20))
triggerAll = P2StateType != L && (P2Dist y = [-80,32])
...
trigger2 = EnemyNear, GetHitVar(HitTime) >= 4
trigger3 = (StateNo = 5120 || StateNo = 5201) && !AnimTime && Random < (50 * (AILevel ** 2 / 64.0))
trigger4 = StateNo = 3006 && AnimElemTime(4) > 0 && AnimElemTime(6) < 0 && Random < (50 * (AIlevel ** 2 / 64.0))
trigger5 = StateNo = 3100 && AnimElemTime(15) = 0 && MoveHit && Random < (50 * (AIlevel ** 2 / 64.0))
trigger6 = StateNo = 3302 && AnimElemTime(40) = 0 && Random < (50 * (AIlevel ** 2 / 64.0))
